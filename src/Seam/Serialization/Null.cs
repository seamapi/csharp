...
namespace Seam
{
    ...
    /// serializer options, including ones a caller supplies.
    /// </remarks>
    internal sealed class NullJsonConverter : JsonConverter<Null>
    {
        public override Null Read(
        ...
        // The sentinel means an explicit null, so it must never be dropped by
        // the ignore-nulls-when-writing default.
