...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<GetResponse>("/instant_keys/get", requestOptions)).Data.InstantKey;
}

public async Task<InstantKey> GetAsync(string? instantKeyId = default, string? instantKeyUrl = default)
{
return (await GetAsync(new GetRequest(instantKeyId: instantKeyId, instantKeyUrl: instantKeyUrl)));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<ListResponse>("/instant_keys/list", requestOptions)).Data.InstantKeys;
}
