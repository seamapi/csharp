...
public CreateRequest(List<CreateRequest.AcceptedCapabilitiesEnum>? acceptedCapabilities = default, List<CreateRequest.AcceptedProvidersEnum>? acceptedProviders = default, bool? automaticallyManageNewDevices = default, object? customMetadata = default, string? customRedirectFailureUrl = default, string? customRedirectUrl = default, string? customerKey = default, CreateRequest.DeviceSelectionModeEnum? deviceSelectionMode = default, List<string>? excludedProviders = default, CreateRequest.ProviderCategoryEnum? providerCategory = default, bool? waitForDeviceCreation = default)
{
...
return _seam.Post<CreateResponse>("/connect_webviews/create", requestOptions).Data.ConnectWebview;
}

public ConnectWebview Create(List<CreateRequest.AcceptedCapabilitiesEnum>? acceptedCapabilities = default, List<CreateRequest.AcceptedProvidersEnum>? acceptedProviders = default, bool? automaticallyManageNewDevices = default, object? customMetadata = default, string? customRedirectFailureUrl = default, string? customRedirectUrl = default, string? customerKey = default, CreateRequest.DeviceSelectionModeEnum? deviceSelectionMode = default, List<string>? excludedProviders = default, CreateRequest.ProviderCategoryEnum? providerCategory = default, bool? waitForDeviceCreation = default)
{
return Create(new CreateRequest(acceptedCapabilities: acceptedCapabilities, acceptedProviders: acceptedProviders, automaticallyManageNewDevices: automaticallyManageNewDevices, customMetadata: customMetadata, customRedirectFailureUrl: customRedirectFailureUrl, customRedirectUrl: customRedirectUrl, customerKey: customerKey, deviceSelectionMode: deviceSelectionMode, excludedProviders: excludedProviders, providerCategory: providerCategory, waitForDeviceCreation: waitForDeviceCreation));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<CreateResponse>("/connect_webviews/create", requestOptions)).Data.ConnectWebview;
}

public async Task<ConnectWebview> CreateAsync(List<CreateRequest.AcceptedCapabilitiesEnum>? acceptedCapabilities = default, List<CreateRequest.AcceptedProvidersEnum>? acceptedProviders = default, bool? automaticallyManageNewDevices = default, object? customMetadata = default, string? customRedirectFailureUrl = default, string? customRedirectUrl = default, string? customerKey = default, CreateRequest.DeviceSelectionModeEnum? deviceSelectionMode = default, List<string>? excludedProviders = default, CreateRequest.ProviderCategoryEnum? providerCategory = default, bool? waitForDeviceCreation = default)
{
return (await CreateAsync(new CreateRequest(acceptedCapabilities: acceptedCapabilities, acceptedProviders: acceptedProviders, automaticallyManageNewDevices: automaticallyManageNewDevices, customMetadata: customMetadata, customRedirectFailureUrl: customRedirectFailureUrl, customRedirectUrl: customRedirectUrl, customerKey: customerKey, deviceSelectionMode: deviceSelectionMode, excludedProviders: excludedProviders, providerCategory: providerCategory, waitForDeviceCreation: waitForDeviceCreation)));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<GetResponse>("/connect_webviews/get", requestOptions)).Data.ConnectWebview;
}
...
public ListRequest(object? customMetadataHas = default, string? customerKey = default, float? limit = default, string? pageCursor = default, string? search = default, string? userIdentifierKey = default)
{
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return _seam.Post<ListResponse>("/connect_webviews/list", requestOptions).Data.ConnectWebviews;
}

public List<ConnectWebview> List(object? customMetadataHas = default, string? customerKey = default, float? limit = default, string? pageCursor = default, string? search = default, string? userIdentifierKey = default)
{
return List(new ListRequest(customMetadataHas: customMetadataHas, customerKey: customerKey, limit: limit, pageCursor: pageCursor, search: search, userIdentifierKey: userIdentifierKey));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<ListResponse>("/connect_webviews/list", requestOptions)).Data.ConnectWebviews;
}

public async Task<List<ConnectWebview>> ListAsync(object? customMetadataHas = default, string? customerKey = default, float? limit = default, string? pageCursor = default, string? search = default, string? userIdentifierKey = default)
{
return (await ListAsync(new ListRequest(customMetadataHas: customMetadataHas, customerKey: customerKey, limit: limit, pageCursor: pageCursor, search: search, userIdentifierKey: userIdentifierKey)));
}
}
}
