...
public AddAcsEntrancesRequest(List<string> acsEntranceIds = default, string spaceId = default)
{
...
{
AddAcsEntrances(new AddAcsEntrancesRequest(acsEntranceIds: acsEntranceIds, spaceId: spaceId));
}
...
public async Task AddAcsEntrancesAsync(List<string> acsEntranceIds = default, string spaceId = default)
{
await AddAcsEntrancesAsync(new AddAcsEntrancesRequest(acsEntranceIds: acsEntranceIds, spaceId: spaceId));
}
...
public AddConnectedAccountRequest(string connectedAccountId = default, string spaceId = default)
{
...
public void AddConnectedAccount(string connectedAccountId = default, string spaceId = default)
{
AddConnectedAccount(new AddConnectedAccountRequest(connectedAccountId: connectedAccountId, spaceId: spaceId));
}
...
public async Task AddConnectedAccountAsync(string connectedAccountId = default, string spaceId = default)
{
await AddConnectedAccountAsync(new AddConnectedAccountRequest(connectedAccountId: connectedAccountId, spaceId: spaceId));
}
...
public async Task AddDevicesAsync(List<string> deviceIds = default, string spaceId = default)
{
...
public CreateRequest(List<string>? acsEntranceIds = default, List<string>? connectedAccountIds = default, CreateRequestCustomerData? customerData = default, string? customerKey = default, List<string>? deviceIds = default, string name = default, string? spaceKey = default)
{
AcsEntranceIds = acsEntranceIds;
...
public CreateRequestCustomerData(string? address = default, string? defaultCheckinTime = default, string? defaultCheckoutTime = default, string? timeZone = default)
{
Address = address;
...
public Space Create(List<string>? acsEntranceIds = default, List<string>? connectedAccountIds = default, CreateRequestCustomerData? customerData = default, string? customerKey = default, List<string>? deviceIds = default, string name = default, string? spaceKey = default)
{
return Create(new CreateRequest(acsEntranceIds: acsEntranceIds, connectedAccountIds: connectedAccountIds, customerData: customerData, customerKey: customerKey, deviceIds: deviceIds, name: name, spaceKey: spaceKey));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<CreateResponse>("/spaces/create", requestOptions)).Data.Space;
}

public async Task<Space> CreateAsync(List<string>? acsEntranceIds = default, List<string>? connectedAccountIds = default, CreateRequestCustomerData? customerData = default, string? customerKey = default, List<string>? deviceIds = default, string name = default, string? spaceKey = default)
{
return (await CreateAsync(new CreateRequest(acsEntranceIds: acsEntranceIds, connectedAccountIds: connectedAccountIds, customerData: customerData, customerKey: customerKey, deviceIds: deviceIds, name: name, spaceKey: spaceKey)));
}
...
public GetRelatedRequest(List<GetRelatedRequest.ExcludeEnum>? exclude = default, List<GetRelatedRequest.IncludeEnum>? include = default, List<string>? spaceIds = default, List<string>? spaceKeys = default)
{
Exclude = exclude;
Include = include;
SpaceIds = spaceIds;
...
public Batch GetRelated(List<GetRelatedRequest.ExcludeEnum>? exclude = default, List<GetRelatedRequest.IncludeEnum>? include = default, List<string>? spaceIds = default, List<string>? spaceKeys = default)
{
return GetRelated(new GetRelatedRequest(exclude: exclude, include: include, spaceIds: spaceIds, spaceKeys: spaceKeys));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<GetRelatedResponse>("/spaces/get_related", requestOptions)).Data.Batch;
}

public async Task<Batch> GetRelatedAsync(List<GetRelatedRequest.ExcludeEnum>? exclude = default, List<GetRelatedRequest.IncludeEnum>? include = default, List<string>? spaceIds = default, List<string>? spaceKeys = default)
{
return (await GetRelatedAsync(new GetRelatedRequest(exclude: exclude, include: include, spaceIds: spaceIds, spaceKeys: spaceKeys)));
}
...
public ListRequest(string? connectedAccountId = default, string? customerKey = default, float? limit = default, string? pageCursor = default, string? parentSpaceId = default, string? parentSpaceKey = default, string? search = default, string? spaceKey = default)
{
ConnectedAccountId = connectedAccountId;
CustomerKey = customerKey;
Limit = limit;
...
public List<Space> List(string? connectedAccountId = default, string? customerKey = default, float? limit = default, string? pageCursor = default, string? parentSpaceId = default, string? parentSpaceKey = default, string? search = default, string? spaceKey = default)
{
return List(new ListRequest(connectedAccountId: connectedAccountId, customerKey: customerKey, limit: limit, pageCursor: pageCursor, parentSpaceId: parentSpaceId, parentSpaceKey: parentSpaceKey, search: search, spaceKey: spaceKey));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<ListResponse>("/spaces/list", requestOptions)).Data.Spaces;
}

public async Task<List<Space>> ListAsync(string? connectedAccountId = default, string? customerKey = default, float? limit = default, string? pageCursor = default, string? parentSpaceId = default, string? parentSpaceKey = default, string? search = default, string? spaceKey = default)
{
return (await ListAsync(new ListRequest(connectedAccountId: connectedAccountId, customerKey: customerKey, limit: limit, pageCursor: pageCursor, parentSpaceId: parentSpaceId, parentSpaceKey: parentSpaceKey, search: search, spaceKey: spaceKey)));
}
...
public RemoveAcsEntrancesRequest(List<string> acsEntranceIds = default, string spaceId = default)
{
AcsEntranceIds = acsEntranceIds;
SpaceId = spaceId;
}
...
public void RemoveAcsEntrances(List<string> acsEntranceIds = default, string spaceId = default)
{
RemoveAcsEntrances(new RemoveAcsEntrancesRequest(acsEntranceIds: acsEntranceIds, spaceId: spaceId));
}
...
public async Task RemoveAcsEntrancesAsync(List<string> acsEntranceIds = default, string spaceId = default)
{
await RemoveAcsEntrancesAsync(new RemoveAcsEntrancesRequest(acsEntranceIds: acsEntranceIds, spaceId: spaceId));
}
...
public RemoveConnectedAccountRequest(string connectedAccountId = default, string spaceId = default)
{
ConnectedAccountId = connectedAccountId;
SpaceId = spaceId;
}
...
public void RemoveConnectedAccount(string connectedAccountId = default, string spaceId = default)
{
RemoveConnectedAccount(new RemoveConnectedAccountRequest(connectedAccountId: connectedAccountId, spaceId: spaceId));
}
...
public async Task RemoveConnectedAccountAsync(string connectedAccountId = default, string spaceId = default)
{
await RemoveConnectedAccountAsync(new RemoveConnectedAccountRequest(connectedAccountId: connectedAccountId, spaceId: spaceId));
}
...
public async Task RemoveDevicesAsync(List<string> deviceIds = default, string spaceId = default)
{
await RemoveDevicesAsync(new RemoveDevicesRequest(deviceIds: deviceIds, spaceId: spaceId));
}
...
public UpdateRequest(List<string>? acsEntranceIds = default, UpdateRequestCustomerData? customerData = default, List<string>? deviceIds = default, string? name = default, string? parentSpaceId = default, string? parentSpaceKey = default, string? spaceId = default, string? spaceKey = default)
{
AcsEntranceIds = acsEntranceIds;
CustomerData = customerData;
DeviceIds = deviceIds;
...
public UpdateRequestCustomerData(string? address = default, string? defaultCheckinTime = default, string? defaultCheckoutTime = default, string? timeZone = default)
{
Address = address;
DefaultCheckinTime = defaultCheckinTime;
DefaultCheckoutTime = defaultCheckoutTime;
...
public Space Update(List<string>? acsEntranceIds = default, UpdateRequestCustomerData? customerData = default, List<string>? deviceIds = default, string? name = default, string? parentSpaceId = default, string? parentSpaceKey = default, string? spaceId = default, string? spaceKey = default)
{
return Update(new UpdateRequest(acsEntranceIds: acsEntranceIds, customerData: customerData, deviceIds: deviceIds, name: name, parentSpaceId: parentSpaceId, parentSpaceKey: parentSpaceKey, spaceId: spaceId, spaceKey: spaceKey));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<UpdateResponse>("/spaces/update", requestOptions)).Data.Space;
}

public async Task<Space> UpdateAsync(List<string>? acsEntranceIds = default, UpdateRequestCustomerData? customerData = default, List<string>? deviceIds = default, string? name = default, string? parentSpaceId = default, string? parentSpaceKey = default, string? spaceId = default, string? spaceKey = default)
{
return (await UpdateAsync(new UpdateRequest(acsEntranceIds: acsEntranceIds, customerData: customerData, deviceIds: deviceIds, name: name, parentSpaceId: parentSpaceId, parentSpaceKey: parentSpaceKey, spaceId: spaceId, spaceKey: spaceKey)));
}
}
}
