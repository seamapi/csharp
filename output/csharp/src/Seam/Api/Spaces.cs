...
public ListRequest(string? customerKey = default, float? limit = default, string? pageCursor = default, string? search = default, string? spaceKey = default)
{
CustomerKey = customerKey;
Limit = limit;
...
public List<Space> List(string? customerKey = default, float? limit = default, string? pageCursor = default, string? search = default, string? spaceKey = default)
{
return List(new ListRequest(customerKey: customerKey, limit: limit, pageCursor: pageCursor, search: search, spaceKey: spaceKey));
}
...
public async Task<List<Space>> ListAsync(string? customerKey = default, float? limit = default, string? pageCursor = default, string? search = default, string? spaceKey = default)
{
return (await ListAsync(new ListRequest(customerKey: customerKey, limit: limit, pageCursor: pageCursor, search: search, spaceKey: spaceKey)));
}
...
public UpdateRequest(List<string>? acsEntranceIds = default, UpdateRequestCustomerData? customerData = default, List<string>? deviceIds = default, string? name = default, string? spaceId = default, string? spaceKey = default)
{
AcsEntranceIds = acsEntranceIds;
CustomerData = customerData;
DeviceIds = deviceIds;
...
public Space Update(List<string>? acsEntranceIds = default, UpdateRequestCustomerData? customerData = default, List<string>? deviceIds = default, string? name = default, string? spaceId = default, string? spaceKey = default)
{
return Update(new UpdateRequest(acsEntranceIds: acsEntranceIds, customerData: customerData, deviceIds: deviceIds, name: name, spaceId: spaceId, spaceKey: spaceKey));
}
...
public async Task<Space> UpdateAsync(List<string>? acsEntranceIds = default, UpdateRequestCustomerData? customerData = default, List<string>? deviceIds = default, string? name = default, string? spaceId = default, string? spaceKey = default)
{
return (await UpdateAsync(new UpdateRequest(acsEntranceIds: acsEntranceIds, customerData: customerData, deviceIds: deviceIds, name: name, spaceId: spaceId, spaceKey: spaceKey)));
}
}
}
