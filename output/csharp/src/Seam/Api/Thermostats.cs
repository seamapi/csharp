...
public ActivateClimatePresetRequest(string climatePresetKey = default, string deviceId = default)
{
...
return _seam.Post<ActivateClimatePresetResponse>("/thermostats/activate_climate_preset", requestOptions).Data.ActionAttempt;
}

public ActionAttempt ActivateClimatePreset(string climatePresetKey = default, string deviceId = default)
{
return ActivateClimatePreset(new ActivateClimatePresetRequest(climatePresetKey: climatePresetKey, deviceId: deviceId));
}

public async Task<ActionAttempt> ActivateClimatePresetAsync(ActivateClimatePresetRequest request)
{
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<ActivateClimatePresetResponse>("/thermostats/activate_climate_preset", requestOptions)).Data.ActionAttempt;
}

public async Task<ActionAttempt> ActivateClimatePresetAsync(string climatePresetKey = default, string deviceId = default)
{
return (await ActivateClimatePresetAsync(new ActivateClimatePresetRequest(climatePresetKey: climatePresetKey, deviceId: deviceId)));
}
...
public CoolRequest(float? coolingSetPointCelsius = default, float? coolingSetPointFahrenheit = default, string deviceId = default, bool? sync = default)
{
...
public ActionAttempt Cool(float? coolingSetPointCelsius = default, float? coolingSetPointFahrenheit = default, string deviceId = default, bool? sync = default)
{
return Cool(new CoolRequest(coolingSetPointCelsius: coolingSetPointCelsius, coolingSetPointFahrenheit: coolingSetPointFahrenheit, deviceId: deviceId, sync: sync));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<CoolResponse>("/thermostats/cool", requestOptions)).Data.ActionAttempt;
}

public async Task<ActionAttempt> CoolAsync(float? coolingSetPointCelsius = default, float? coolingSetPointFahrenheit = default, string deviceId = default, bool? sync = default)
{
return (await CoolAsync(new CoolRequest(coolingSetPointCelsius: coolingSetPointCelsius, coolingSetPointFahrenheit: coolingSetPointFahrenheit, deviceId: deviceId, sync: sync)));
}
...
public CreateClimatePresetRequestEcobeeMetadata(string? climateRef = default, bool? isOptimized = default, CreateClimatePresetRequestEcobeeMetadata.OwnerEnum? owner = default)
{
...
public async Task CreateClimatePresetAsync(string climatePresetKey = default, CreateClimatePresetRequest.ClimatePresetModeEnum? climatePresetMode = default, float? coolingSetPointCelsius = default, float? coolingSetPointFahrenheit = default, string deviceId = default, CreateClimatePresetRequestEcobeeMetadata? ecobeeMetadata = default, CreateClimatePresetRequest.FanModeSettingEnum? fanModeSetting = default, float? heatingSetPointCelsius = default, float? heatingSetPointFahrenheit = default, CreateClimatePresetRequest.HvacModeSettingEnum? hvacModeSetting = default, bool? manualOverrideAllowed = default, string? name = default)
{
await CreateClimatePresetAsync(new CreateClimatePresetRequest(climatePresetKey: climatePresetKey, climatePresetMode: climatePresetMode, coolingSetPointCelsius: coolingSetPointCelsius, coolingSetPointFahrenheit: coolingSetPointFahrenheit, deviceId: deviceId, ecobeeMetadata: ecobeeMetadata, fanModeSetting: fanModeSetting, heatingSetPointCelsius: heatingSetPointCelsius, heatingSetPointFahrenheit: heatingSetPointFahrenheit, hvacModeSetting: hvacModeSetting, manualOverrideAllowed: manualOverrideAllowed, name: name));
}
...
public DeleteClimatePresetRequest(string climatePresetKey = default, string deviceId = default)
{
ClimatePresetKey = climatePresetKey;
DeviceId = deviceId;
}
...
public void DeleteClimatePreset(string climatePresetKey = default, string deviceId = default)
{
DeleteClimatePreset(new DeleteClimatePresetRequest(climatePresetKey: climatePresetKey, deviceId: deviceId));
}
...
public async Task DeleteClimatePresetAsync(string climatePresetKey = default, string deviceId = default)
{
await DeleteClimatePresetAsync(new DeleteClimatePresetRequest(climatePresetKey: climatePresetKey, deviceId: deviceId));
}
...
public HeatRequest(string deviceId = default, float? heatingSetPointCelsius = default, float? heatingSetPointFahrenheit = default, bool? sync = default)
{
DeviceId = deviceId;
HeatingSetPointCelsius = heatingSetPointCelsius;
HeatingSetPointFahrenheit = heatingSetPointFahrenheit;
...
public ActionAttempt Heat(string deviceId = default, float? heatingSetPointCelsius = default, float? heatingSetPointFahrenheit = default, bool? sync = default)
{
return Heat(new HeatRequest(deviceId: deviceId, heatingSetPointCelsius: heatingSetPointCelsius, heatingSetPointFahrenheit: heatingSetPointFahrenheit, sync: sync));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<HeatResponse>("/thermostats/heat", requestOptions)).Data.ActionAttempt;
}

public async Task<ActionAttempt> HeatAsync(string deviceId = default, float? heatingSetPointCelsius = default, float? heatingSetPointFahrenheit = default, bool? sync = default)
{
return (await HeatAsync(new HeatRequest(deviceId: deviceId, heatingSetPointCelsius: heatingSetPointCelsius, heatingSetPointFahrenheit: heatingSetPointFahrenheit, sync: sync)));
}
...
public HeatCoolRequest(float? coolingSetPointCelsius = default, float? coolingSetPointFahrenheit = default, string deviceId = default, float? heatingSetPointCelsius = default, float? heatingSetPointFahrenheit = default, bool? sync = default)
{
CoolingSetPointCelsius = coolingSetPointCelsius;
CoolingSetPointFahrenheit = coolingSetPointFahrenheit;
DeviceId = deviceId;
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return _seam.Post<HeatCoolResponse>("/thermostats/heat_cool", requestOptions).Data.ActionAttempt;
}

public ActionAttempt HeatCool(float? coolingSetPointCelsius = default, float? coolingSetPointFahrenheit = default, string deviceId = default, float? heatingSetPointCelsius = default, float? heatingSetPointFahrenheit = default, bool? sync = default)
{
return HeatCool(new HeatCoolRequest(coolingSetPointCelsius: coolingSetPointCelsius, coolingSetPointFahrenheit: coolingSetPointFahrenheit, deviceId: deviceId, heatingSetPointCelsius: heatingSetPointCelsius, heatingSetPointFahrenheit: heatingSetPointFahrenheit, sync: sync));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<HeatCoolResponse>("/thermostats/heat_cool", requestOptions)).Data.ActionAttempt;
}

public async Task<ActionAttempt> HeatCoolAsync(float? coolingSetPointCelsius = default, float? coolingSetPointFahrenheit = default, string deviceId = default, float? heatingSetPointCelsius = default, float? heatingSetPointFahrenheit = default, bool? sync = default)
{
return (await HeatCoolAsync(new HeatCoolRequest(coolingSetPointCelsius: coolingSetPointCelsius, coolingSetPointFahrenheit: coolingSetPointFahrenheit, deviceId: deviceId, heatingSetPointCelsius: heatingSetPointCelsius, heatingSetPointFahrenheit: heatingSetPointFahrenheit, sync: sync)));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<ListResponse>("/thermostats/list", requestOptions)).Data.Devices;
}

public async Task<List<Device>> ListAsync(string? connectWebviewId = default, string? connectedAccountId = default, List<string>? connectedAccountIds = default, string? createdBefore = default, object? customMetadataHas = default, string? customerKey = default, List<string>? deviceIds = default, ListRequest.DeviceTypeEnum? deviceType = default, List<ListRequest.DeviceTypesEnum>? deviceTypes = default, List<ListRequest.ExcludeIfEnum>? excludeIf = default, List<ListRequest.IncludeIfEnum>? includeIf = default, float? limit = default, ListRequest.ManufacturerEnum? manufacturer = default, string? pageCursor = default, string? search = default, string? spaceId = default, string? unstableLocationId = default, string? userIdentifierKey = default)
{
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<OffResponse>("/thermostats/off", requestOptions)).Data.ActionAttempt;
}
...
public SetFallbackClimatePresetRequest(string climatePresetKey = default, string deviceId = default)
{
ClimatePresetKey = climatePresetKey;
DeviceId = deviceId;
}
...
public void SetFallbackClimatePreset(string climatePresetKey = default, string deviceId = default)
{
SetFallbackClimatePreset(new SetFallbackClimatePresetRequest(climatePresetKey: climatePresetKey, deviceId: deviceId));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
await _seam.PostAsync<object>("/thermostats/set_fallback_climate_preset", requestOptions);
}

public async Task SetFallbackClimatePresetAsync(string climatePresetKey = default, string deviceId = default)
{
await SetFallbackClimatePresetAsync(new SetFallbackClimatePresetRequest(climatePresetKey: climatePresetKey, deviceId: deviceId));
}
...
public SetFanModeRequest(string deviceId = default, SetFanModeRequest.FanModeEnum? fanMode = default, SetFanModeRequest.FanModeSettingEnum? fanModeSetting = default, bool? sync = default)
{
DeviceId = deviceId;
FanMode = fanMode;
FanModeSetting = fanModeSetting;
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return _seam.Post<SetFanModeResponse>("/thermostats/set_fan_mode", requestOptions).Data.ActionAttempt;
}

public ActionAttempt SetFanMode(string deviceId = default, SetFanModeRequest.FanModeEnum? fanMode = default, SetFanModeRequest.FanModeSettingEnum? fanModeSetting = default, bool? sync = default)
{
return SetFanMode(new SetFanModeRequest(deviceId: deviceId, fanMode: fanMode, fanModeSetting: fanModeSetting, sync: sync));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<SetFanModeResponse>("/thermostats/set_fan_mode", requestOptions)).Data.ActionAttempt;
}

public async Task<ActionAttempt> SetFanModeAsync(string deviceId = default, SetFanModeRequest.FanModeEnum? fanMode = default, SetFanModeRequest.FanModeSettingEnum? fanModeSetting = default, bool? sync = default)
{
return (await SetFanModeAsync(new SetFanModeRequest(deviceId: deviceId, fanMode: fanMode, fanModeSetting: fanModeSetting, sync: sync)));
}
...
public SetHvacModeRequest(string deviceId = default, SetHvacModeRequest.HvacModeSettingEnum hvacModeSetting = default, float? coolingSetPointCelsius = default, float? coolingSetPointFahrenheit = default, float? heatingSetPointCelsius = default, float? heatingSetPointFahrenheit = default)
{
DeviceId = deviceId;
HvacModeSetting = hvacModeSetting;
CoolingSetPointCelsius = coolingSetPointCelsius;
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return _seam.Post<SetHvacModeResponse>("/thermostats/set_hvac_mode", requestOptions).Data.ActionAttempt;
}

public ActionAttempt SetHvacMode(string deviceId = default, SetHvacModeRequest.HvacModeSettingEnum hvacModeSetting = default, float? coolingSetPointCelsius = default, float? coolingSetPointFahrenheit = default, float? heatingSetPointCelsius = default, float? heatingSetPointFahrenheit = default)
{
return SetHvacMode(new SetHvacModeRequest(deviceId: deviceId, hvacModeSetting: hvacModeSetting, coolingSetPointCelsius: coolingSetPointCelsius, coolingSetPointFahrenheit: coolingSetPointFahrenheit, heatingSetPointCelsius: heatingSetPointCelsius, heatingSetPointFahrenheit: heatingSetPointFahrenheit));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<SetHvacModeResponse>("/thermostats/set_hvac_mode", requestOptions)).Data.ActionAttempt;
}

public async Task<ActionAttempt> SetHvacModeAsync(string deviceId = default, SetHvacModeRequest.HvacModeSettingEnum hvacModeSetting = default, float? coolingSetPointCelsius = default, float? coolingSetPointFahrenheit = default, float? heatingSetPointCelsius = default, float? heatingSetPointFahrenheit = default)
{
return (await SetHvacModeAsync(new SetHvacModeRequest(deviceId: deviceId, hvacModeSetting: hvacModeSetting, coolingSetPointCelsius: coolingSetPointCelsius, coolingSetPointFahrenheit: coolingSetPointFahrenheit, heatingSetPointCelsius: heatingSetPointCelsius, heatingSetPointFahrenheit: heatingSetPointFahrenheit)));
}
...
public SetTemperatureThresholdRequest(string deviceId = default, float? lowerLimitCelsius = default, float? lowerLimitFahrenheit = default, float? upperLimitCelsius = default, float? upperLimitFahrenheit = default)
{
DeviceId = deviceId;
...
public void SetTemperatureThreshold(string deviceId = default, float? lowerLimitCelsius = default, float? lowerLimitFahrenheit = default, float? upperLimitCelsius = default, float? upperLimitFahrenheit = default)
{
SetTemperatureThreshold(new SetTemperatureThresholdRequest(deviceId: deviceId, lowerLimitCelsius: lowerLimitCelsius, lowerLimitFahrenheit: lowerLimitFahrenheit, upperLimitCelsius: upperLimitCelsius, upperLimitFahrenheit: upperLimitFahrenheit));
}
...
public async Task SetTemperatureThresholdAsync(string deviceId = default, float? lowerLimitCelsius = default, float? lowerLimitFahrenheit = default, float? upperLimitCelsius = default, float? upperLimitFahrenheit = default)
{
await SetTemperatureThresholdAsync(new SetTemperatureThresholdRequest(deviceId: deviceId, lowerLimitCelsius: lowerLimitCelsius, lowerLimitFahrenheit: lowerLimitFahrenheit, upperLimitCelsius: upperLimitCelsius, upperLimitFahrenheit: upperLimitFahrenheit));
}
...
public UpdateClimatePresetRequest(string climatePresetKey = default, UpdateClimatePresetRequest.ClimatePresetModeEnum? climatePresetMode = default, float? coolingSetPointCelsius = default, float? coolingSetPointFahrenheit = default, string deviceId = default, UpdateClimatePresetRequestEcobeeMetadata? ecobeeMetadata = default, UpdateClimatePresetRequest.FanModeSettingEnum? fanModeSetting = default, float? heatingSetPointCelsius = default, float? heatingSetPointFahrenheit = default, UpdateClimatePresetRequest.HvacModeSettingEnum? hvacModeSetting = default, bool? manualOverrideAllowed = default, string? name = default)
{
ClimatePresetKey = climatePresetKey;
ClimatePresetMode = climatePresetMode;
CoolingSetPointCelsius = coolingSetPointCelsius;
...
public UpdateClimatePresetRequestEcobeeMetadata(string? climateRef = default, bool? isOptimized = default, UpdateClimatePresetRequestEcobeeMetadata.OwnerEnum? owner = default)
{
ClimateRef = climateRef;
IsOptimized = isOptimized;
Owner = owner;
...
public void UpdateClimatePreset(string climatePresetKey = default, UpdateClimatePresetRequest.ClimatePresetModeEnum? climatePresetMode = default, float? coolingSetPointCelsius = default, float? coolingSetPointFahrenheit = default, string deviceId = default, UpdateClimatePresetRequestEcobeeMetadata? ecobeeMetadata = default, UpdateClimatePresetRequest.FanModeSettingEnum? fanModeSetting = default, float? heatingSetPointCelsius = default, float? heatingSetPointFahrenheit = default, UpdateClimatePresetRequest.HvacModeSettingEnum? hvacModeSetting = default, bool? manualOverrideAllowed = default, string? name = default)
{
...
public async Task UpdateClimatePresetAsync(string climatePresetKey = default, UpdateClimatePresetRequest.ClimatePresetModeEnum? climatePresetMode = default, float? coolingSetPointCelsius = default, float? coolingSetPointFahrenheit = default, string deviceId = default, UpdateClimatePresetRequestEcobeeMetadata? ecobeeMetadata = default, UpdateClimatePresetRequest.FanModeSettingEnum? fanModeSetting = default, float? heatingSetPointCelsius = default, float? heatingSetPointFahrenheit = default, UpdateClimatePresetRequest.HvacModeSettingEnum? hvacModeSetting = default, bool? manualOverrideAllowed = default, string? name = default)
{
await UpdateClimatePresetAsync(new UpdateClimatePresetRequest(climatePresetKey: climatePresetKey, climatePresetMode: climatePresetMode, coolingSetPointCelsius: coolingSetPointCelsius, coolingSetPointFahrenheit: coolingSetPointFahrenheit, deviceId: deviceId, ecobeeMetadata: ecobeeMetadata, fanModeSetting: fanModeSetting, heatingSetPointCelsius: heatingSetPointCelsius, heatingSetPointFahrenheit: heatingSetPointFahrenheit, hvacModeSetting: hvacModeSetting, manualOverrideAllowed: manualOverrideAllowed, name: name));
}
...
public UpdateWeeklyProgramRequest(string deviceId = default, string? fridayProgramId = default, string? mondayProgramId = default, string? saturdayProgramId = default, string? sundayProgramId = default, string? thursdayProgramId = default, string? tuesdayProgramId = default, string? wednesdayProgramId = default)
{
DeviceId = deviceId;
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return _seam.Post<UpdateWeeklyProgramResponse>("/thermostats/update_weekly_program", requestOptions).Data.ActionAttempt;
}

public ActionAttempt UpdateWeeklyProgram(string deviceId = default, string? fridayProgramId = default, string? mondayProgramId = default, string? saturdayProgramId = default, string? sundayProgramId = default, string? thursdayProgramId = default, string? tuesdayProgramId = default, string? wednesdayProgramId = default)
{
return UpdateWeeklyProgram(new UpdateWeeklyProgramRequest(deviceId: deviceId, fridayProgramId: fridayProgramId, mondayProgramId: mondayProgramId, saturdayProgramId: saturdayProgramId, sundayProgramId: sundayProgramId, thursdayProgramId: thursdayProgramId, tuesdayProgramId: tuesdayProgramId, wednesdayProgramId: wednesdayProgramId));
}

public async Task<ActionAttempt> UpdateWeeklyProgramAsync(UpdateWeeklyProgramRequest request)
{
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<UpdateWeeklyProgramResponse>("/thermostats/update_weekly_program", requestOptions)).Data.ActionAttempt;
}

public async Task<ActionAttempt> UpdateWeeklyProgramAsync(string deviceId = default, string? fridayProgramId = default, string? mondayProgramId = default, string? saturdayProgramId = default, string? sundayProgramId = default, string? thursdayProgramId = default, string? tuesdayProgramId = default, string? wednesdayProgramId = default)
{
return (await UpdateWeeklyProgramAsync(new UpdateWeeklyProgramRequest(deviceId: deviceId, fridayProgramId: fridayProgramId, mondayProgramId: mondayProgramId, saturdayProgramId: saturdayProgramId, sundayProgramId: sundayProgramId, thursdayProgramId: thursdayProgramId, tuesdayProgramId: tuesdayProgramId, wednesdayProgramId: wednesdayProgramId)));
}
}
}
