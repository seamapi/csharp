...
public CreateSandboxPhoneRequest(CreateSandboxPhoneRequestAssaAbloyMetadata? assaAbloyMetadata = default, string? customSdkInstallationId = default, CreateSandboxPhoneRequestPhoneMetadata? phoneMetadata = default, string userIdentityId = default)
{
...
[DataMember(Name = "custom_sdk_installation_id", IsRequired = false, EmitDefaultValue = false)]
...
public CreateSandboxPhoneRequestAssaAbloyMetadata(string? applicationVersion = default, bool? bleCapability = default, bool? hceCapability = default, bool? nfcCapability = default, string? seosAppletVersion = default, float? seosTsmEndpointId = default)
{
...
[DataMember(Name = "seos_tsm_endpoint_id", IsRequired = false, EmitDefaultValue = false)]
...
public CreateSandboxPhoneRequestPhoneMetadata(string? deviceManufacturer = default, string? deviceModel = default, CreateSandboxPhoneRequestPhoneMetadata.OperatingSystemEnum? operatingSystem = default, string? osVersion = default)
{
...
return _seam.Post<CreateSandboxPhoneResponse>("/phones/simulate/create_sandbox_phone", requestOptions).Data.Phone;
}

public Phone CreateSandboxPhone(CreateSandboxPhoneRequestAssaAbloyMetadata? assaAbloyMetadata = default, string? customSdkInstallationId = default, CreateSandboxPhoneRequestPhoneMetadata? phoneMetadata = default, string userIdentityId = default)
{
return CreateSandboxPhone(new CreateSandboxPhoneRequest(assaAbloyMetadata: assaAbloyMetadata, customSdkInstallationId: customSdkInstallationId, phoneMetadata: phoneMetadata, userIdentityId: userIdentityId));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<CreateSandboxPhoneResponse>("/phones/simulate/create_sandbox_phone", requestOptions)).Data.Phone;
}

public async Task<Phone> CreateSandboxPhoneAsync(CreateSandboxPhoneRequestAssaAbloyMetadata? assaAbloyMetadata = default, string? customSdkInstallationId = default, CreateSandboxPhoneRequestPhoneMetadata? phoneMetadata = default, string userIdentityId = default)
{
return (await CreateSandboxPhoneAsync(new CreateSandboxPhoneRequest(assaAbloyMetadata: assaAbloyMetadata, customSdkInstallationId: customSdkInstallationId, phoneMetadata: phoneMetadata, userIdentityId: userIdentityId)));
}
}
}
