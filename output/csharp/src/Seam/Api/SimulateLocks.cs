...
return _seam.Post<KeypadCodeEntryResponse>("/locks/simulate/keypad_code_entry", requestOptions).Data.ActionAttempt;
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<KeypadCodeEntryResponse>("/locks/simulate/keypad_code_entry", requestOptions)).Data.ActionAttempt;
}

public async Task<ActionAttempt> KeypadCodeEntryAsync(string code = default, string deviceId = default)
{
return (await KeypadCodeEntryAsync(new KeypadCodeEntryRequest(code: code, deviceId: deviceId)));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return _seam.Post<ManualLockViaKeypadResponse>("/locks/simulate/manual_lock_via_keypad", requestOptions).Data.ActionAttempt;
}
...
public async Task<ActionAttempt> ManualLockViaKeypadAsync(ManualLockViaKeypadRequest request)
{
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<ManualLockViaKeypadResponse>("/locks/simulate/manual_lock_via_keypad", requestOptions)).Data.ActionAttempt;
}

public async Task<ActionAttempt> ManualLockViaKeypadAsync(string deviceId = default)
{
return (await ManualLockViaKeypadAsync(new ManualLockViaKeypadRequest(deviceId: deviceId)));
}
}
}
