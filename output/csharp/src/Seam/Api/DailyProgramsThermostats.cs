...
public CreateRequest(string deviceId = default, string name = default, List<CreateRequestPeriods> periods = default)
{
DeviceId = deviceId;
Name = name;
Periods = periods;
...
public CreateRequestPeriods(string? climatePresetKey = default, string? startsAtTime = default)
{
...
[DataMember(Name = "thermostat_daily_program", IsRequired = false, EmitDefaultValue = false)]
...
return _seam.Post<CreateResponse>("/thermostats/daily_programs/create", requestOptions).Data.ThermostatDailyProgram;
}

public ThermostatDailyProgram Create(string deviceId = default, string name = default, List<CreateRequestPeriods> periods = default)
{
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<CreateResponse>("/thermostats/daily_programs/create", requestOptions)).Data.ThermostatDailyProgram;
}

public async Task<ThermostatDailyProgram> CreateAsync(string deviceId = default, string name = default, List<CreateRequestPeriods> periods = default)
{
return (await CreateAsync(new CreateRequest(deviceId: deviceId, name: name, periods: periods)));
}
...
{
await DeleteAsync(new DeleteRequest(thermostatDailyProgramId: thermostatDailyProgramId));
}
...
public UpdateRequest(string name = default, List<UpdateRequestPeriods> periods = default, string thermostatDailyProgramId = default)
{
Name = name;
Periods = periods;
ThermostatDailyProgramId = thermostatDailyProgramId;
...
public UpdateRequestPeriods(string? climatePresetKey = default, string? startsAtTime = default)
{
ClimatePresetKey = climatePresetKey;
StartsAtTime = startsAtTime;
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return _seam.Post<UpdateResponse>("/thermostats/daily_programs/update", requestOptions).Data.ActionAttempt;
}

public ActionAttempt Update(string name = default, List<UpdateRequestPeriods> periods = default, string thermostatDailyProgramId = default)
{
return Update(new UpdateRequest(name: name, periods: periods, thermostatDailyProgramId: thermostatDailyProgramId));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<UpdateResponse>("/thermostats/daily_programs/update", requestOptions)).Data.ActionAttempt;
}

public async Task<ActionAttempt> UpdateAsync(string name = default, List<UpdateRequestPeriods> periods = default, string thermostatDailyProgramId = default)
{
return (await UpdateAsync(new UpdateRequest(name: name, periods: periods, thermostatDailyProgramId: thermostatDailyProgramId)));
}
}
}
