...
public ListRequest(string? acsCredentialId = default, string? ownerUserIdentityId = default)
{
...
public List<Phone> List(string? acsCredentialId = default, string? ownerUserIdentityId = default)
{
return List(new ListRequest(acsCredentialId: acsCredentialId, ownerUserIdentityId: ownerUserIdentityId));
}
...
public async Task<List<Phone>> ListAsync(string? acsCredentialId = default, string? ownerUserIdentityId = default)
{
return (await ListAsync(new ListRequest(acsCredentialId: acsCredentialId, ownerUserIdentityId: ownerUserIdentityId)));
}
}
}
