...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<ListResponse>("/devices/list", requestOptions)).Data.Devices;
}
...
public ListDeviceProvidersRequest(ListDeviceProvidersRequest.ProviderCategoryEnum? providerCategory = default)
{
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return _seam.Post<ListDeviceProvidersResponse>("/devices/list_device_providers", requestOptions).Data.DeviceProviders;
}

public List<DeviceProvider> ListDeviceProviders(ListDeviceProvidersRequest.ProviderCategoryEnum? providerCategory = default)
{
return ListDeviceProviders(new ListDeviceProvidersRequest(providerCategory: providerCategory));
}

public async Task<List<DeviceProvider>> ListDeviceProvidersAsync(ListDeviceProvidersRequest request)
{
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<ListDeviceProvidersResponse>("/devices/list_device_providers", requestOptions)).Data.DeviceProviders;
}

public async Task<List<DeviceProvider>> ListDeviceProvidersAsync(ListDeviceProvidersRequest.ProviderCategoryEnum? providerCategory = default)
{
return (await ListDeviceProvidersAsync(new ListDeviceProvidersRequest(providerCategory: providerCategory)));
}
...
public ReportProviderMetadataRequest(List<ReportProviderMetadataRequestDevices> devices = default)
{
Devices = devices;
}
...
public ReportProviderMetadataRequestDevices(string? deviceId = default, ReportProviderMetadataRequestDevicesOmnitecMetadata? omnitecMetadata = default, ReportProviderMetadataRequestDevicesSchlageMetadata? schlageMetadata = default, ReportProviderMetadataRequestDevicesUltraloqMetadata? ultraloqMetadata = default)
{
DeviceId = deviceId;
...
[DataContract(Name = "reportProviderMetadataRequestDevicesOmnitecMetadata_model")]
public class ReportProviderMetadataRequestDevicesOmnitecMetadata
{
[JsonConstructorAttribute]
protected ReportProviderMetadataRequestDevicesOmnitecMetadata() { }

public ReportProviderMetadataRequestDevicesOmnitecMetadata(ReportProviderMetadataRequestDevicesOmnitecMetadata.TimeZoneEnum? timeZone = default)
{
TimeZone = timeZone;
}
...
[DataContract(Name = "reportProviderMetadataRequestDevicesSchlageMetadata_model")]
public class ReportProviderMetadataRequestDevicesSchlageMetadata
{
[JsonConstructorAttribute]
protected ReportProviderMetadataRequestDevicesSchlageMetadata() { }

public ReportProviderMetadataRequestDevicesSchlageMetadata(ReportProviderMetadataRequestDevicesSchlageMetadata.TimeZoneEnum? timeZone = default)
{
TimeZone = timeZone;
}
...
public ReportProviderMetadataRequestDevicesUltraloqMetadata(ReportProviderMetadataRequestDevicesUltraloqMetadata.TimeZoneEnum? timeZone = default)
{
TimeZone = timeZone;
}
...
public void ReportProviderMetadata(List<ReportProviderMetadataRequestDevices> devices = default)
{
...
public async Task ReportProviderMetadataAsync(List<ReportProviderMetadataRequestDevices> devices = default)
{
...
public UpdateRequest(bool? backupAccessCodePoolEnabled = default, object? customMetadata = default, string deviceId = default, bool? isManaged = default, string? name = default, UpdateRequestProperties? properties = default)
{
...
public void Update(bool? backupAccessCodePoolEnabled = default, object? customMetadata = default, string deviceId = default, bool? isManaged = default, string? name = default, UpdateRequestProperties? properties = default)
{
Update(new UpdateRequest(backupAccessCodePoolEnabled: backupAccessCodePoolEnabled, customMetadata: customMetadata, deviceId: deviceId, isManaged: isManaged, name: name, properties: properties));
}
...
public async Task UpdateAsync(bool? backupAccessCodePoolEnabled = default, object? customMetadata = default, string deviceId = default, bool? isManaged = default, string? name = default, UpdateRequestProperties? properties = default)
{
await UpdateAsync(new UpdateRequest(backupAccessCodePoolEnabled: backupAccessCodePoolEnabled, customMetadata: customMetadata, deviceId: deviceId, isManaged: isManaged, name: name, properties: properties));
}
}
}
