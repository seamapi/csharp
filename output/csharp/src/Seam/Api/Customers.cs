...
public CustomerPortal CreatePortal(List<CreatePortalRequestCustomerResourcesFilters>? customerResourcesFilters = default, string? customizationProfileId = default, bool? excludeLocalePicker = default, CreatePortalRequestFeatures? features = default, bool? isEmbedded = default, CreatePortalRequestLandingPage? landingPage = default, CreatePortalRequest.LocaleEnum? locale = default, CreatePortalRequest.NavigationModeEnum? navigationMode = default, CreatePortalRequestCustomerData? customerData = default)
{
return CreatePortal(new CreatePortalRequest(customerResourcesFilters: customerResourcesFilters, customizationProfileId: customizationProfileId, excludeLocalePicker: excludeLocalePicker, features: features, isEmbedded: isEmbedded, landingPage: landingPage, locale: locale, navigationMode: navigationMode, customerData: customerData));
}
...
public async Task<CustomerPortal> CreatePortalAsync(List<CreatePortalRequestCustomerResourcesFilters>? customerResourcesFilters = default, string? customizationProfileId = default, bool? excludeLocalePicker = default, CreatePortalRequestFeatures? features = default, bool? isEmbedded = default, CreatePortalRequestLandingPage? landingPage = default, CreatePortalRequest.LocaleEnum? locale = default, CreatePortalRequest.NavigationModeEnum? navigationMode = default, CreatePortalRequestCustomerData? customerData = default)
{
return (await CreatePortalAsync(new CreatePortalRequest(customerResourcesFilters: customerResourcesFilters, customizationProfileId: customizationProfileId, excludeLocalePicker: excludeLocalePicker, features: features, isEmbedded: isEmbedded, landingPage: landingPage, locale: locale, navigationMode: navigationMode, customerData: customerData)));
}
