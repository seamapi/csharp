...
public CreatePortalRequest(bool? dev = default, List<CreatePortalRequestCustomerResourcesFilters>? customerResourcesFilters = default, string? customizationProfileId = default, CreatePortalRequestDeepLink? deepLink = default, bool? excludeLocalePicker = default, CreatePortalRequestFeatures? features = default, bool? isEmbedded = default, CreatePortalRequestLandingPage? landingPage = default, CreatePortalRequest.LocaleEnum? locale = default, CreatePortalRequest.NavigationModeEnum? navigationMode = default, CreatePortalRequestCustomerData? customerData = default)
{
Dev = dev;
...
[DataMember(Name = "customer_resources_filters", IsRequired = false, EmitDefaultValue = false)]
...
[DataMember(Name = "exclude_locale_picker", IsRequired = false, EmitDefaultValue = false)]
...
public CreatePortalRequestCustomerResourcesFilters(string? field = default, CreatePortalRequestCustomerResourcesFilters.OperationEnum? operation = default, CreatePortalRequestCustomerResourcesFiltersValue? value = default)
{
Field = field;
Operation = operation;
Value = value;
...
public CreatePortalRequestDeepLink(string? resourceKey = default, CreatePortalRequestDeepLink.ResourceTypeEnum? resourceType = default)
{
...
public CreatePortalRequestFeatures(CreatePortalRequestFeaturesConfigure? configure = default, CreatePortalRequestFeaturesConnect? connect = default, CreatePortalRequestFeaturesManage? manage = default, CreatePortalRequestFeaturesManageDevices? manageDevices = default, CreatePortalRequestFeaturesOrganize? organize = default)
{
Configure = configure;
Connect = connect;
Manage = manage;
...
public CreatePortalRequestFeaturesConfigure(bool? allowAccessAutomationRuleCustomization = default, bool? allowClimateAutomationRuleCustomization = default, bool? allowInstantKeyCustomization = default, bool? exclude = default)
{
...
[DataMember(Name = "allow_access_automation_rule_customization", IsRequired = false, EmitDefaultValue = false)]
public bool? AllowAccessAutomationRuleCustomization { get; set; }

[DataMember(Name = "allow_climate_automation_rule_customization", IsRequired = false, EmitDefaultValue = false)]
public bool? AllowClimateAutomationRuleCustomization { get; set; }

[DataMember(Name = "allow_instant_key_customization", IsRequired = false, EmitDefaultValue = false)]
...
public CreatePortalRequestFeaturesConnect(List<string>? acceptedProviders = default, bool? exclude = default, List<string>? excludedProviders = default)
{
...
[DataMember(Name = "device_management_confirmation", IsRequired = false, EmitDefaultValue = false)]
...
[DataMember(Name = "exclude_reservation_management", IsRequired = false, EmitDefaultValue = false)]
public bool? ExcludeReservationManagement { get; set; }

[DataMember(Name = "exclude_reservation_technical_details", IsRequired = false, EmitDefaultValue = false)]
public bool? ExcludeReservationTechnicalDetails { get; set; }

[DataMember(Name = "exclude_staff_management", IsRequired = false, EmitDefaultValue = false)]
...
public CreatePortalRequestFeaturesManageDeviceManagementConfirmation(string? body = default, string? cancelButtonLabel = default, string? confirmButtonLabel = default, string? title = default)
{
Body = body;
...
[DataMember(Name = "confirm_button_label", IsRequired = false, EmitDefaultValue = false)]
...
public CreatePortalRequestFeaturesManageEvents(List<string>? allowedEvents = default, List<string>? defaultEvents = default)
{
...
public CreatePortalRequestLandingPage(CreatePortalRequestLandingPageManage? manage = default)
{
Manage = manage;
}
...
public CreatePortalRequestLandingPageManage(string? spaceKey = default, string? propertyKey = default, string? roomKey = default, string? commonAreaKey = default, string? unitKey = default, string? facilityKey = default, string? buildingKey = default, string? listingKey = default, string? propertyListingKey = default, string? siteKey = default, string? reservationKey = default, string? bookingKey = default, string? accessGrantKey = default)
{
SpaceKey = spaceKey;
...
[DataMember(Name = "property_listing_key", IsRequired = false, EmitDefaultValue = false)]
...
public CreatePortalRequestCustomerData(List<CreatePortalRequestCustomerDataAccessGrants>? accessGrants = default, List<CreatePortalRequestCustomerDataBookings>? bookings = default, List<CreatePortalRequestCustomerDataBuildings>? buildings = default, List<CreatePortalRequestCustomerDataCommonAreas>? commonAreas = default, string? customerKey = default, List<CreatePortalRequestCustomerDataFacilities>? facilities = default, List<CreatePortalRequestCustomerDataGuests>? guests = default, List<CreatePortalRequestCustomerDataListings>? listings = default, List<CreatePortalRequestCustomerDataProperties>? properties = default, List<CreatePortalRequestCustomerDataPropertyListings>? propertyListings = default, List<CreatePortalRequestCustomerDataReservations>? reservations = default, List<CreatePortalRequestCustomerDataResidents>? residents = default, List<CreatePortalRequestCustomerDataRooms>? rooms = default, List<CreatePortalRequestCustomerDataSites>? sites = default, List<CreatePortalRequestCustomerDataSpaces>? spaces = default, List<CreatePortalRequestCustomerDataStaffMembers>? staffMembers = default, List<CreatePortalRequestCustomerDataTenants>? tenants = default, List<CreatePortalRequestCustomerDataUnits>? units = default, List<CreatePortalRequestCustomerDataUserIdentities>? userIdentities = default, List<CreatePortalRequestCustomerDataUsers>? users = default)
{
...
public CreatePortalRequestCustomerDataAccessGrants(string? accessGrantKey = default, List<string>? buildingKeys = default, List<string>? commonAreaKeys = default, string? endsAt = default, List<string>? facilityKeys = default, string? guestKey = default, List<string>? listingKeys = default, string? name = default, string? preferredCode = default, List<string>? propertyKeys = default, string? residentKey = default, List<string>? roomKeys = default, List<string>? spaceKeys = default, string? startsAt = default, string? tenantKey = default, List<string>? unitKeys = default, string? userIdentityKey = default, string? userKey = default)
{
AccessGrantKey = accessGrantKey;
...
public CreatePortalRequestCustomerDataBookings(string? bookingKey = default, List<string>? buildingKeys = default, List<string>? commonAreaKeys = default, string? endsAt = default, List<string>? facilityKeys = default, string? guestKey = default, List<string>? listingKeys = default, string? name = default, string? preferredCode = default, List<string>? propertyKeys = default, string? residentKey = default, List<string>? roomKeys = default, List<string>? spaceKeys = default, string? startsAt = default, string? tenantKey = default, List<string>? unitKeys = default, string? userIdentityKey = default, string? userKey = default)
{
BookingKey = bookingKey;
BuildingKeys = buildingKeys;
CommonAreaKeys = commonAreaKeys;
...
public CreatePortalRequestCustomerDataBuildings(string? buildingKey = default, string? name = default)
{
BuildingKey = buildingKey;
Name = name;
}
...
public CreatePortalRequestCustomerDataCommonAreas(string? commonAreaKey = default, string? name = default, string? parentSiteKey = default)
{
CommonAreaKey = commonAreaKey;
Name = name;
...
public CreatePortalRequestCustomerDataFacilities(string? facilityKey = default, string? name = default)
{
FacilityKey = facilityKey;
Name = name;
}
...
public CreatePortalRequestCustomerDataGuests(string? emailAddress = default, string? guestKey = default, string? name = default, string? phoneNumber = default)
{
...
public CreatePortalRequestCustomerDataListings(string? listingKey = default, string? name = default)
{
ListingKey = listingKey;
Name = name;
}
...
public CreatePortalRequestCustomerDataProperties(string? name = default, string? propertyKey = default)
{
Name = name;
PropertyKey = propertyKey;
}
...
public CreatePortalRequestCustomerDataPropertyListings(object? customMetadata = default, string? name = default, string? propertyListingKey = default)
{
...
public CreatePortalRequestCustomerDataReservations(List<string>? buildingKeys = default, List<string>? commonAreaKeys = default, object? customMetadata = default, string? endsAt = default, List<string>? facilityKeys = default, string? guestKey = default, List<string>? listingKeys = default, string? name = default, string? preferredCode = default, List<string>? propertyKeys = default, string? reservationKey = default, string? residentKey = default, List<string>? roomKeys = default, List<string>? spaceKeys = default, string? startsAt = default, string? tenantKey = default, List<string>? unitKeys = default, string? userIdentityKey = default, string? userKey = default)
{
BuildingKeys = buildingKeys;
CommonAreaKeys = commonAreaKeys;
CustomMetadata = customMetadata;
...
public CreatePortalRequestCustomerDataResidents(string? emailAddress = default, string? name = default, string? phoneNumber = default, string? residentKey = default)
{
EmailAddress = emailAddress;
Name = name;
PhoneNumber = phoneNumber;
...
public CreatePortalRequestCustomerDataRooms(string? name = default, string? parentSiteKey = default, string? roomKey = default)
{
Name = name;
ParentSiteKey = parentSiteKey;
RoomKey = roomKey;
...
public CreatePortalRequestCustomerDataSites(string? name = default, string? siteKey = default)
{
Name = name;
SiteKey = siteKey;
}
...
public CreatePortalRequestCustomerDataSpaces(CreatePortalRequestCustomerDataSpacesCustomerData? customerData = default, int? durationMinutes = default, CreatePortalRequestCustomerDataSpacesGeolocation? geolocation = default, string? name = default, string? parentSiteKey = default, string? spaceKey = default)
{
CustomerData = customerData;
...
public CreatePortalRequestCustomerDataSpacesCustomerData(string? address = default, string? defaultCheckinTime = default, string? defaultCheckoutTime = default, string? timeZone = default)
{
Address = address;
...
public CreatePortalRequestCustomerDataSpacesGeolocation(float? latitude = default, float? longitude = default)
{
Latitude = latitude;
Longitude = longitude;
}
...
public CreatePortalRequestCustomerDataStaffMembers(List<string>? buildingKeys = default, List<string>? commonAreaKeys = default, string? emailAddress = default, List<string>? facilityKeys = default, List<string>? listingKeys = default, string? name = default, string? phoneNumber = default, List<string>? propertyKeys = default, List<string>? propertyListingKeys = default, List<string>? roomKeys = default, List<string>? siteKeys = default, List<string>? spaceKeys = default, string? staffMemberKey = default, List<string>? unitKeys = default)
{
BuildingKeys = buildingKeys;
CommonAreaKeys = commonAreaKeys;
EmailAddress = emailAddress;
...
public CreatePortalRequestCustomerDataTenants(string? emailAddress = default, string? name = default, string? phoneNumber = default, string? tenantKey = default)
{
EmailAddress = emailAddress;
Name = name;
PhoneNumber = phoneNumber;
...
public CreatePortalRequestCustomerDataUnits(string? name = default, string? parentSiteKey = default, string? unitKey = default)
{
Name = name;
ParentSiteKey = parentSiteKey;
UnitKey = unitKey;
...
public CreatePortalRequestCustomerDataUserIdentities(string? emailAddress = default, string? name = default, string? phoneNumber = default, string? userIdentityKey = default)
{
EmailAddress = emailAddress;
Name = name;
PhoneNumber = phoneNumber;
...
public CreatePortalRequestCustomerDataUsers(string? emailAddress = default, string? name = default, string? phoneNumber = default, string? userKey = default)
{
EmailAddress = emailAddress;
Name = name;
PhoneNumber = phoneNumber;
...
return _seam.Post<CreatePortalResponse>("/customers/create_portal", requestOptions).Data.CustomerPortal;
}

public CustomerPortal CreatePortal(bool? dev = default, List<CreatePortalRequestCustomerResourcesFilters>? customerResourcesFilters = default, string? customizationProfileId = default, CreatePortalRequestDeepLink? deepLink = default, bool? excludeLocalePicker = default, CreatePortalRequestFeatures? features = default, bool? isEmbedded = default, CreatePortalRequestLandingPage? landingPage = default, CreatePortalRequest.LocaleEnum? locale = default, CreatePortalRequest.NavigationModeEnum? navigationMode = default, CreatePortalRequestCustomerData? customerData = default)
{
return CreatePortal(new CreatePortalRequest(dev: dev, customerResourcesFilters: customerResourcesFilters, customizationProfileId: customizationProfileId, deepLink: deepLink, excludeLocalePicker: excludeLocalePicker, features: features, isEmbedded: isEmbedded, landingPage: landingPage, locale: locale, navigationMode: navigationMode, customerData: customerData));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<CreatePortalResponse>("/customers/create_portal", requestOptions)).Data.CustomerPortal;
}

public async Task<CustomerPortal> CreatePortalAsync(bool? dev = default, List<CreatePortalRequestCustomerResourcesFilters>? customerResourcesFilters = default, string? customizationProfileId = default, CreatePortalRequestDeepLink? deepLink = default, bool? excludeLocalePicker = default, CreatePortalRequestFeatures? features = default, bool? isEmbedded = default, CreatePortalRequestLandingPage? landingPage = default, CreatePortalRequest.LocaleEnum? locale = default, CreatePortalRequest.NavigationModeEnum? navigationMode = default, CreatePortalRequestCustomerData? customerData = default)
{
return (await CreatePortalAsync(new CreatePortalRequest(dev: dev, customerResourcesFilters: customerResourcesFilters, customizationProfileId: customizationProfileId, deepLink: deepLink, excludeLocalePicker: excludeLocalePicker, features: features, isEmbedded: isEmbedded, landingPage: landingPage, locale: locale, navigationMode: navigationMode, customerData: customerData)));
}
...
public DeleteDataRequest(List<string>? accessGrantKeys = default, List<string>? bookingKeys = default, List<string>? buildingKeys = default, List<string>? commonAreaKeys = default, List<string>? customerKeys = default, List<string>? facilityKeys = default, List<string>? guestKeys = default, List<string>? listingKeys = default, List<string>? propertyKeys = default, List<string>? propertyListingKeys = default, List<string>? reservationKeys = default, List<string>? residentKeys = default, List<string>? roomKeys = default, List<string>? spaceKeys = default, List<string>? staffMemberKeys = default, List<string>? tenantKeys = default, List<string>? unitKeys = default, List<string>? userIdentityKeys = default, List<string>? userKeys = default)
{
...
public void DeleteData(List<string>? accessGrantKeys = default, List<string>? bookingKeys = default, List<string>? buildingKeys = default, List<string>? commonAreaKeys = default, List<string>? customerKeys = default, List<string>? facilityKeys = default, List<string>? guestKeys = default, List<string>? listingKeys = default, List<string>? propertyKeys = default, List<string>? propertyListingKeys = default, List<string>? reservationKeys = default, List<string>? residentKeys = default, List<string>? roomKeys = default, List<string>? spaceKeys = default, List<string>? staffMemberKeys = default, List<string>? tenantKeys = default, List<string>? unitKeys = default, List<string>? userIdentityKeys = default, List<string>? userKeys = default)
{
DeleteData(new DeleteDataRequest(accessGrantKeys: accessGrantKeys, bookingKeys: bookingKeys, buildingKeys: buildingKeys, commonAreaKeys: commonAreaKeys, customerKeys: customerKeys, facilityKeys: facilityKeys, guestKeys: guestKeys, listingKeys: listingKeys, propertyKeys: propertyKeys, propertyListingKeys: propertyListingKeys, reservationKeys: reservationKeys, residentKeys: residentKeys, roomKeys: roomKeys, spaceKeys: spaceKeys, staffMemberKeys: staffMemberKeys, tenantKeys: tenantKeys, unitKeys: unitKeys, userIdentityKeys: userIdentityKeys, userKeys: userKeys));
}
...
{
await DeleteDataAsync(new DeleteDataRequest(accessGrantKeys: accessGrantKeys, bookingKeys: bookingKeys, buildingKeys: buildingKeys, commonAreaKeys: commonAreaKeys, customerKeys: customerKeys, facilityKeys: facilityKeys, guestKeys: guestKeys, listingKeys: listingKeys, propertyKeys: propertyKeys, propertyListingKeys: propertyListingKeys, reservationKeys: reservationKeys, residentKeys: residentKeys, roomKeys: roomKeys, spaceKeys: spaceKeys, staffMemberKeys: staffMemberKeys, tenantKeys: tenantKeys, unitKeys: unitKeys, userIdentityKeys: userIdentityKeys, userKeys: userKeys));
}
...
public PushDataRequest(List<PushDataRequestAccessGrants>? accessGrants = default, List<PushDataRequestBookings>? bookings = default, List<PushDataRequestBuildings>? buildings = default, List<PushDataRequestCommonAreas>? commonAreas = default, string customerKey = default, List<PushDataRequestFacilities>? facilities = default, List<PushDataRequestGuests>? guests = default, List<PushDataRequestListings>? listings = default, List<PushDataRequestProperties>? properties = default, List<PushDataRequestPropertyListings>? propertyListings = default, List<PushDataRequestReservations>? reservations = default, List<PushDataRequestResidents>? residents = default, List<PushDataRequestRooms>? rooms = default, List<PushDataRequestSites>? sites = default, List<PushDataRequestSpaces>? spaces = default, List<PushDataRequestStaffMembers>? staffMembers = default, List<PushDataRequestTenants>? tenants = default, List<PushDataRequestUnits>? units = default, List<PushDataRequestUserIdentities>? userIdentities = default, List<PushDataRequestUsers>? users = default)
{
AccessGrants = accessGrants;
Bookings = bookings;
Buildings = buildings;
...
public PushDataRequestAccessGrants(string? accessGrantKey = default, List<string>? buildingKeys = default, List<string>? commonAreaKeys = default, string? endsAt = default, List<string>? facilityKeys = default, string? guestKey = default, List<string>? listingKeys = default, string? name = default, string? preferredCode = default, List<string>? propertyKeys = default, string? residentKey = default, List<string>? roomKeys = default, List<string>? spaceKeys = default, string? startsAt = default, string? tenantKey = default, List<string>? unitKeys = default, string? userIdentityKey = default, string? userKey = default)
{
AccessGrantKey = accessGrantKey;
BuildingKeys = buildingKeys;
CommonAreaKeys = commonAreaKeys;
...
public PushDataRequestBookings(string? bookingKey = default, List<string>? buildingKeys = default, List<string>? commonAreaKeys = default, string? endsAt = default, List<string>? facilityKeys = default, string? guestKey = default, List<string>? listingKeys = default, string? name = default, string? preferredCode = default, List<string>? propertyKeys = default, string? residentKey = default, List<string>? roomKeys = default, List<string>? spaceKeys = default, string? startsAt = default, string? tenantKey = default, List<string>? unitKeys = default, string? userIdentityKey = default, string? userKey = default)
{
BookingKey = bookingKey;
BuildingKeys = buildingKeys;
CommonAreaKeys = commonAreaKeys;
...
public PushDataRequestCommonAreas(string? commonAreaKey = default, string? name = default, string? parentSiteKey = default)
{
CommonAreaKey = commonAreaKey;
Name = name;
ParentSiteKey = parentSiteKey;
...
public PushDataRequestGuests(string? emailAddress = default, string? guestKey = default, string? name = default, string? phoneNumber = default)
{
EmailAddress = emailAddress;
GuestKey = guestKey;
Name = name;
...
public PushDataRequestPropertyListings(object? customMetadata = default, string? name = default, string? propertyListingKey = default)
{
CustomMetadata = customMetadata;
Name = name;
PropertyListingKey = propertyListingKey;
...
public PushDataRequestReservations(List<string>? buildingKeys = default, List<string>? commonAreaKeys = default, object? customMetadata = default, string? endsAt = default, List<string>? facilityKeys = default, string? guestKey = default, List<string>? listingKeys = default, string? name = default, string? preferredCode = default, List<string>? propertyKeys = default, string? reservationKey = default, string? residentKey = default, List<string>? roomKeys = default, List<string>? spaceKeys = default, string? startsAt = default, string? tenantKey = default, List<string>? unitKeys = default, string? userIdentityKey = default, string? userKey = default)
{
BuildingKeys = buildingKeys;
CommonAreaKeys = commonAreaKeys;
CustomMetadata = customMetadata;
...
public PushDataRequestResidents(string? emailAddress = default, string? name = default, string? phoneNumber = default, string? residentKey = default)
{
EmailAddress = emailAddress;
Name = name;
PhoneNumber = phoneNumber;
...
public PushDataRequestRooms(string? name = default, string? parentSiteKey = default, string? roomKey = default)
{
Name = name;
ParentSiteKey = parentSiteKey;
RoomKey = roomKey;
...
public PushDataRequestSpaces(PushDataRequestSpacesCustomerData? customerData = default, int? durationMinutes = default, PushDataRequestSpacesGeolocation? geolocation = default, string? name = default, string? parentSiteKey = default, string? spaceKey = default)
{
CustomerData = customerData;
DurationMinutes = durationMinutes;
Geolocation = geolocation;
...
public PushDataRequestSpacesCustomerData(string? address = default, string? defaultCheckinTime = default, string? defaultCheckoutTime = default, string? timeZone = default)
{
Address = address;
DefaultCheckinTime = defaultCheckinTime;
DefaultCheckoutTime = defaultCheckoutTime;
...
public PushDataRequestSpacesGeolocation(float? latitude = default, float? longitude = default)
{
Latitude = latitude;
Longitude = longitude;
}
...
public PushDataRequestStaffMembers(List<string>? buildingKeys = default, List<string>? commonAreaKeys = default, string? emailAddress = default, List<string>? facilityKeys = default, List<string>? listingKeys = default, string? name = default, string? phoneNumber = default, List<string>? propertyKeys = default, List<string>? propertyListingKeys = default, List<string>? roomKeys = default, List<string>? siteKeys = default, List<string>? spaceKeys = default, string? staffMemberKey = default, List<string>? unitKeys = default)
{
BuildingKeys = buildingKeys;
CommonAreaKeys = commonAreaKeys;
EmailAddress = emailAddress;
...
public PushDataRequestTenants(string? emailAddress = default, string? name = default, string? phoneNumber = default, string? tenantKey = default)
{
EmailAddress = emailAddress;
Name = name;
PhoneNumber = phoneNumber;
...
public PushDataRequestUnits(string? name = default, string? parentSiteKey = default, string? unitKey = default)
{
Name = name;
ParentSiteKey = parentSiteKey;
UnitKey = unitKey;
...
public PushDataRequestUserIdentities(string? emailAddress = default, string? name = default, string? phoneNumber = default, string? userIdentityKey = default)
{
EmailAddress = emailAddress;
Name = name;
PhoneNumber = phoneNumber;
...
public PushDataRequestUsers(string? emailAddress = default, string? name = default, string? phoneNumber = default, string? userKey = default)
{
EmailAddress = emailAddress;
Name = name;
PhoneNumber = phoneNumber;
...
public void PushData(List<PushDataRequestAccessGrants>? accessGrants = default, List<PushDataRequestBookings>? bookings = default, List<PushDataRequestBuildings>? buildings = default, List<PushDataRequestCommonAreas>? commonAreas = default, string customerKey = default, List<PushDataRequestFacilities>? facilities = default, List<PushDataRequestGuests>? guests = default, List<PushDataRequestListings>? listings = default, List<PushDataRequestProperties>? properties = default, List<PushDataRequestPropertyListings>? propertyListings = default, List<PushDataRequestReservations>? reservations = default, List<PushDataRequestResidents>? residents = default, List<PushDataRequestRooms>? rooms = default, List<PushDataRequestSites>? sites = default, List<PushDataRequestSpaces>? spaces = default, List<PushDataRequestStaffMembers>? staffMembers = default, List<PushDataRequestTenants>? tenants = default, List<PushDataRequestUnits>? units = default, List<PushDataRequestUserIdentities>? userIdentities = default, List<PushDataRequestUsers>? users = default)
{
PushData(new PushDataRequest(accessGrants: accessGrants, bookings: bookings, buildings: buildings, commonAreas: commonAreas, customerKey: customerKey, facilities: facilities, guests: guests, listings: listings, properties: properties, propertyListings: propertyListings, reservations: reservations, residents: residents, rooms: rooms, sites: sites, spaces: spaces, staffMembers: staffMembers, tenants: tenants, units: units, userIdentities: userIdentities, users: users));
}
...
public async Task PushDataAsync(List<PushDataRequestAccessGrants>? accessGrants = default, List<PushDataRequestBookings>? bookings = default, List<PushDataRequestBuildings>? buildings = default, List<PushDataRequestCommonAreas>? commonAreas = default, string customerKey = default, List<PushDataRequestFacilities>? facilities = default, List<PushDataRequestGuests>? guests = default, List<PushDataRequestListings>? listings = default, List<PushDataRequestProperties>? properties = default, List<PushDataRequestPropertyListings>? propertyListings = default, List<PushDataRequestReservations>? reservations = default, List<PushDataRequestResidents>? residents = default, List<PushDataRequestRooms>? rooms = default, List<PushDataRequestSites>? sites = default, List<PushDataRequestSpaces>? spaces = default, List<PushDataRequestStaffMembers>? staffMembers = default, List<PushDataRequestTenants>? tenants = default, List<PushDataRequestUnits>? units = default, List<PushDataRequestUserIdentities>? userIdentities = default, List<PushDataRequestUsers>? users = default)
{
await PushDataAsync(new PushDataRequest(accessGrants: accessGrants, bookings: bookings, buildings: buildings, commonAreas: commonAreas, customerKey: customerKey, facilities: facilities, guests: guests, listings: listings, properties: properties, propertyListings: propertyListings, reservations: reservations, residents: residents, rooms: rooms, sites: sites, spaces: spaces, staffMembers: staffMembers, tenants: tenants, units: units, userIdentities: userIdentities, users: users));
}
}
}
