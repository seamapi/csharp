...
public CreateRequest(bool? allowExternalModification = default, bool? attemptForOfflineDevice = default, string? code = default, string? commonCodeKey = default, string deviceId = default, string? endsAt = default, bool? isExternalModificationAllowed = default, bool? isOfflineAccessCode = default, bool? isOneTimeUse = default, CreateRequest.MaxTimeRoundingEnum? maxTimeRounding = default, string? name = default, bool? preferNativeScheduling = default, float? preferredCodeLength = default, string? startsAt = default, bool? sync = default, bool? useBackupAccessCodePool = default, bool? useOfflineAccessCode = default)
{
...
[DataMember(Name = "allow_external_modification", IsRequired = false, EmitDefaultValue = false)]
public bool? AllowExternalModification { get; set; }

[DataMember(Name = "attempt_for_offline_device", IsRequired = false, EmitDefaultValue = false)]
...
[DataMember(Name = "prefer_native_scheduling", IsRequired = false, EmitDefaultValue = false)]
public bool? PreferNativeScheduling { get; set; }

[DataMember(Name = "preferred_code_length", IsRequired = false, EmitDefaultValue = false)]
...
[DataMember(Name = "use_backup_access_code_pool", IsRequired = false, EmitDefaultValue = false)]
public bool? UseBackupAccessCodePool { get; set; }

[DataMember(Name = "use_offline_access_code", IsRequired = false, EmitDefaultValue = false)]
...
return _seam.Post<CreateResponse>("/access_codes/create", requestOptions).Data.AccessCode;
}

public AccessCode Create(bool? allowExternalModification = default, bool? attemptForOfflineDevice = default, string? code = default, string? commonCodeKey = default, string deviceId = default, string? endsAt = default, bool? isExternalModificationAllowed = default, bool? isOfflineAccessCode = default, bool? isOneTimeUse = default, CreateRequest.MaxTimeRoundingEnum? maxTimeRounding = default, string? name = default, bool? preferNativeScheduling = default, float? preferredCodeLength = default, string? startsAt = default, bool? sync = default, bool? useBackupAccessCodePool = default, bool? useOfflineAccessCode = default)
{
return Create(new CreateRequest(allowExternalModification: allowExternalModification, attemptForOfflineDevice: attemptForOfflineDevice, code: code, commonCodeKey: commonCodeKey, deviceId: deviceId, endsAt: endsAt, isExternalModificationAllowed: isExternalModificationAllowed, isOfflineAccessCode: isOfflineAccessCode, isOneTimeUse: isOneTimeUse, maxTimeRounding: maxTimeRounding, name: name, preferNativeScheduling: preferNativeScheduling, preferredCodeLength: preferredCodeLength, startsAt: startsAt, sync: sync, useBackupAccessCodePool: useBackupAccessCodePool, useOfflineAccessCode: useOfflineAccessCode));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<CreateResponse>("/access_codes/create", requestOptions)).Data.AccessCode;
}

public async Task<AccessCode> CreateAsync(bool? allowExternalModification = default, bool? attemptForOfflineDevice = default, string? code = default, string? commonCodeKey = default, string deviceId = default, string? endsAt = default, bool? isExternalModificationAllowed = default, bool? isOfflineAccessCode = default, bool? isOneTimeUse = default, CreateRequest.MaxTimeRoundingEnum? maxTimeRounding = default, string? name = default, bool? preferNativeScheduling = default, float? preferredCodeLength = default, string? startsAt = default, bool? sync = default, bool? useBackupAccessCodePool = default, bool? useOfflineAccessCode = default)
{
return (await CreateAsync(new CreateRequest(allowExternalModification: allowExternalModification, attemptForOfflineDevice: attemptForOfflineDevice, code: code, commonCodeKey: commonCodeKey, deviceId: deviceId, endsAt: endsAt, isExternalModificationAllowed: isExternalModificationAllowed, isOfflineAccessCode: isOfflineAccessCode, isOneTimeUse: isOneTimeUse, maxTimeRounding: maxTimeRounding, name: name, preferNativeScheduling: preferNativeScheduling, preferredCodeLength: preferredCodeLength, startsAt: startsAt, sync: sync, useBackupAccessCodePool: useBackupAccessCodePool, useOfflineAccessCode: useOfflineAccessCode)));
}
...
public CreateMultipleRequest(bool? allowExternalModification = default, bool? attemptForOfflineDevice = default, CreateMultipleRequest.BehaviorWhenCodeCannotBeSharedEnum? behaviorWhenCodeCannotBeShared = default, string? code = default, List<string> deviceIds = default, string? endsAt = default, bool? isExternalModificationAllowed = default, string? name = default, bool? preferNativeScheduling = default, float? preferredCodeLength = default, string? startsAt = default, bool? useBackupAccessCodePool = default)
{
AllowExternalModification = allowExternalModification;
AttemptForOfflineDevice = attemptForOfflineDevice;
...
[DataMember(Name = "behavior_when_code_cannot_be_shared", IsRequired = false, EmitDefaultValue = false)]
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return _seam.Post<CreateMultipleResponse>("/access_codes/create_multiple", requestOptions).Data.AccessCodes;
}

public List<AccessCode> CreateMultiple(bool? allowExternalModification = default, bool? attemptForOfflineDevice = default, CreateMultipleRequest.BehaviorWhenCodeCannotBeSharedEnum? behaviorWhenCodeCannotBeShared = default, string? code = default, List<string> deviceIds = default, string? endsAt = default, bool? isExternalModificationAllowed = default, string? name = default, bool? preferNativeScheduling = default, float? preferredCodeLength = default, string? startsAt = default, bool? useBackupAccessCodePool = default)
{
return CreateMultiple(new CreateMultipleRequest(allowExternalModification: allowExternalModification, attemptForOfflineDevice: attemptForOfflineDevice, behaviorWhenCodeCannotBeShared: behaviorWhenCodeCannotBeShared, code: code, deviceIds: deviceIds, endsAt: endsAt, isExternalModificationAllowed: isExternalModificationAllowed, name: name, preferNativeScheduling: preferNativeScheduling, preferredCodeLength: preferredCodeLength, startsAt: startsAt, useBackupAccessCodePool: useBackupAccessCodePool));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<CreateMultipleResponse>("/access_codes/create_multiple", requestOptions)).Data.AccessCodes;
}

public async Task<List<AccessCode>> CreateMultipleAsync(bool? allowExternalModification = default, bool? attemptForOfflineDevice = default, CreateMultipleRequest.BehaviorWhenCodeCannotBeSharedEnum? behaviorWhenCodeCannotBeShared = default, string? code = default, List<string> deviceIds = default, string? endsAt = default, bool? isExternalModificationAllowed = default, string? name = default, bool? preferNativeScheduling = default, float? preferredCodeLength = default, string? startsAt = default, bool? useBackupAccessCodePool = default)
{
return (await CreateMultipleAsync(new CreateMultipleRequest(allowExternalModification: allowExternalModification, attemptForOfflineDevice: attemptForOfflineDevice, behaviorWhenCodeCannotBeShared: behaviorWhenCodeCannotBeShared, code: code, deviceIds: deviceIds, endsAt: endsAt, isExternalModificationAllowed: isExternalModificationAllowed, name: name, preferNativeScheduling: preferNativeScheduling, preferredCodeLength: preferredCodeLength, startsAt: startsAt, useBackupAccessCodePool: useBackupAccessCodePool)));
}
...
public DeleteRequest(string accessCodeId = default, string? deviceId = default, bool? sync = default)
{
...
public void Delete(string accessCodeId = default, string? deviceId = default, bool? sync = default)
{
...
public async Task DeleteAsync(string accessCodeId = default, string? deviceId = default, bool? sync = default)
{
await DeleteAsync(new DeleteRequest(accessCodeId: accessCodeId, deviceId: deviceId, sync: sync));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return _seam.Post<GenerateCodeResponse>("/access_codes/generate_code", requestOptions).Data.GeneratedCode;
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<GenerateCodeResponse>("/access_codes/generate_code", requestOptions)).Data.GeneratedCode;
}
...
public GetRequest(string? accessCodeId = default, string? code = default, string? deviceId = default)
{
AccessCodeId = accessCodeId;
Code = code;
DeviceId = deviceId;
...
public AccessCode Get(string? accessCodeId = default, string? code = default, string? deviceId = default)
{
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<GetResponse>("/access_codes/get", requestOptions)).Data.AccessCode;
}

public async Task<AccessCode> GetAsync(string? accessCodeId = default, string? code = default, string? deviceId = default)
{
return (await GetAsync(new GetRequest(accessCodeId: accessCodeId, code: code, deviceId: deviceId)));
}
...
public ListRequest(List<string>? accessCodeIds = default, string? accessGrantId = default, string? accessGrantKey = default, string? accessMethodId = default, string? customerKey = default, string? deviceId = default, float? limit = default, string? pageCursor = default, string? search = default, string? userIdentifierKey = default)
{
...
public List<AccessCode> List(List<string>? accessCodeIds = default, string? accessGrantId = default, string? accessGrantKey = default, string? accessMethodId = default, string? customerKey = default, string? deviceId = default, float? limit = default, string? pageCursor = default, string? search = default, string? userIdentifierKey = default)
{
return List(new ListRequest(accessCodeIds: accessCodeIds, accessGrantId: accessGrantId, accessGrantKey: accessGrantKey, accessMethodId: accessMethodId, customerKey: customerKey, deviceId: deviceId, limit: limit, pageCursor: pageCursor, search: search, userIdentifierKey: userIdentifierKey));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<ListResponse>("/access_codes/list", requestOptions)).Data.AccessCodes;
}

public async Task<List<AccessCode>> ListAsync(List<string>? accessCodeIds = default, string? accessGrantId = default, string? accessGrantKey = default, string? accessMethodId = default, string? customerKey = default, string? deviceId = default, float? limit = default, string? pageCursor = default, string? search = default, string? userIdentifierKey = default)
{
return (await ListAsync(new ListRequest(accessCodeIds: accessCodeIds, accessGrantId: accessGrantId, accessGrantKey: accessGrantKey, accessMethodId: accessMethodId, customerKey: customerKey, deviceId: deviceId, limit: limit, pageCursor: pageCursor, search: search, userIdentifierKey: userIdentifierKey)));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return _seam.Post<PullBackupAccessCodeResponse>("/access_codes/pull_backup_access_code", requestOptions).Data.AccessCode;
}

public AccessCode PullBackupAccessCode(string accessCodeId = default)
{
return PullBackupAccessCode(new PullBackupAccessCodeRequest(accessCodeId: accessCodeId));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<PullBackupAccessCodeResponse>("/access_codes/pull_backup_access_code", requestOptions)).Data.AccessCode;
}

public async Task<AccessCode> PullBackupAccessCodeAsync(string accessCodeId = default)
{
return (await PullBackupAccessCodeAsync(new PullBackupAccessCodeRequest(accessCodeId: accessCodeId)));
}
...
public ReportDeviceConstraintsRequest(string deviceId = default, int? maxCodeLength = default, int? minCodeLength = default, List<int>? supportedCodeLengths = default)
{
DeviceId = deviceId;
...
public void ReportDeviceConstraints(string deviceId = default, int? maxCodeLength = default, int? minCodeLength = default, List<int>? supportedCodeLengths = default)
{
ReportDeviceConstraints(new ReportDeviceConstraintsRequest(deviceId: deviceId, maxCodeLength: maxCodeLength, minCodeLength: minCodeLength, supportedCodeLengths: supportedCodeLengths));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
await _seam.PostAsync<object>("/access_codes/report_device_constraints", requestOptions);
}

public async Task ReportDeviceConstraintsAsync(string deviceId = default, int? maxCodeLength = default, int? minCodeLength = default, List<int>? supportedCodeLengths = default)
{
await ReportDeviceConstraintsAsync(new ReportDeviceConstraintsRequest(deviceId: deviceId, maxCodeLength: maxCodeLength, minCodeLength: minCodeLength, supportedCodeLengths: supportedCodeLengths));
}
...
public UpdateRequest(string accessCodeId = default, bool? allowExternalModification = default, bool? attemptForOfflineDevice = default, string? code = default, string? deviceId = default, string? endsAt = default, bool? isExternalModificationAllowed = default, bool? isManaged = default, bool? isOfflineAccessCode = default, bool? isOneTimeUse = default, UpdateRequest.MaxTimeRoundingEnum? maxTimeRounding = default, string? name = default, bool? preferNativeScheduling = default, float? preferredCodeLength = default, string? startsAt = default, bool? sync = default, UpdateRequest.TypeEnum? type = default, bool? useBackupAccessCodePool = default, bool? useOfflineAccessCode = default)
{
AccessCodeId = accessCodeId;
AllowExternalModification = allowExternalModification;
AttemptForOfflineDevice = attemptForOfflineDevice;
...
public async Task UpdateAsync(string accessCodeId = default, bool? allowExternalModification = default, bool? attemptForOfflineDevice = default, string? code = default, string? deviceId = default, string? endsAt = default, bool? isExternalModificationAllowed = default, bool? isManaged = default, bool? isOfflineAccessCode = default, bool? isOneTimeUse = default, UpdateRequest.MaxTimeRoundingEnum? maxTimeRounding = default, string? name = default, bool? preferNativeScheduling = default, float? preferredCodeLength = default, string? startsAt = default, bool? sync = default, UpdateRequest.TypeEnum? type = default, bool? useBackupAccessCodePool = default, bool? useOfflineAccessCode = default)
{
await UpdateAsync(new UpdateRequest(accessCodeId: accessCodeId, allowExternalModification: allowExternalModification, attemptForOfflineDevice: attemptForOfflineDevice, code: code, deviceId: deviceId, endsAt: endsAt, isExternalModificationAllowed: isExternalModificationAllowed, isManaged: isManaged, isOfflineAccessCode: isOfflineAccessCode, isOneTimeUse: isOneTimeUse, maxTimeRounding: maxTimeRounding, name: name, preferNativeScheduling: preferNativeScheduling, preferredCodeLength: preferredCodeLength, startsAt: startsAt, sync: sync, type: type, useBackupAccessCodePool: useBackupAccessCodePool, useOfflineAccessCode: useOfflineAccessCode));
}
...
public UpdateMultipleRequest(string commonCodeKey = default, string? endsAt = default, string? name = default, string? startsAt = default)
{
CommonCodeKey = commonCodeKey;
EndsAt = endsAt;
Name = name;
...
public void UpdateMultiple(string commonCodeKey = default, string? endsAt = default, string? name = default, string? startsAt = default)
{
UpdateMultiple(new UpdateMultipleRequest(commonCodeKey: commonCodeKey, endsAt: endsAt, name: name, startsAt: startsAt));
}
...
public async Task UpdateMultipleAsync(string commonCodeKey = default, string? endsAt = default, string? name = default, string? startsAt = default)
{
await UpdateMultipleAsync(new UpdateMultipleRequest(commonCodeKey: commonCodeKey, endsAt: endsAt, name: name, startsAt: startsAt));
}
}
}
