...
namespace Seam.Api
{
  public class AccessCodes
  {
    ...
    public ActionAttempt Delete(DeleteRequest request)
    {
      var requestOptions = new RequestOptions();
      requestOptions.Data = request;
      return _seam.Post<DeleteResponse>("/access_codes/delete", requestOptions).Data.ActionAttempt;
    }
    ...
    {
      return Delete(new DeleteRequest(deviceId: deviceId, accessCodeId: accessCodeId, sync: sync));
    }
    ...
    public async Task<AccessCode> GenerateCodeAsync(GenerateCodeRequest request)
    {
      ...
      requestOptions.Data = request;
      return (
        await _seam.PostAsync<GenerateCodeResponse>("/access_codes/generate_code", requestOptions)
      )
        .Data
        .GeneratedCode;
    }
    ...
    {
      return (
        await GetAsync(new GetRequest(deviceId: deviceId, accessCodeId: accessCodeId, code: code))
      );
    }
    ...
    public AccessCode PullBackupAccessCode(PullBackupAccessCodeRequest request)
    {
      ...
      requestOptions.Data = request;
      return _seam
        .Post<PullBackupAccessCodeResponse>("/access_codes/pull_backup_access_code", requestOptions)
    ...
    {
      return (
        await PullBackupAccessCodeAsync(new PullBackupAccessCodeRequest(accessCodeId: accessCodeId))
      );
    }
    ...
    public ActionAttempt Update(UpdateRequest request)
    {
      var requestOptions = new RequestOptions();
      requestOptions.Data = request;
      return _seam.Post<UpdateResponse>("/access_codes/update", requestOptions).Data.ActionAttempt;
    }
