...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<CreateResponse>("/webhooks/create", requestOptions)).Data.Webhook;
}

public async Task<Webhook> CreateAsync(List<string>? eventTypes = default, string url = default)
{
