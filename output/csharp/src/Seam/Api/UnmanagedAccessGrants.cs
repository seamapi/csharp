...
public List<object> List(string? acsEntranceId = default, string? acsSystemId = default, float? limit = default, string? pageCursor = default, string? reservationKey = default, string? userIdentityId = default)
{
...
public async Task<List<object>> ListAsync(string? acsEntranceId = default, string? acsSystemId = default, float? limit = default, string? pageCursor = default, string? reservationKey = default, string? userIdentityId = default)
{
