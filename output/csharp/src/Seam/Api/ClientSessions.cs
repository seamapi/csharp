...
namespace Seam.Api
{
  public class ClientSessions
  {
    ...
    public async Task<ClientSession> CreateAsync(CreateRequest request)
    {
      var requestOptions = new RequestOptions();
      requestOptions.Data = request;
      return (await _seam.PostAsync<CreateResponse>("/client_sessions/create", requestOptions))
        .Data
        .ClientSession;
    }
    ...
    {
      return Get(
        new GetRequest(clientSessionId: clientSessionId, userIdentifierKey: userIdentifierKey)
      );
    }
    ...
    public async Task<ClientSession> GetOrCreateAsync(GetOrCreateRequest request)
    {
      ...
      requestOptions.Data = request;
      return (
        await _seam.PostAsync<GetOrCreateResponse>("/client_sessions/get_or_create", requestOptions)
      )
        .Data
        .ClientSession;
    }
