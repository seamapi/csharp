...
public AssignRequest(string acsCredentialId = default, string? acsUserId = default, string? userIdentityId = default)
{
...
public void Assign(string acsCredentialId = default, string? acsUserId = default, string? userIdentityId = default)
{
Assign(new AssignRequest(acsCredentialId: acsCredentialId, acsUserId: acsUserId, userIdentityId: userIdentityId));
}
...
public async Task AssignAsync(string acsCredentialId = default, string? acsUserId = default, string? userIdentityId = default)
{
await AssignAsync(new AssignRequest(acsCredentialId: acsCredentialId, acsUserId: acsUserId, userIdentityId: userIdentityId));
}
...
public CreateRequest(CreateRequest.AccessMethodEnum accessMethod = default, string? acsSystemId = default, string? acsUserId = default, List<string>? allowedAcsEntranceIds = default, CreateRequestAssaAbloyVostioMetadata? assaAbloyVostioMetadata = default, string? code = default, string? credentialManagerAcsSystemId = default, string? endsAt = default, CreateRequestHotekMetadata? hotekMetadata = default, bool? isMultiPhoneSyncCredential = default, CreateRequestSaltoSpaceMetadata? saltoSpaceMetadata = default, string? startsAt = default, string? userIdentityId = default, CreateRequestVisionlineMetadata? visionlineMetadata = default)
{
...
[DataMember(Name = "allowed_acs_entrance_ids", IsRequired = false, EmitDefaultValue = false)]
...
public CreateRequestAssaAbloyVostioMetadata(bool? autoJoin = default, bool? joinAllGuestAcsEntrances = default, bool? overrideAllGuestAcsEntrances = default, List<string>? overrideGuestAcsEntranceIds = default)
{
AutoJoin = autoJoin;
...
[DataMember(Name = "join_all_guest_acs_entrances", IsRequired = false, EmitDefaultValue = false)]
public bool? JoinAllGuestAcsEntrances { get; set; }

[DataMember(Name = "override_all_guest_acs_entrances", IsRequired = false, EmitDefaultValue = false)]
...
public CreateRequestHotekMetadata(bool? autoJoin = default, bool? mustOverride = default)
{
AutoJoin = autoJoin;
...
public CreateRequestSaltoSpaceMetadata(bool? assignNewKey = default, bool? updateCurrentKey = default)
{
...
public CreateRequestVisionlineMetadata(string? assaAbloyCredentialServiceMobileEndpointId = default, bool? autoJoin = default, CreateRequestVisionlineMetadata.CardFormatEnum? cardFormat = default, CreateRequestVisionlineMetadata.CardFunctionTypeEnum? cardFunctionType = default, bool? isOverrideKey = default, List<string>? joinerAcsCredentialIds = default, bool? mustOverride = default)
{
AssaAbloyCredentialServiceMobileEndpointId = assaAbloyCredentialServiceMobileEndpointId;
AutoJoin = autoJoin;
...
[DataMember(Name = "assa_abloy_credential_service_mobile_endpoint_id", IsRequired = false, EmitDefaultValue = false)]
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return _seam.Post<CreateResponse>("/acs/credentials/create", requestOptions).Data.AcsCredential;
}

public AcsCredential Create(CreateRequest.AccessMethodEnum accessMethod = default, string? acsSystemId = default, string? acsUserId = default, List<string>? allowedAcsEntranceIds = default, CreateRequestAssaAbloyVostioMetadata? assaAbloyVostioMetadata = default, string? code = default, string? credentialManagerAcsSystemId = default, string? endsAt = default, CreateRequestHotekMetadata? hotekMetadata = default, bool? isMultiPhoneSyncCredential = default, CreateRequestSaltoSpaceMetadata? saltoSpaceMetadata = default, string? startsAt = default, string? userIdentityId = default, CreateRequestVisionlineMetadata? visionlineMetadata = default)
{
return Create(new CreateRequest(accessMethod: accessMethod, acsSystemId: acsSystemId, acsUserId: acsUserId, allowedAcsEntranceIds: allowedAcsEntranceIds, assaAbloyVostioMetadata: assaAbloyVostioMetadata, code: code, credentialManagerAcsSystemId: credentialManagerAcsSystemId, endsAt: endsAt, hotekMetadata: hotekMetadata, isMultiPhoneSyncCredential: isMultiPhoneSyncCredential, saltoSpaceMetadata: saltoSpaceMetadata, startsAt: startsAt, userIdentityId: userIdentityId, visionlineMetadata: visionlineMetadata));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<CreateResponse>("/acs/credentials/create", requestOptions)).Data.AcsCredential;
}

public async Task<AcsCredential> CreateAsync(CreateRequest.AccessMethodEnum accessMethod = default, string? acsSystemId = default, string? acsUserId = default, List<string>? allowedAcsEntranceIds = default, CreateRequestAssaAbloyVostioMetadata? assaAbloyVostioMetadata = default, string? code = default, string? credentialManagerAcsSystemId = default, string? endsAt = default, CreateRequestHotekMetadata? hotekMetadata = default, bool? isMultiPhoneSyncCredential = default, CreateRequestSaltoSpaceMetadata? saltoSpaceMetadata = default, string? startsAt = default, string? userIdentityId = default, CreateRequestVisionlineMetadata? visionlineMetadata = default)
{
return (await CreateAsync(new CreateRequest(accessMethod: accessMethod, acsSystemId: acsSystemId, acsUserId: acsUserId, allowedAcsEntranceIds: allowedAcsEntranceIds, assaAbloyVostioMetadata: assaAbloyVostioMetadata, code: code, credentialManagerAcsSystemId: credentialManagerAcsSystemId, endsAt: endsAt, hotekMetadata: hotekMetadata, isMultiPhoneSyncCredential: isMultiPhoneSyncCredential, saltoSpaceMetadata: saltoSpaceMetadata, startsAt: startsAt, userIdentityId: userIdentityId, visionlineMetadata: visionlineMetadata)));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return _seam.Post<GetResponse>("/acs/credentials/get", requestOptions).Data.AcsCredential;
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<GetResponse>("/acs/credentials/get", requestOptions)).Data.AcsCredential;
}
...
public ListRequest(string? acsUserId = default, string? acsSystemId = default, string? userIdentityId = default, string? createdBefore = default, bool? isMultiPhoneSyncCredential = default, float? limit = default, string? pageCursor = default, string? search = default)
{
AcsUserId = acsUserId;
AcsSystemId = acsSystemId;
UserIdentityId = userIdentityId;
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return _seam.Post<ListResponse>("/acs/credentials/list", requestOptions).Data.AcsCredentials;
}

public List<AcsCredential> List(string? acsUserId = default, string? acsSystemId = default, string? userIdentityId = default, string? createdBefore = default, bool? isMultiPhoneSyncCredential = default, float? limit = default, string? pageCursor = default, string? search = default)
{
return List(new ListRequest(acsUserId: acsUserId, acsSystemId: acsSystemId, userIdentityId: userIdentityId, createdBefore: createdBefore, isMultiPhoneSyncCredential: isMultiPhoneSyncCredential, limit: limit, pageCursor: pageCursor, search: search));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<ListResponse>("/acs/credentials/list", requestOptions)).Data.AcsCredentials;
}

public async Task<List<AcsCredential>> ListAsync(string? acsUserId = default, string? acsSystemId = default, string? userIdentityId = default, string? createdBefore = default, bool? isMultiPhoneSyncCredential = default, float? limit = default, string? pageCursor = default, string? search = default)
{
return (await ListAsync(new ListRequest(acsUserId: acsUserId, acsSystemId: acsSystemId, userIdentityId: userIdentityId, createdBefore: createdBefore, isMultiPhoneSyncCredential: isMultiPhoneSyncCredential, limit: limit, pageCursor: pageCursor, search: search)));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return _seam.Post<ListAccessibleEntrancesResponse>("/acs/credentials/list_accessible_entrances", requestOptions).Data.AcsEntrances;
}

public List<AcsEntrance> ListAccessibleEntrances(string acsCredentialId = default)
{
return ListAccessibleEntrances(new ListAccessibleEntrancesRequest(acsCredentialId: acsCredentialId));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<ListAccessibleEntrancesResponse>("/acs/credentials/list_accessible_entrances", requestOptions)).Data.AcsEntrances;
}

public async Task<List<AcsEntrance>> ListAccessibleEntrancesAsync(string acsCredentialId = default)
{
return (await ListAccessibleEntrancesAsync(new ListAccessibleEntrancesRequest(acsCredentialId: acsCredentialId)));
}
...
public UnassignRequest(string acsCredentialId = default, string? acsUserId = default, string? userIdentityId = default)
{
AcsCredentialId = acsCredentialId;
AcsUserId = acsUserId;
UserIdentityId = userIdentityId;
...
public void Unassign(string acsCredentialId = default, string? acsUserId = default, string? userIdentityId = default)
{
Unassign(new UnassignRequest(acsCredentialId: acsCredentialId, acsUserId: acsUserId, userIdentityId: userIdentityId));
}
...
public async Task UnassignAsync(string acsCredentialId = default, string? acsUserId = default, string? userIdentityId = default)
{
await UnassignAsync(new UnassignRequest(acsCredentialId: acsCredentialId, acsUserId: acsUserId, userIdentityId: userIdentityId));
}
...
public UpdateRequest(string acsCredentialId = default, string? code = default, string? endsAt = default)
{
AcsCredentialId = acsCredentialId;
Code = code;
EndsAt = endsAt;
...
public void Update(string acsCredentialId = default, string? code = default, string? endsAt = default)
{
...
public async Task UpdateAsync(string acsCredentialId = default, string? code = default, string? endsAt = default)
{
await UpdateAsync(new UpdateRequest(acsCredentialId: acsCredentialId, code: code, endsAt: endsAt));
}
}
}
