...
public CreateRequestVisionlineMetadata(bool? autoJoin = default, CreateRequestVisionlineMetadata.CardFormatEnum? cardFormat = default, CreateRequestVisionlineMetadata.CardFunctionTypeEnum? cardFunctionType = default, List<string>? joinerAcsCredentialIds = default, bool? mustOverride = default)
{
AutoJoin = autoJoin;
