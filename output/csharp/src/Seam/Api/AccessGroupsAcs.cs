...
public AddUserRequest(string acsAccessGroupId = default, string? acsUserId = default, string? userIdentityId = default)
{
...
public void AddUser(string acsAccessGroupId = default, string? acsUserId = default, string? userIdentityId = default)
{
AddUser(new AddUserRequest(acsAccessGroupId: acsAccessGroupId, acsUserId: acsUserId, userIdentityId: userIdentityId));
}
...
public async Task AddUserAsync(string acsAccessGroupId = default, string? acsUserId = default, string? userIdentityId = default)
{
await AddUserAsync(new AddUserRequest(acsAccessGroupId: acsAccessGroupId, acsUserId: acsUserId, userIdentityId: userIdentityId));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return _seam.Post<GetResponse>("/acs/access_groups/get", requestOptions).Data.AcsAccessGroup;
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<GetResponse>("/acs/access_groups/get", requestOptions)).Data.AcsAccessGroup;
}
...
public ListRequest(string? acsSystemId = default, string? acsUserId = default, string? search = default, string? userIdentityId = default)
{
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return _seam.Post<ListResponse>("/acs/access_groups/list", requestOptions).Data.AcsAccessGroups;
}

public List<AcsAccessGroup> List(string? acsSystemId = default, string? acsUserId = default, string? search = default, string? userIdentityId = default)
{
return List(new ListRequest(acsSystemId: acsSystemId, acsUserId: acsUserId, search: search, userIdentityId: userIdentityId));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<ListResponse>("/acs/access_groups/list", requestOptions)).Data.AcsAccessGroups;
}

public async Task<List<AcsAccessGroup>> ListAsync(string? acsSystemId = default, string? acsUserId = default, string? search = default, string? userIdentityId = default)
{
return (await ListAsync(new ListRequest(acsSystemId: acsSystemId, acsUserId: acsUserId, search: search, userIdentityId: userIdentityId)));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return _seam.Post<ListAccessibleEntrancesResponse>("/acs/access_groups/list_accessible_entrances", requestOptions).Data.AcsEntrances;
}

public List<AcsEntrance> ListAccessibleEntrances(string acsAccessGroupId = default)
{
return ListAccessibleEntrances(new ListAccessibleEntrancesRequest(acsAccessGroupId: acsAccessGroupId));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<ListAccessibleEntrancesResponse>("/acs/access_groups/list_accessible_entrances", requestOptions)).Data.AcsEntrances;
}

public async Task<List<AcsEntrance>> ListAccessibleEntrancesAsync(string acsAccessGroupId = default)
{
return (await ListAccessibleEntrancesAsync(new ListAccessibleEntrancesRequest(acsAccessGroupId: acsAccessGroupId)));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return _seam.Post<ListUsersResponse>("/acs/access_groups/list_users", requestOptions).Data.AcsUsers;
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<ListUsersResponse>("/acs/access_groups/list_users", requestOptions)).Data.AcsUsers;
}
...
public RemoveUserRequest(string acsAccessGroupId = default, string? acsUserId = default, string? userIdentityId = default)
{
AcsAccessGroupId = acsAccessGroupId;
AcsUserId = acsUserId;
UserIdentityId = userIdentityId;
...
public void RemoveUser(string acsAccessGroupId = default, string? acsUserId = default, string? userIdentityId = default)
{
RemoveUser(new RemoveUserRequest(acsAccessGroupId: acsAccessGroupId, acsUserId: acsUserId, userIdentityId: userIdentityId));
}
...
public async Task RemoveUserAsync(string acsAccessGroupId = default, string? acsUserId = default, string? userIdentityId = default)
{
await RemoveUserAsync(new RemoveUserRequest(acsAccessGroupId: acsAccessGroupId, acsUserId: acsUserId, userIdentityId: userIdentityId));
}
}
}
