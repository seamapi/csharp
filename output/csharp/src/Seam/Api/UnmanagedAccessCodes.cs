...
namespace Seam.Api
{
  public class UnmanagedAccessCodes
  {
    ...
    public async Task<ActionAttempt> DeleteAsync(DeleteRequest request)
    {
      ...
      requestOptions.Data = request;
      return (
        await _seam.PostAsync<DeleteResponse>("/access_codes/unmanaged/delete", requestOptions)
      )
        .Data
        .ActionAttempt;
    }
    ...
    public async Task<UnmanagedAccessCode> GetAsync(GetRequest request)
    {
      var requestOptions = new RequestOptions();
      requestOptions.Data = request;
      return (await _seam.PostAsync<GetResponse>("/access_codes/unmanaged/get", requestOptions))
        .Data
        .AccessCode;
    }
    ...
    public async Task<List<UnmanagedAccessCode>> ListAsync(ListRequest request)
    {
      var requestOptions = new RequestOptions();
      requestOptions.Data = request;
      return (await _seam.PostAsync<ListResponse>("/access_codes/unmanaged/list", requestOptions))
        .Data
        .AccessCodes;
    }
