...
[DataMember(Name = "connect_webview_customization", IsRequired = false, EmitDefaultValue = false)]
...
[DataMember(Name = "webview_primary_button_color", IsRequired = false, EmitDefaultValue = false)]
public string? WebviewPrimaryButtonColor { get; set; }

[DataMember(Name = "webview_primary_button_text_color", IsRequired = false, EmitDefaultValue = false)]
public string? WebviewPrimaryButtonTextColor { get; set; }

[DataMember(Name = "webview_success_message", IsRequired = false, EmitDefaultValue = false)]
...
public CreateRequestConnectWebviewCustomization(CreateRequestConnectWebviewCustomization.LogoShapeEnum? logoShape = default, string? primaryButtonColor = default, string? primaryButtonTextColor = default, string? successMessage = default)
{
LogoShape = logoShape;
...
[DataMember(Name = "primary_button_text_color", IsRequired = false, EmitDefaultValue = false)]
...
public Workspace Create(string? companyName = default, string? connectPartnerName = default, CreateRequestConnectWebviewCustomization? connectWebviewCustomization = default, bool? isSandbox = default, string name = default, string? organizationId = default, CreateRequest.WebviewLogoShapeEnum? webviewLogoShape = default, string? webviewPrimaryButtonColor = default, string? webviewPrimaryButtonTextColor = default, string? webviewSuccessMessage = default)
{
return Create(new CreateRequest(companyName: companyName, connectPartnerName: connectPartnerName, connectWebviewCustomization: connectWebviewCustomization, isSandbox: isSandbox, name: name, organizationId: organizationId, webviewLogoShape: webviewLogoShape, webviewPrimaryButtonColor: webviewPrimaryButtonColor, webviewPrimaryButtonTextColor: webviewPrimaryButtonTextColor, webviewSuccessMessage: webviewSuccessMessage));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<CreateResponse>("/workspaces/create", requestOptions)).Data.Workspace;
}

public async Task<Workspace> CreateAsync(string? companyName = default, string? connectPartnerName = default, CreateRequestConnectWebviewCustomization? connectWebviewCustomization = default, bool? isSandbox = default, string name = default, string? organizationId = default, CreateRequest.WebviewLogoShapeEnum? webviewLogoShape = default, string? webviewPrimaryButtonColor = default, string? webviewPrimaryButtonTextColor = default, string? webviewSuccessMessage = default)
{
return (await CreateAsync(new CreateRequest(companyName: companyName, connectPartnerName: connectPartnerName, connectWebviewCustomization: connectWebviewCustomization, isSandbox: isSandbox, name: name, organizationId: organizationId, webviewLogoShape: webviewLogoShape, webviewPrimaryButtonColor: webviewPrimaryButtonColor, webviewPrimaryButtonTextColor: webviewPrimaryButtonTextColor, webviewSuccessMessage: webviewSuccessMessage)));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<ListResponse>("/workspaces/list", requestOptions)).Data.Workspaces;
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return _seam.Post<ResetSandboxResponse>("/workspaces/reset_sandbox", requestOptions).Data.ActionAttempt;
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<ResetSandboxResponse>("/workspaces/reset_sandbox", requestOptions)).Data.ActionAttempt;
}
...
public UpdateRequest(string? connectPartnerName = default, UpdateRequestConnectWebviewCustomization? connectWebviewCustomization = default, bool? isPublishableKeyAuthEnabled = default, bool? isSuspended = default, string? name = default, string? organizationId = default)
{
ConnectPartnerName = connectPartnerName;
ConnectWebviewCustomization = connectWebviewCustomization;
...
[DataMember(Name = "is_publishable_key_auth_enabled", IsRequired = false, EmitDefaultValue = false)]
...
public UpdateRequestConnectWebviewCustomization(UpdateRequestConnectWebviewCustomization.LogoShapeEnum? logoShape = default, string? primaryButtonColor = default, string? primaryButtonTextColor = default, string? successMessage = default)
{
LogoShape = logoShape;
PrimaryButtonColor = primaryButtonColor;
PrimaryButtonTextColor = primaryButtonTextColor;
...
public void Update(string? connectPartnerName = default, UpdateRequestConnectWebviewCustomization? connectWebviewCustomization = default, bool? isPublishableKeyAuthEnabled = default, bool? isSuspended = default, string? name = default, string? organizationId = default)
{
Update(new UpdateRequest(connectPartnerName: connectPartnerName, connectWebviewCustomization: connectWebviewCustomization, isPublishableKeyAuthEnabled: isPublishableKeyAuthEnabled, isSuspended: isSuspended, name: name, organizationId: organizationId));
}
...
public async Task UpdateAsync(string? connectPartnerName = default, UpdateRequestConnectWebviewCustomization? connectWebviewCustomization = default, bool? isPublishableKeyAuthEnabled = default, bool? isSuspended = default, string? name = default, string? organizationId = default)
{
await UpdateAsync(new UpdateRequest(connectPartnerName: connectPartnerName, connectWebviewCustomization: connectWebviewCustomization, isPublishableKeyAuthEnabled: isPublishableKeyAuthEnabled, isSuspended: isSuspended, name: name, organizationId: organizationId));
}
}
}
