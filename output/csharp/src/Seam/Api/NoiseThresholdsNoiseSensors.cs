...
namespace Seam.Api
{
  public class NoiseThresholdsNoiseSensors
  {
    ...
    {
      return Delete(
        new DeleteRequest(noiseThresholdId: noiseThresholdId, deviceId: deviceId, sync: sync)
      );
    }
    ...
    public async Task<NoiseThreshold> GetAsync(GetRequest request)
    {
      ...
      requestOptions.Data = request;
      return (
        await _seam.PostAsync<GetResponse>("/noise_sensors/noise_thresholds/get", requestOptions)
      )
        .Data
        .NoiseThreshold;
    }
    ...
    public async Task<List<NoiseThreshold>> ListAsync(ListRequest request)
    {
      ...
      requestOptions.Data = request;
      return (
        await _seam.PostAsync<ListResponse>("/noise_sensors/noise_thresholds/list", requestOptions)
      )
        .Data
        .NoiseThresholds;
    }
