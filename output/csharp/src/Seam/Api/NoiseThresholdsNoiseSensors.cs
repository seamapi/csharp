...
public CreateRequest(string deviceId = default, string endsDailyAt = default, string? name = default, float? noiseThresholdDecibels = default, float? noiseThresholdNrs = default, string startsDailyAt = default)
{
DeviceId = deviceId;
...
public NoiseThreshold Create(string deviceId = default, string endsDailyAt = default, string? name = default, float? noiseThresholdDecibels = default, float? noiseThresholdNrs = default, string startsDailyAt = default)
{
return Create(new CreateRequest(deviceId: deviceId, endsDailyAt: endsDailyAt, name: name, noiseThresholdDecibels: noiseThresholdDecibels, noiseThresholdNrs: noiseThresholdNrs, startsDailyAt: startsDailyAt));
}
...
public async Task<NoiseThreshold> CreateAsync(string deviceId = default, string endsDailyAt = default, string? name = default, float? noiseThresholdDecibels = default, float? noiseThresholdNrs = default, string startsDailyAt = default)
{
return (await CreateAsync(new CreateRequest(deviceId: deviceId, endsDailyAt: endsDailyAt, name: name, noiseThresholdDecibels: noiseThresholdDecibels, noiseThresholdNrs: noiseThresholdNrs, startsDailyAt: startsDailyAt)));
}
...
{
await DeleteAsync(new DeleteRequest(deviceId: deviceId, noiseThresholdId: noiseThresholdId));
}
...
public UpdateRequest(string deviceId = default, string? endsDailyAt = default, string? name = default, float? noiseThresholdDecibels = default, string noiseThresholdId = default, float? noiseThresholdNrs = default, string? startsDailyAt = default)
{
DeviceId = deviceId;
EndsDailyAt = endsDailyAt;
Name = name;
...
public void Update(string deviceId = default, string? endsDailyAt = default, string? name = default, float? noiseThresholdDecibels = default, string noiseThresholdId = default, float? noiseThresholdNrs = default, string? startsDailyAt = default)
{
Update(new UpdateRequest(deviceId: deviceId, endsDailyAt: endsDailyAt, name: name, noiseThresholdDecibels: noiseThresholdDecibels, noiseThresholdId: noiseThresholdId, noiseThresholdNrs: noiseThresholdNrs, startsDailyAt: startsDailyAt));
}
...
public async Task UpdateAsync(string deviceId = default, string? endsDailyAt = default, string? name = default, float? noiseThresholdDecibels = default, string noiseThresholdId = default, float? noiseThresholdNrs = default, string? startsDailyAt = default)
{
await UpdateAsync(new UpdateRequest(deviceId: deviceId, endsDailyAt: endsDailyAt, name: name, noiseThresholdDecibels: noiseThresholdDecibels, noiseThresholdId: noiseThresholdId, noiseThresholdNrs: noiseThresholdNrs, startsDailyAt: startsDailyAt));
}
}
}
