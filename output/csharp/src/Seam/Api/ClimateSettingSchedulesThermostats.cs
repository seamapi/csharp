...
namespace Seam.Api
{
  public class ClimateSettingSchedulesThermostats
  {
    ...
    public class CreateRequest
    {
      ...
      [DataMember(Name = "automatic_heating_enabled", IsRequired = false, EmitDefaultValue = false)]
      public bool? AutomaticHeatingEnabled { get; set; }

      [DataMember(Name = "automatic_cooling_enabled", IsRequired = false, EmitDefaultValue = false)]
    ...
    public class CreateResponse
    {
      ...
      [DataMember(Name = "climate_setting_schedule", IsRequired = false, EmitDefaultValue = false)]
    ...
    public ClimateSettingSchedule Create(CreateRequest request)
    {
      ...
      return _seam
        .Post<CreateResponse>("/thermostats/climate_setting_schedules/create", requestOptions)
    ...
    public class GetRequest
    {
      ...
      public GetRequest(string? climateSettingScheduleId = default, string? deviceId = default)
      {
    ...
    {
      return Get(
        new GetRequest(climateSettingScheduleId: climateSettingScheduleId, deviceId: deviceId)
      );
    }
    ...
    public class ListResponse
    {
      ...
      [DataMember(Name = "climate_setting_schedules", IsRequired = false, EmitDefaultValue = false)]
    ...
    {
      return (
        await ListAsync(new ListRequest(deviceId: deviceId, userIdentifierKey: userIdentifierKey))
      );
    }
    ...
    public ClimateSettingSchedule Update(UpdateRequest request)
    {
      ...
      requestOptions.Data = request;
      return _seam
        .Post<UpdateResponse>("/thermostats/climate_setting_schedules/update", requestOptions)
        .Data.ClimateSettingSchedule;
    }
...
namespace Seam.Client
{
  ...
  {
    public Api.ClimateSettingSchedulesThermostats ClimateSettingSchedulesThermostats => new(this);
  }
