...
public ConfigureAutoLockRequest(float? autoLockDelaySeconds = default, bool autoLockEnabled = default, string deviceId = default)
{
...
return _seam.Post<ConfigureAutoLockResponse>("/locks/configure_auto_lock", requestOptions).Data.ActionAttempt;
}

public ActionAttempt ConfigureAutoLock(float? autoLockDelaySeconds = default, bool autoLockEnabled = default, string deviceId = default)
{
return ConfigureAutoLock(new ConfigureAutoLockRequest(autoLockDelaySeconds: autoLockDelaySeconds, autoLockEnabled: autoLockEnabled, deviceId: deviceId));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<ConfigureAutoLockResponse>("/locks/configure_auto_lock", requestOptions)).Data.ActionAttempt;
}

public async Task<ActionAttempt> ConfigureAutoLockAsync(float? autoLockDelaySeconds = default, bool autoLockEnabled = default, string deviceId = default)
{
return (await ConfigureAutoLockAsync(new ConfigureAutoLockRequest(autoLockDelaySeconds: autoLockDelaySeconds, autoLockEnabled: autoLockEnabled, deviceId: deviceId)));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<LockDoorResponse>("/locks/lock_door", requestOptions)).Data.ActionAttempt;
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return _seam.Post<UnlockDoorResponse>("/locks/unlock_door", requestOptions).Data.ActionAttempt;
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<UnlockDoorResponse>("/locks/unlock_door", requestOptions)).Data.ActionAttempt;
}

public async Task<ActionAttempt> UnlockDoorAsync(string deviceId = default, bool? sync = default)
{
