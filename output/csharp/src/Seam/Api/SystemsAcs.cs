...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<GetResponse>("/acs/systems/get", requestOptions)).Data.AcsSystem;
}
...
public ListRequest(string? connectedAccountId = default, string? customerKey = default, string? search = default)
{
...
public List<AcsSystem> List(string? connectedAccountId = default, string? customerKey = default, string? search = default)
{
return List(new ListRequest(connectedAccountId: connectedAccountId, customerKey: customerKey, search: search));
}
...
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<ListResponse>("/acs/systems/list", requestOptions)).Data.AcsSystems;
}

public async Task<List<AcsSystem>> ListAsync(string? connectedAccountId = default, string? customerKey = default, string? search = default)
{
return (await ListAsync(new ListRequest(connectedAccountId: connectedAccountId, customerKey: customerKey, search: search)));
}
...
public ListCompatibleCredentialManagerAcsSystemsResponse(List<AcsSystem> acsSystems = default)
{
AcsSystems = acsSystems;
}
...
public List<AcsSystem> ListCompatibleCredentialManagerAcsSystems(ListCompatibleCredentialManagerAcsSystemsRequest request)
{
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return _seam.Post<ListCompatibleCredentialManagerAcsSystemsResponse>("/acs/systems/list_compatible_credential_manager_acs_systems", requestOptions).Data.AcsSystems;
}

public List<AcsSystem> ListCompatibleCredentialManagerAcsSystems(string acsSystemId = default)
{
return ListCompatibleCredentialManagerAcsSystems(new ListCompatibleCredentialManagerAcsSystemsRequest(acsSystemId: acsSystemId));
}

public async Task<List<AcsSystem>> ListCompatibleCredentialManagerAcsSystemsAsync(ListCompatibleCredentialManagerAcsSystemsRequest request)
{
var requestOptions = new RequestOptions();
requestOptions.Data = request;
return (await _seam.PostAsync<ListCompatibleCredentialManagerAcsSystemsResponse>("/acs/systems/list_compatible_credential_manager_acs_systems", requestOptions)).Data.AcsSystems;
}

public async Task<List<AcsSystem>> ListCompatibleCredentialManagerAcsSystemsAsync(string acsSystemId = default)
{
return (await ListCompatibleCredentialManagerAcsSystemsAsync(new ListCompatibleCredentialManagerAcsSystemsRequest(acsSystemId: acsSystemId)));
}
...
public ReportDevicesRequest(List<ReportDevicesRequestAcsEncoders>? acsEncoders = default, List<ReportDevicesRequestAcsEntrances>? acsEntrances = default, string acsSystemId = default)
{
...
public ReportDevicesRequestAcsEncoders(ReportDevicesRequestAcsEncodersHotekMetadata? hotekMetadata = default, bool? isRemoved = default)
{
...
public ReportDevicesRequestAcsEntrancesHotekMetadata(string? commonAreaName = default, string? commonAreaNumber = default, string? roomNumber = default)
{
...
public void ReportDevices(List<ReportDevicesRequestAcsEncoders>? acsEncoders = default, List<ReportDevicesRequestAcsEntrances>? acsEntrances = default, string acsSystemId = default)
{
ReportDevices(new ReportDevicesRequest(acsEncoders: acsEncoders, acsEntrances: acsEntrances, acsSystemId: acsSystemId));
}
...
public async Task ReportDevicesAsync(List<ReportDevicesRequestAcsEncoders>? acsEncoders = default, List<ReportDevicesRequestAcsEntrances>? acsEntrances = default, string acsSystemId = default)
{
await ReportDevicesAsync(new ReportDevicesRequest(acsEncoders: acsEncoders, acsEntrances: acsEntrances, acsSystemId: acsSystemId));
}
}
}
