...
public List<object> List(string? createdBefore = default, int? limit = default, string? pageCursor = default, string? search = default)
{
...
public async Task<List<object>> ListAsync(string? createdBefore = default, int? limit = default, string? pageCursor = default, string? search = default)
{
