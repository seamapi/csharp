...
public GetRequest(string? deviceId = default, string? eventId = default, string? eventType = default)
{
DeviceId = deviceId;
EventId = eventId;
EventType = eventType;
...
public Event Get(string? deviceId = default, string? eventId = default, string? eventType = default)
{
...
public async Task<Event> GetAsync(string? deviceId = default, string? eventId = default, string? eventType = default)
{
return (await GetAsync(new GetRequest(deviceId: deviceId, eventId: eventId, eventType: eventType)));
}
...
public ListRequest(string? accessCodeId = default, List<string>? accessCodeIds = default, string? accessGrantId = default, List<string>? accessGrantIds = default, string? accessMethodId = default, List<string>? accessMethodIds = default, string? acsAccessGroupId = default, string? acsCredentialId = default, string? acsEncoderId = default, string? acsEntranceId = default, string? acsSystemId = default, List<string>? acsSystemIds = default, string? acsUserId = default, List<ListRequestBetween>? between = default, string? connectWebviewId = default, string? connectedAccountId = default, string? customerKey = default, string? deviceId = default, List<string>? deviceIds = default, List<string>? eventIds = default, ListRequest.EventTypeEnum? eventType = default, List<ListRequest.EventTypesEnum>? eventTypes = default, float? limit = default, string? since = default, string? spaceId = default, List<string>? spaceIds = default, float? unstableOffset = default, string? userIdentityId = default)
{
...
public async Task<List<Event>> ListAsync(string? accessCodeId = default, List<string>? accessCodeIds = default, string? accessGrantId = default, List<string>? accessGrantIds = default, string? accessMethodId = default, List<string>? accessMethodIds = default, string? acsAccessGroupId = default, string? acsCredentialId = default, string? acsEncoderId = default, string? acsEntranceId = default, string? acsSystemId = default, List<string>? acsSystemIds = default, string? acsUserId = default, List<ListRequestBetween>? between = default, string? connectWebviewId = default, string? connectedAccountId = default, string? customerKey = default, string? deviceId = default, List<string>? deviceIds = default, List<string>? eventIds = default, ListRequest.EventTypeEnum? eventType = default, List<ListRequest.EventTypesEnum>? eventTypes = default, float? limit = default, string? since = default, string? spaceId = default, List<string>? spaceIds = default, float? unstableOffset = default, string? userIdentityId = default)
{
return (await ListAsync(new ListRequest(accessCodeId: accessCodeId, accessCodeIds: accessCodeIds, accessGrantId: accessGrantId, accessGrantIds: accessGrantIds, accessMethodId: accessMethodId, accessMethodIds: accessMethodIds, acsAccessGroupId: acsAccessGroupId, acsCredentialId: acsCredentialId, acsEncoderId: acsEncoderId, acsEntranceId: acsEntranceId, acsSystemId: acsSystemId, acsSystemIds: acsSystemIds, acsUserId: acsUserId, between: between, connectWebviewId: connectWebviewId, connectedAccountId: connectedAccountId, customerKey: customerKey, deviceId: deviceId, deviceIds: deviceIds, eventIds: eventIds, eventType: eventType, eventTypes: eventTypes, limit: limit, since: since, spaceId: spaceId, spaceIds: spaceIds, unstableOffset: unstableOffset, userIdentityId: userIdentityId)));
}
}
}
