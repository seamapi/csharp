...
public Batch(object? accessCodes = default, object? accessGrants = default, object? accessMethods = default, object? acsAccessGroups = default, object? acsCredentials = default, object? acsEncoders = default, object? acsEntrances = default, object? acsSystems = default, object? acsUsers = default, object? actionAttempts = default, object? clientSessions = default, object? connectWebviews = default, object? connectedAccounts = default, object? customizationProfiles = default, object? devices = default, object? events = default, object? instantKeys = default, object? noiseThresholds = default, object? spaces = default, object? thermostatDailyPrograms = default, object? thermostatSchedules = default, object? unmanagedAccessCodes = default, object? unmanagedAcsAccessGroups = default, object? unmanagedAcsCredentials = default, object? unmanagedAcsUsers = default, object? unmanagedDevices = default, object? userIdentities = default, object? workspaces = default)
{
...
[DataMember(Name = "unmanaged_acs_access_groups", IsRequired = false, EmitDefaultValue = false)]
public object? UnmanagedAcsAccessGroups { get; set; }

[DataMember(Name = "unmanaged_acs_credentials", IsRequired = false, EmitDefaultValue = false)]
