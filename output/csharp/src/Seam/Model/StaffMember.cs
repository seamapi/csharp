...
public StaffMember(List<string>? buildingKeys = default, List<string>? commonAreaKeys = default, string? emailAddress = default, List<string>? facilityKeys = default, List<string>? listingKeys = default, string? name = default, string? phoneNumber = default, List<string>? propertyKeys = default, List<string>? propertyListingKeys = default, List<string>? roomKeys = default, List<string>? siteKeys = default, List<string>? spaceKeys = default, string? staffMemberKey = default, List<string>? unitKeys = default)
{
