...
public InstantKey(string? clientSessionId = default, string? createdAt = default, InstantKeyCustomization? customization = default, string? customizationProfileId = default, string? expiresAt = default, string? instantKeyId = default, string? instantKeyUrl = default, string? userIdentityId = default, string? workspaceId = default)
{
...
public InstantKeyCustomization(string? logoUrl = default, string? primaryColor = default, string? secondaryColor = default)
{
LogoUrl = logoUrl;
