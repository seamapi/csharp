...
[JsonSubtypes.KnownSubType(typeof(EventSpaceDeviceMembershipChanged), "space.device_membership_changed")]
...
[JsonSubtypes.KnownSubType(typeof(EventThermostatTemperatureChanged), "thermostat.temperature_changed")]
[JsonSubtypes.KnownSubType(typeof(EventThermostatTemperatureReachedSetPoint), "thermostat.temperature_reached_set_point")]
[JsonSubtypes.KnownSubType(typeof(EventThermostatTemperatureThresholdNoLongerExceeded), "thermostat.temperature_threshold_no_longer_exceeded")]
[JsonSubtypes.KnownSubType(typeof(EventThermostatTemperatureThresholdExceeded), "thermostat.temperature_threshold_exceeded")]
[JsonSubtypes.KnownSubType(typeof(EventThermostatManuallyAdjusted), "thermostat.manually_adjusted")]
[JsonSubtypes.KnownSubType(typeof(EventThermostatClimatePresetActivated), "thermostat.climate_preset_activated")]
...
[JsonSubtypes.KnownSubType(typeof(EventNoiseSensorNoiseThresholdTriggered), "noise_sensor.noise_threshold_triggered")]
[JsonSubtypes.KnownSubType(typeof(EventDeviceAccessoryKeypadDisconnected), "device.accessory_keypad_disconnected")]
[JsonSubtypes.KnownSubType(typeof(EventDeviceAccessoryKeypadConnected), "device.accessory_keypad_connected")]
[JsonSubtypes.KnownSubType(typeof(EventDeviceErrorSubscriptionRequiredResolved), "device.error.subscription_required.resolved")]
[JsonSubtypes.KnownSubType(typeof(EventDeviceErrorSubscriptionRequired), "device.error.subscription_required")]
[JsonSubtypes.KnownSubType(typeof(EventDeviceConnectionStabilized), "device.connection_stabilized")]
[JsonSubtypes.KnownSubType(typeof(EventDeviceConnectionBecameFlaky), "device.connection_became_flaky")]
[JsonSubtypes.KnownSubType(typeof(EventDeviceSaltoPrivacyModeDeactivated), "device.salto.privacy_mode_deactivated")]
[JsonSubtypes.KnownSubType(typeof(EventDeviceSaltoPrivacyModeActivated), "device.salto.privacy_mode_activated")]
[JsonSubtypes.KnownSubType(typeof(EventDeviceThirdPartyIntegrationNoLongerDetected), "device.third_party_integration_no_longer_detected")]
[JsonSubtypes.KnownSubType(typeof(EventDeviceThirdPartyIntegrationDetected), "device.third_party_integration_detected")]
...
[JsonSubtypes.KnownSubType(typeof(EventDeviceBatteryStatusChanged), "device.battery_status_changed")]
...
[JsonSubtypes.KnownSubType(typeof(EventDeviceUnmanagedDisconnected), "device.unmanaged.disconnected")]
...
[JsonSubtypes.KnownSubType(typeof(EventDeviceUnmanagedConvertedToManaged), "device.unmanaged.converted_to_managed")]
[JsonSubtypes.KnownSubType(typeof(EventDeviceConvertedToUnmanaged), "device.converted_to_unmanaged")]
...
[JsonSubtypes.KnownSubType(typeof(EventConnectWebviewLoginFailed), "connect_webview.login_failed")]
[JsonSubtypes.KnownSubType(typeof(EventConnectWebviewLoginSucceeded), "connect_webview.login_succeeded")]
[JsonSubtypes.KnownSubType(typeof(EventActionAttemptSimulateManualLockViaKeypadFailed), "action_attempt.simulate_manual_lock_via_keypad.failed")]
[JsonSubtypes.KnownSubType(typeof(EventActionAttemptSimulateManualLockViaKeypadSucceeded), "action_attempt.simulate_manual_lock_via_keypad.succeeded")]
[JsonSubtypes.KnownSubType(typeof(EventActionAttemptSimulateKeypadCodeEntryFailed), "action_attempt.simulate_keypad_code_entry.failed")]
[JsonSubtypes.KnownSubType(typeof(EventActionAttemptSimulateKeypadCodeEntrySucceeded), "action_attempt.simulate_keypad_code_entry.succeeded")]
[JsonSubtypes.KnownSubType(typeof(EventActionAttemptUnlockDoorFailed), "action_attempt.unlock_door.failed")]
[JsonSubtypes.KnownSubType(typeof(EventActionAttemptUnlockDoorSucceeded), "action_attempt.unlock_door.succeeded")]
[JsonSubtypes.KnownSubType(typeof(EventActionAttemptLockDoorFailed), "action_attempt.lock_door.failed")]
[JsonSubtypes.KnownSubType(typeof(EventActionAttemptLockDoorSucceeded), "action_attempt.lock_door.succeeded")]
[JsonSubtypes.KnownSubType(typeof(EventConnectedAccountReauthorizationRequested), "connected_account.reauthorization_requested")]
[JsonSubtypes.KnownSubType(typeof(EventConnectedAccountCompletedFirstSyncAfterReconnection), "connected_account.completed_first_sync_after_reconnection")]
[JsonSubtypes.KnownSubType(typeof(EventConnectedAccountDeleted), "connected_account.deleted")]
[JsonSubtypes.KnownSubType(typeof(EventConnectedAccountCompletedFirstSync), "connected_account.completed_first_sync")]
[JsonSubtypes.KnownSubType(typeof(EventConnectedAccountDisconnected), "connected_account.disconnected")]
[JsonSubtypes.KnownSubType(typeof(EventConnectedAccountSuccessfulLogin), "connected_account.successful_login")]
[JsonSubtypes.KnownSubType(typeof(EventConnectedAccountCreated), "connected_account.created")]
[JsonSubtypes.KnownSubType(typeof(EventConnectedAccountConnected), "connected_account.connected")]
...
[JsonSubtypes.KnownSubType(typeof(EventAccessMethodFailedToIssue), "access_method.failed_to_issue")]
[JsonSubtypes.KnownSubType(typeof(EventAccessMethodDelayInIssuing), "access_method.delay_in_issuing")]
...
[JsonSubtypes.KnownSubType(typeof(EventAccessMethodCardEncodingRequired), "access_method.card_encoding_required")]
...
[JsonSubtypes.KnownSubType(typeof(EventAccessGrantCouldNotCreateRequestedAccessMethods), "access_grant.could_not_create_requested_access_methods")]
[JsonSubtypes.KnownSubType(typeof(EventAccessGrantAccessTimesChanged), "access_grant.access_times_changed")]
[JsonSubtypes.KnownSubType(typeof(EventAccessGrantAccessToDoorLost), "access_grant.access_to_door_lost")]
[JsonSubtypes.KnownSubType(typeof(EventAccessGrantAccessGrantedToDoor), "access_grant.access_granted_to_door")]
[JsonSubtypes.KnownSubType(typeof(EventAccessGrantAccessGrantedToAllDoors), "access_grant.access_granted_to_all_doors")]
...
[JsonSubtypes.KnownSubType(typeof(EventAccessCodeUnmanagedRemoved), "access_code.unmanaged.removed")]
[JsonSubtypes.KnownSubType(typeof(EventAccessCodeUnmanagedCreated), "access_code.unmanaged.created")]
[JsonSubtypes.KnownSubType(typeof(EventAccessCodeUnmanagedFailedToConvertToManaged), "access_code.unmanaged.failed_to_convert_to_managed")]
[JsonSubtypes.KnownSubType(typeof(EventAccessCodeUnmanagedConvertedToManaged), "access_code.unmanaged.converted_to_managed")]
[JsonSubtypes.KnownSubType(typeof(EventAccessCodeBackupAccessCodePulled), "access_code.backup_access_code_pulled")]
[JsonSubtypes.KnownSubType(typeof(EventAccessCodeDeletedExternalToSeam), "access_code.deleted_external_to_seam")]
[JsonSubtypes.KnownSubType(typeof(EventAccessCodeModifiedExternalToSeam), "access_code.modified_external_to_seam")]
[JsonSubtypes.KnownSubType(typeof(EventAccessCodeFailedToRemoveFromDevice), "access_code.failed_to_remove_from_device")]
[JsonSubtypes.KnownSubType(typeof(EventAccessCodeDelayInRemovingFromDevice), "access_code.delay_in_removing_from_device")]
[JsonSubtypes.KnownSubType(typeof(EventAccessCodeDeleted), "access_code.deleted")]
[JsonSubtypes.KnownSubType(typeof(EventAccessCodeFailedToSetOnDevice), "access_code.failed_to_set_on_device")]
[JsonSubtypes.KnownSubType(typeof(EventAccessCodeDelayInSettingOnDevice), "access_code.delay_in_setting_on_device")]
[JsonSubtypes.KnownSubType(typeof(EventAccessCodeRemovedFromDevice), "access_code.removed_from_device")]
[JsonSubtypes.KnownSubType(typeof(EventAccessCodeSetOnDevice), "access_code.set_on_device")]
[JsonSubtypes.KnownSubType(typeof(EventAccessCodeScheduledOnDevice), "access_code.scheduled_on_device")]
[JsonSubtypes.KnownSubType(typeof(EventAccessCodeMutationsRequested), "access_code.mutations_requested")]
[JsonSubtypes.KnownSubType(typeof(EventAccessCodeTimeFrameChanged), "access_code.time_frame_changed")]
...
[DataMember(Name = "connected_account_custom_metadata", IsRequired = false, EmitDefaultValue = false)]
...
public EventAccessCodeChanged(string accessCodeId = default, string changeReason = default, List<EventAccessCodeChangedChangedProperties> changedProperties = default, object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AccessCodeId = accessCodeId;
...
public EventAccessCodeChangedChangedProperties(string? from = default, string property = default, string? to = default)
{
From = from;
Property = property;
To = to;
...
public EventAccessCodeNameChanged(string accessCodeId = default, object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, string description = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, EventAccessCodeNameChangedFrom from = default, string occurredAt = default, EventAccessCodeNameChangedTo to = default, string workspaceId = default)
{
AccessCodeId = accessCodeId;
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountId = connectedAccountId;
...
public EventAccessCodeCodeChanged(string accessCodeId = default, object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, string description = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, EventAccessCodeCodeChangedFrom from = default, string occurredAt = default, EventAccessCodeCodeChangedTo to = default, string workspaceId = default)
{
AccessCodeId = accessCodeId;
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountId = connectedAccountId;
...
public EventAccessCodeTimeFrameChangedFrom(string? endsAt = default, string? startsAt = default)
{
EndsAt = endsAt;
StartsAt = startsAt;
}
...
public EventAccessCodeTimeFrameChangedTo(string? endsAt = default, string? startsAt = default)
{
EndsAt = endsAt;
StartsAt = startsAt;
}
...
public EventAccessCodeMutationsRequested(string accessCodeId = default, object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, List<EventAccessCodeMutationsRequestedRequestedMutations> requestedMutations = default, string workspaceId = default)
{
AccessCodeId = accessCodeId;
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountId = connectedAccountId;
...
public EventAccessCodeMutationsRequestedRequestedMutations(object from = default, EventAccessCodeMutationsRequestedRequestedMutations.MutationCodeEnum mutationCode = default, object to = default)
{
From = from;
...
public EventAccessCodeScheduledOnDevice(string accessCodeId = default, string code = default, object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AccessCodeId = accessCodeId;
Code = code;
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
...
public EventAccessCodeSetOnDevice(string accessCodeId = default, string code = default, object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AccessCodeId = accessCodeId;
Code = code;
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
...
public EventAccessCodeRemovedFromDevice(string accessCodeId = default, object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AccessCodeId = accessCodeId;
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountId = connectedAccountId;
...
public EventAccessCodeDelayInSettingOnDevice(List<EventAccessCodeDelayInSettingOnDeviceAccessCodeErrors> accessCodeErrors = default, string accessCodeId = default, List<EventAccessCodeDelayInSettingOnDeviceAccessCodeWarnings> accessCodeWarnings = default, object connectedAccountCustomMetadata = default, List<EventAccessCodeDelayInSettingOnDeviceConnectedAccountErrors> connectedAccountErrors = default, string connectedAccountId = default, List<EventAccessCodeDelayInSettingOnDeviceConnectedAccountWarnings> connectedAccountWarnings = default, string createdAt = default, object deviceCustomMetadata = default, List<EventAccessCodeDelayInSettingOnDeviceDeviceErrors> deviceErrors = default, string deviceId = default, List<EventAccessCodeDelayInSettingOnDeviceDeviceWarnings> deviceWarnings = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
...
[DataMember(Name = "connected_account_warnings", IsRequired = true, EmitDefaultValue = false)]
...
public EventAccessCodeDelayInSettingOnDeviceAccessCodeErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
public EventAccessCodeDelayInSettingOnDeviceAccessCodeWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
...
[DataContract(Name = "seamModel_eventAccessCodeDelayInSettingOnDeviceConnectedAccountErrors_model")]
...
public EventAccessCodeDelayInSettingOnDeviceConnectedAccountErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
[DataContract(Name = "seamModel_eventAccessCodeDelayInSettingOnDeviceConnectedAccountWarnings_model")]
...
public EventAccessCodeDelayInSettingOnDeviceConnectedAccountWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public EventAccessCodeDelayInSettingOnDeviceDeviceErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
public EventAccessCodeDelayInSettingOnDeviceDeviceWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public EventAccessCodeFailedToSetOnDevice(List<EventAccessCodeFailedToSetOnDeviceAccessCodeErrors> accessCodeErrors = default, string accessCodeId = default, List<EventAccessCodeFailedToSetOnDeviceAccessCodeWarnings> accessCodeWarnings = default, object connectedAccountCustomMetadata = default, List<EventAccessCodeFailedToSetOnDeviceConnectedAccountErrors> connectedAccountErrors = default, string connectedAccountId = default, List<EventAccessCodeFailedToSetOnDeviceConnectedAccountWarnings> connectedAccountWarnings = default, string createdAt = default, object deviceCustomMetadata = default, List<EventAccessCodeFailedToSetOnDeviceDeviceErrors> deviceErrors = default, string deviceId = default, List<EventAccessCodeFailedToSetOnDeviceDeviceWarnings> deviceWarnings = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AccessCodeErrors = accessCodeErrors;
AccessCodeId = accessCodeId;
AccessCodeWarnings = accessCodeWarnings;
...
public EventAccessCodeFailedToSetOnDeviceAccessCodeErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
public EventAccessCodeFailedToSetOnDeviceAccessCodeWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
[DataContract(Name = "seamModel_eventAccessCodeFailedToSetOnDeviceConnectedAccountErrors_model")]
...
public EventAccessCodeFailedToSetOnDeviceConnectedAccountErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
[DataContract(Name = "seamModel_eventAccessCodeFailedToSetOnDeviceConnectedAccountWarnings_model")]
...
public EventAccessCodeFailedToSetOnDeviceConnectedAccountWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public EventAccessCodeFailedToSetOnDeviceDeviceErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
public EventAccessCodeFailedToSetOnDeviceDeviceWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public EventAccessCodeDelayInRemovingFromDevice(List<EventAccessCodeDelayInRemovingFromDeviceAccessCodeErrors> accessCodeErrors = default, string accessCodeId = default, List<EventAccessCodeDelayInRemovingFromDeviceAccessCodeWarnings> accessCodeWarnings = default, object connectedAccountCustomMetadata = default, List<EventAccessCodeDelayInRemovingFromDeviceConnectedAccountErrors> connectedAccountErrors = default, string connectedAccountId = default, List<EventAccessCodeDelayInRemovingFromDeviceConnectedAccountWarnings> connectedAccountWarnings = default, string createdAt = default, object deviceCustomMetadata = default, List<EventAccessCodeDelayInRemovingFromDeviceDeviceErrors> deviceErrors = default, string deviceId = default, List<EventAccessCodeDelayInRemovingFromDeviceDeviceWarnings> deviceWarnings = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AccessCodeErrors = accessCodeErrors;
AccessCodeId = accessCodeId;
AccessCodeWarnings = accessCodeWarnings;
...
[DataContract(Name = "seamModel_eventAccessCodeDelayInRemovingFromDeviceAccessCodeErrors_model")]
...
public EventAccessCodeDelayInRemovingFromDeviceAccessCodeErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
[DataContract(Name = "seamModel_eventAccessCodeDelayInRemovingFromDeviceAccessCodeWarnings_model")]
...
public EventAccessCodeDelayInRemovingFromDeviceAccessCodeWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
[DataContract(Name = "seamModel_eventAccessCodeDelayInRemovingFromDeviceConnectedAccountErrors_model")]
...
public EventAccessCodeDelayInRemovingFromDeviceConnectedAccountErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
[DataContract(Name = "seamModel_eventAccessCodeDelayInRemovingFromDeviceConnectedAccountWarnings_model")]
...
public EventAccessCodeDelayInRemovingFromDeviceConnectedAccountWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public EventAccessCodeDelayInRemovingFromDeviceDeviceErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
public EventAccessCodeDelayInRemovingFromDeviceDeviceWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public EventAccessCodeFailedToRemoveFromDevice(List<EventAccessCodeFailedToRemoveFromDeviceAccessCodeErrors> accessCodeErrors = default, string accessCodeId = default, List<EventAccessCodeFailedToRemoveFromDeviceAccessCodeWarnings> accessCodeWarnings = default, object connectedAccountCustomMetadata = default, List<EventAccessCodeFailedToRemoveFromDeviceConnectedAccountErrors> connectedAccountErrors = default, string connectedAccountId = default, List<EventAccessCodeFailedToRemoveFromDeviceConnectedAccountWarnings> connectedAccountWarnings = default, string createdAt = default, object deviceCustomMetadata = default, List<EventAccessCodeFailedToRemoveFromDeviceDeviceErrors> deviceErrors = default, string deviceId = default, List<EventAccessCodeFailedToRemoveFromDeviceDeviceWarnings> deviceWarnings = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AccessCodeErrors = accessCodeErrors;
AccessCodeId = accessCodeId;
AccessCodeWarnings = accessCodeWarnings;
...
public EventAccessCodeFailedToRemoveFromDeviceAccessCodeErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
[DataContract(Name = "seamModel_eventAccessCodeFailedToRemoveFromDeviceAccessCodeWarnings_model")]
...
public EventAccessCodeFailedToRemoveFromDeviceAccessCodeWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
[DataContract(Name = "seamModel_eventAccessCodeFailedToRemoveFromDeviceConnectedAccountErrors_model")]
...
public EventAccessCodeFailedToRemoveFromDeviceConnectedAccountErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
[DataContract(Name = "seamModel_eventAccessCodeFailedToRemoveFromDeviceConnectedAccountWarnings_model")]
...
public EventAccessCodeFailedToRemoveFromDeviceConnectedAccountWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public EventAccessCodeFailedToRemoveFromDeviceDeviceErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
public EventAccessCodeFailedToRemoveFromDeviceDeviceWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public EventAccessCodeModifiedExternalToSeam(string accessCodeId = default, object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AccessCodeId = accessCodeId;
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountId = connectedAccountId;
...
public EventAccessCodeUnmanagedConvertedToManaged(string accessCodeId = default, object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AccessCodeId = accessCodeId;
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountId = connectedAccountId;
...
public EventAccessCodeUnmanagedFailedToConvertToManaged(List<EventAccessCodeUnmanagedFailedToConvertToManagedAccessCodeErrors> accessCodeErrors = default, string accessCodeId = default, List<EventAccessCodeUnmanagedFailedToConvertToManagedAccessCodeWarnings> accessCodeWarnings = default, object connectedAccountCustomMetadata = default, List<EventAccessCodeUnmanagedFailedToConvertToManagedConnectedAccountErrors> connectedAccountErrors = default, string connectedAccountId = default, List<EventAccessCodeUnmanagedFailedToConvertToManagedConnectedAccountWarnings> connectedAccountWarnings = default, string createdAt = default, object deviceCustomMetadata = default, List<EventAccessCodeUnmanagedFailedToConvertToManagedDeviceErrors> deviceErrors = default, string deviceId = default, List<EventAccessCodeUnmanagedFailedToConvertToManagedDeviceWarnings> deviceWarnings = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AccessCodeErrors = accessCodeErrors;
AccessCodeId = accessCodeId;
AccessCodeWarnings = accessCodeWarnings;
...
[DataMember(Name = "event_type", IsRequired = true, EmitDefaultValue = false)]
public override string EventType { get; } = "access_code.unmanaged.failed_to_convert_to_managed";
...
[DataContract(Name = "seamModel_eventAccessCodeUnmanagedFailedToConvertToManagedAccessCodeErrors_model")]
...
public EventAccessCodeUnmanagedFailedToConvertToManagedAccessCodeErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
[DataContract(Name = "seamModel_eventAccessCodeUnmanagedFailedToConvertToManagedAccessCodeWarnings_model")]
...
public EventAccessCodeUnmanagedFailedToConvertToManagedAccessCodeWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
[DataContract(Name = "seamModel_eventAccessCodeUnmanagedFailedToConvertToManagedConnectedAccountErrors_model")]
...
public EventAccessCodeUnmanagedFailedToConvertToManagedConnectedAccountErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
[DataContract(Name = "seamModel_eventAccessCodeUnmanagedFailedToConvertToManagedConnectedAccountWarnings_model")]
...
public EventAccessCodeUnmanagedFailedToConvertToManagedConnectedAccountWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
[DataContract(Name = "seamModel_eventAccessCodeUnmanagedFailedToConvertToManagedDeviceErrors_model")]
...
public EventAccessCodeUnmanagedFailedToConvertToManagedDeviceErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
[DataContract(Name = "seamModel_eventAccessCodeUnmanagedFailedToConvertToManagedDeviceWarnings_model")]
...
public EventAccessCodeUnmanagedFailedToConvertToManagedDeviceWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public EventAccessCodeUnmanagedRemoved(string accessCodeId = default, object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AccessCodeId = accessCodeId;
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountId = connectedAccountId;
...
public EventAccessGrantCreated(string accessGrantId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
...
public EventAccessGrantDeleted(string accessGrantId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AccessGrantId = accessGrantId;
CreatedAt = createdAt;
EventDescription = eventDescription;
...
public EventAccessGrantAccessGrantedToAllDoors(string accessGrantId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AccessGrantId = accessGrantId;
CreatedAt = createdAt;
EventDescription = eventDescription;
...
public EventAccessGrantAccessGrantedToDoor(string accessGrantId = default, string acsEntranceId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AccessGrantId = accessGrantId;
...
public EventAccessGrantAccessToDoorLost(string accessGrantId = default, string acsEntranceId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AccessGrantId = accessGrantId;
AcsEntranceId = acsEntranceId;
CreatedAt = createdAt;
...
[DataMember(Name = "event_type", IsRequired = true, EmitDefaultValue = false)]
public override string EventType { get; } = "access_grant.could_not_create_requested_access_methods";
...
public EventAccessMethodIssued(List<string> accessGrantIds = default, List<string> accessGrantKeys = default, string accessMethodId = default, string code = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, bool isBackupCode = default, string occurredAt = default, string workspaceId = default)
{
...
public EventAccessMethodRevoked(List<string> accessGrantIds = default, List<string> accessGrantKeys = default, string accessMethodId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AccessGrantIds = accessGrantIds;
AccessGrantKeys = accessGrantKeys;
AccessMethodId = accessMethodId;
...
public EventAccessMethodCardEncodingRequired(List<string> accessGrantIds = default, List<string> accessGrantKeys = default, string accessMethodId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AccessGrantIds = accessGrantIds;
AccessGrantKeys = accessGrantKeys;
AccessMethodId = accessMethodId;
...
public EventAccessMethodDeleted(List<string> accessGrantIds = default, List<string> accessGrantKeys = default, string accessMethodId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AccessGrantIds = accessGrantIds;
AccessGrantKeys = accessGrantKeys;
AccessMethodId = accessMethodId;
...
public EventAccessMethodReissued(List<string> accessGrantIds = default, List<string> accessGrantKeys = default, string accessMethodId = default, string code = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, bool isBackupCode = default, string occurredAt = default, string workspaceId = default)
{
AccessGrantIds = accessGrantIds;
AccessGrantKeys = accessGrantKeys;
AccessMethodId = accessMethodId;
...
public EventAccessMethodCreated(List<string> accessGrantIds = default, List<string> accessGrantKeys = default, string accessMethodId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AccessGrantIds = accessGrantIds;
AccessGrantKeys = accessGrantKeys;
AccessMethodId = accessMethodId;
...
public EventAccessMethodDelayInIssuing(List<string> accessGrantIds = default, List<string> accessGrantKeys = default, string accessMethodId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AccessGrantIds = accessGrantIds;
AccessGrantKeys = accessGrantKeys;
AccessMethodId = accessMethodId;
...
public EventAccessMethodFailedToIssue(List<string> accessGrantIds = default, List<string> accessGrantKeys = default, string accessMethodId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AccessGrantIds = accessGrantIds;
AccessGrantKeys = accessGrantKeys;
AccessMethodId = accessMethodId;
...
public EventAcsSystemConnected(string acsSystemId = default, string connectedAccountId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
...
public EventAcsSystemAdded(string acsSystemId = default, string connectedAccountId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AcsSystemId = acsSystemId;
ConnectedAccountId = connectedAccountId;
CreatedAt = createdAt;
...
public EventAcsSystemDisconnected(List<EventAcsSystemDisconnectedAcsSystemErrors> acsSystemErrors = default, string acsSystemId = default, List<EventAcsSystemDisconnectedAcsSystemWarnings> acsSystemWarnings = default, List<EventAcsSystemDisconnectedConnectedAccountErrors> connectedAccountErrors = default, string connectedAccountId = default, List<EventAcsSystemDisconnectedConnectedAccountWarnings> connectedAccountWarnings = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
...
public EventAcsSystemDisconnectedAcsSystemErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
public EventAcsSystemDisconnectedAcsSystemWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public EventAcsSystemDisconnectedConnectedAccountErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
public EventAcsSystemDisconnectedConnectedAccountWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public EventAcsCredentialDeleted(string acsCredentialId = default, string acsSystemId = default, string connectedAccountId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
...
public EventAcsCredentialIssued(string acsCredentialId = default, string acsSystemId = default, string connectedAccountId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AcsCredentialId = acsCredentialId;
AcsSystemId = acsSystemId;
ConnectedAccountId = connectedAccountId;
...
public EventAcsCredentialReissued(string acsCredentialId = default, string acsSystemId = default, string connectedAccountId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AcsCredentialId = acsCredentialId;
AcsSystemId = acsSystemId;
ConnectedAccountId = connectedAccountId;
...
public EventAcsCredentialInvalidated(string acsCredentialId = default, string acsSystemId = default, string connectedAccountId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AcsCredentialId = acsCredentialId;
AcsSystemId = acsSystemId;
ConnectedAccountId = connectedAccountId;
...
public EventAcsUserCreated(string acsSystemId = default, string acsUserId = default, string connectedAccountId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AcsSystemId = acsSystemId;
AcsUserId = acsUserId;
ConnectedAccountId = connectedAccountId;
...
public EventAcsUserDeleted(string acsSystemId = default, string acsUserId = default, string connectedAccountId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AcsSystemId = acsSystemId;
AcsUserId = acsUserId;
ConnectedAccountId = connectedAccountId;
...
public EventAcsEncoderAdded(string acsEncoderId = default, string acsSystemId = default, string connectedAccountId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
...
public EventAcsEncoderRemoved(string acsEncoderId = default, string acsSystemId = default, string connectedAccountId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AcsEncoderId = acsEncoderId;
AcsSystemId = acsSystemId;
ConnectedAccountId = connectedAccountId;
...
public EventAcsAccessGroupDeleted(string acsAccessGroupId = default, string acsSystemId = default, string connectedAccountId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
...
public EventAcsEntranceAdded(string acsEntranceId = default, string acsSystemId = default, string connectedAccountId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AcsEntranceId = acsEntranceId;
AcsSystemId = acsSystemId;
ConnectedAccountId = connectedAccountId;
...
public EventAcsEntranceRemoved(string acsEntranceId = default, string acsSystemId = default, string connectedAccountId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
AcsEntranceId = acsEntranceId;
AcsSystemId = acsSystemId;
ConnectedAccountId = connectedAccountId;
...
public EventClientSessionDeleted(string clientSessionId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
...
public EventConnectedAccountConnected(string connectWebviewId = default, object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, string customerKey = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
...
public EventConnectedAccountDisconnected(object connectedAccountCustomMetadata = default, List<EventConnectedAccountDisconnectedConnectedAccountErrors> connectedAccountErrors = default, string connectedAccountId = default, List<EventConnectedAccountDisconnectedConnectedAccountWarnings> connectedAccountWarnings = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountErrors = connectedAccountErrors;
ConnectedAccountId = connectedAccountId;
...
public EventConnectedAccountDisconnectedConnectedAccountErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
[DataContract(Name = "seamModel_eventConnectedAccountDisconnectedConnectedAccountWarnings_model")]
...
public EventConnectedAccountDisconnectedConnectedAccountWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public EventConnectedAccountCompletedFirstSync(object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountId = connectedAccountId;
CreatedAt = createdAt;
...
[DataContract(Name = "seamModel_eventConnectedAccountCompletedFirstSyncAfterReconnection_model")]
...
[DataMember(Name = "event_type", IsRequired = true, EmitDefaultValue = false)]
public override string EventType { get; } = "connected_account.completed_first_sync_after_reconnection";
...
public EventConnectedAccountReauthorizationRequested(object connectedAccountCustomMetadata = default, List<EventConnectedAccountReauthorizationRequestedConnectedAccountErrors> connectedAccountErrors = default, string connectedAccountId = default, List<EventConnectedAccountReauthorizationRequestedConnectedAccountWarnings> connectedAccountWarnings = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountErrors = connectedAccountErrors;
ConnectedAccountId = connectedAccountId;
...
[DataContract(Name = "seamModel_eventConnectedAccountReauthorizationRequestedConnectedAccountErrors_model")]
...
public EventConnectedAccountReauthorizationRequestedConnectedAccountErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
[DataContract(Name = "seamModel_eventConnectedAccountReauthorizationRequestedConnectedAccountWarnings_model")]
...
public EventConnectedAccountReauthorizationRequestedConnectedAccountWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public EventActionAttemptLockDoorSucceeded(string actionAttemptId = default, string actionType = default, string connectedAccountId = default, string createdAt = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string status = default, string workspaceId = default)
{
...
public EventActionAttemptLockDoorFailed(string actionAttemptId = default, string actionType = default, string connectedAccountId = default, string createdAt = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string status = default, string workspaceId = default)
{
ActionAttemptId = actionAttemptId;
ActionType = actionType;
ConnectedAccountId = connectedAccountId;
...
public EventActionAttemptUnlockDoorFailed(string actionAttemptId = default, string actionType = default, string connectedAccountId = default, string createdAt = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string status = default, string workspaceId = default)
{
ActionAttemptId = actionAttemptId;
ActionType = actionType;
ConnectedAccountId = connectedAccountId;
...
public EventActionAttemptSimulateKeypadCodeEntrySucceeded(string actionAttemptId = default, string actionType = default, string connectedAccountId = default, string createdAt = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string status = default, string workspaceId = default)
{
ActionAttemptId = actionAttemptId;
ActionType = actionType;
ConnectedAccountId = connectedAccountId;
...
[DataMember(Name = "event_type", IsRequired = true, EmitDefaultValue = false)]
public override string EventType { get; } = "action_attempt.simulate_keypad_code_entry.succeeded";
...
[DataMember(Name = "event_type", IsRequired = true, EmitDefaultValue = false)]
public override string EventType { get; } = "action_attempt.simulate_keypad_code_entry.failed";
...
[DataMember(Name = "event_type", IsRequired = true, EmitDefaultValue = false)]
public override string EventType { get; } = "action_attempt.simulate_manual_lock_via_keypad.succeeded";
...
public EventActionAttemptSimulateManualLockViaKeypadFailed(string actionAttemptId = default, string actionType = default, string connectedAccountId = default, string createdAt = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string status = default, string workspaceId = default)
{
ActionAttemptId = actionAttemptId;
ActionType = actionType;
ConnectedAccountId = connectedAccountId;
...
[DataMember(Name = "event_type", IsRequired = true, EmitDefaultValue = false)]
public override string EventType { get; } = "action_attempt.simulate_manual_lock_via_keypad.failed";
...
public EventConnectWebviewLoginFailed(string connectWebviewId = default, string createdAt = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
ConnectWebviewId = connectWebviewId;
CreatedAt = createdAt;
EventDescription = eventDescription;
...
public EventDeviceAdded(object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, string customerKey = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountId = connectedAccountId;
CreatedAt = createdAt;
...
public EventDeviceConvertedToUnmanaged(object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, string customerKey = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountId = connectedAccountId;
CreatedAt = createdAt;
...
public EventDeviceUnmanagedConnected(object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, string customerKey = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountId = connectedAccountId;
CreatedAt = createdAt;
...
public EventDeviceDisconnected(object connectedAccountCustomMetadata = default, List<EventDeviceDisconnectedConnectedAccountErrors> connectedAccountErrors = default, string connectedAccountId = default, List<EventDeviceDisconnectedConnectedAccountWarnings> connectedAccountWarnings = default, string createdAt = default, string customerKey = default, object deviceCustomMetadata = default, List<EventDeviceDisconnectedDeviceErrors> deviceErrors = default, string deviceId = default, List<EventDeviceDisconnectedDeviceWarnings> deviceWarnings = default, EventDeviceDisconnected.ErrorCodeEnum errorCode = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountErrors = connectedAccountErrors;
ConnectedAccountId = connectedAccountId;
...
public EventDeviceDisconnectedConnectedAccountErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
public EventDeviceDisconnectedConnectedAccountWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public EventDeviceDisconnectedDeviceErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
public EventDeviceDisconnectedDeviceWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public EventDeviceUnmanagedDisconnected(object connectedAccountCustomMetadata = default, List<EventDeviceUnmanagedDisconnectedConnectedAccountErrors> connectedAccountErrors = default, string connectedAccountId = default, List<EventDeviceUnmanagedDisconnectedConnectedAccountWarnings> connectedAccountWarnings = default, string createdAt = default, string customerKey = default, object deviceCustomMetadata = default, List<EventDeviceUnmanagedDisconnectedDeviceErrors> deviceErrors = default, string deviceId = default, List<EventDeviceUnmanagedDisconnectedDeviceWarnings> deviceWarnings = default, EventDeviceUnmanagedDisconnected.ErrorCodeEnum errorCode = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountErrors = connectedAccountErrors;
ConnectedAccountId = connectedAccountId;
...
public EventDeviceUnmanagedDisconnectedConnectedAccountErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
[DataContract(Name = "seamModel_eventDeviceUnmanagedDisconnectedConnectedAccountWarnings_model")]
...
public EventDeviceUnmanagedDisconnectedConnectedAccountWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public EventDeviceUnmanagedDisconnectedDeviceErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
public EventDeviceUnmanagedDisconnectedDeviceWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public EventDeviceLowBattery(float batteryLevel = default, object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, string customerKey = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
...
public EventDeviceRemoved(object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, string customerKey = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountId = connectedAccountId;
CreatedAt = createdAt;
...
public EventDeviceDeleted(object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, string customerKey = default, object deviceCustomMetadata = default, string deviceId = default, string? deviceName = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountId = connectedAccountId;
CreatedAt = createdAt;
...
public EventDeviceThirdPartyIntegrationDetected(object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, string customerKey = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountId = connectedAccountId;
CreatedAt = createdAt;
...
public EventDeviceThirdPartyIntegrationNoLongerDetected(object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, string customerKey = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountId = connectedAccountId;
CreatedAt = createdAt;
...
[DataMember(Name = "event_type", IsRequired = true, EmitDefaultValue = false)]
public override string EventType { get; } = "device.third_party_integration_no_longer_detected";
...
public EventDeviceSaltoPrivacyModeDeactivated(object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, string customerKey = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountId = connectedAccountId;
CreatedAt = createdAt;
...
public EventDeviceConnectionBecameFlaky(object connectedAccountCustomMetadata = default, List<EventDeviceConnectionBecameFlakyConnectedAccountErrors> connectedAccountErrors = default, string connectedAccountId = default, List<EventDeviceConnectionBecameFlakyConnectedAccountWarnings> connectedAccountWarnings = default, string createdAt = default, string customerKey = default, object deviceCustomMetadata = default, List<EventDeviceConnectionBecameFlakyDeviceErrors> deviceErrors = default, string deviceId = default, List<EventDeviceConnectionBecameFlakyDeviceWarnings> deviceWarnings = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountErrors = connectedAccountErrors;
ConnectedAccountId = connectedAccountId;
...
public EventDeviceConnectionBecameFlakyConnectedAccountErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
[DataContract(Name = "seamModel_eventDeviceConnectionBecameFlakyConnectedAccountWarnings_model")]
...
public EventDeviceConnectionBecameFlakyConnectedAccountWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public EventDeviceConnectionBecameFlakyDeviceErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
public EventDeviceConnectionBecameFlakyDeviceWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public EventDeviceConnectionStabilized(object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, string customerKey = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountId = connectedAccountId;
CreatedAt = createdAt;
...
public EventDeviceErrorSubscriptionRequired(object connectedAccountCustomMetadata = default, List<EventDeviceErrorSubscriptionRequiredConnectedAccountErrors> connectedAccountErrors = default, string connectedAccountId = default, List<EventDeviceErrorSubscriptionRequiredConnectedAccountWarnings> connectedAccountWarnings = default, string createdAt = default, string customerKey = default, object deviceCustomMetadata = default, List<EventDeviceErrorSubscriptionRequiredDeviceErrors> deviceErrors = default, string deviceId = default, List<EventDeviceErrorSubscriptionRequiredDeviceWarnings> deviceWarnings = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountErrors = connectedAccountErrors;
ConnectedAccountId = connectedAccountId;
...
[DataContract(Name = "seamModel_eventDeviceErrorSubscriptionRequiredConnectedAccountErrors_model")]
...
public EventDeviceErrorSubscriptionRequiredConnectedAccountErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
[DataContract(Name = "seamModel_eventDeviceErrorSubscriptionRequiredConnectedAccountWarnings_model")]
...
public EventDeviceErrorSubscriptionRequiredConnectedAccountWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public EventDeviceErrorSubscriptionRequiredDeviceErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
public EventDeviceErrorSubscriptionRequiredDeviceWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public EventDeviceAccessoryKeypadDisconnected(object connectedAccountCustomMetadata = default, List<EventDeviceAccessoryKeypadDisconnectedConnectedAccountErrors> connectedAccountErrors = default, string connectedAccountId = default, List<EventDeviceAccessoryKeypadDisconnectedConnectedAccountWarnings> connectedAccountWarnings = default, string createdAt = default, string customerKey = default, object deviceCustomMetadata = default, List<EventDeviceAccessoryKeypadDisconnectedDeviceErrors> deviceErrors = default, string deviceId = default, List<EventDeviceAccessoryKeypadDisconnectedDeviceWarnings> deviceWarnings = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountErrors = connectedAccountErrors;
ConnectedAccountId = connectedAccountId;
...
[DataContract(Name = "seamModel_eventDeviceAccessoryKeypadDisconnectedConnectedAccountErrors_model")]
...
public EventDeviceAccessoryKeypadDisconnectedConnectedAccountErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
[DataContract(Name = "seamModel_eventDeviceAccessoryKeypadDisconnectedConnectedAccountWarnings_model")]
...
public EventDeviceAccessoryKeypadDisconnectedConnectedAccountWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public EventDeviceAccessoryKeypadDisconnectedDeviceErrors(string createdAt = default, string errorCode = default, string message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
public EventDeviceAccessoryKeypadDisconnectedDeviceWarnings(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public EventNoiseSensorNoiseThresholdTriggered(object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, string customerKey = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, object minutMetadata = default, float noiseLevelDecibels = default, float noiseLevelNrs = default, string noiseThresholdId = default, string noiseThresholdName = default, object noiseawareMetadata = default, string occurredAt = default, string workspaceId = default)
{
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountId = connectedAccountId;
CreatedAt = createdAt;
...
public EventLockLocked(string accessCodeId = default, bool accessCodeIsManaged = default, string acsEntranceId = default, string acsSystemId = default, string acsUserId = default, string actionAttemptId = default, string code = default, object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, string customerKey = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, bool isViaBluetooth = default, bool isViaNfc = default, EventLockLocked.MethodEnum method = default, string occurredAt = default, string userIdentityId = default, string workspaceId = default)
{
AccessCodeId = accessCodeId;
...
public EventLockUnlocked(string accessCodeId = default, bool accessCodeIsManaged = default, string acsEntranceId = default, string acsSystemId = default, string acsUserId = default, string actionAttemptId = default, string code = default, object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, string customerKey = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, bool isViaBluetooth = default, bool isViaNfc = default, EventLockUnlocked.MethodEnum method = default, string occurredAt = default, string userIdentityId = default, string workspaceId = default)
{
AccessCodeId = accessCodeId;
AccessCodeIsManaged = accessCodeIsManaged;
AcsEntranceId = acsEntranceId;
...
public EventLockAccessDenied(string accessCodeId = default, string acsEntranceId = default, string acsSystemId = default, string acsUserId = default, object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, string customerKey = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, EventLockAccessDeniedReason reason = default, string userIdentityId = default, string workspaceId = default)
{
AccessCodeId = accessCodeId;
AcsEntranceId = acsEntranceId;
AcsSystemId = acsSystemId;
...
public EventLockAccessDeniedReason(string message = default, EventLockAccessDeniedReason.ReasonCodeEnum reasonCode = default)
{
Message = message;
...
[DataMember(Name = "is_fallback_climate_preset", IsRequired = true, EmitDefaultValue = false)]
...
[DataMember(Name = "cooling_set_point_celsius", IsRequired = false, EmitDefaultValue = false)]
public float CoolingSetPointCelsius { get; set; }

[DataMember(Name = "cooling_set_point_fahrenheit", IsRequired = false, EmitDefaultValue = false)]
...
[DataMember(Name = "heating_set_point_celsius", IsRequired = false, EmitDefaultValue = false)]
public float HeatingSetPointCelsius { get; set; }

[DataMember(Name = "heating_set_point_fahrenheit", IsRequired = false, EmitDefaultValue = false)]
...
[DataMember(Name = "lower_limit_celsius", IsRequired = true, EmitDefaultValue = false)]
public float? LowerLimitCelsius { get; set; }

[DataMember(Name = "lower_limit_fahrenheit", IsRequired = true, EmitDefaultValue = false)]
...
[DataMember(Name = "upper_limit_celsius", IsRequired = true, EmitDefaultValue = false)]
public float? UpperLimitCelsius { get; set; }

[DataMember(Name = "upper_limit_fahrenheit", IsRequired = true, EmitDefaultValue = false)]
...
[DataMember(Name = "event_type", IsRequired = true, EmitDefaultValue = false)]
public override string EventType { get; } = "thermostat.temperature_threshold_no_longer_exceeded";
...
public EventThermostatTemperatureReachedSetPoint(object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, string customerKey = default, float desiredTemperatureCelsius = default, float desiredTemperatureFahrenheit = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, float temperatureCelsius = default, float temperatureFahrenheit = default, string workspaceId = default)
{
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountId = connectedAccountId;
CreatedAt = createdAt;
...
[DataMember(Name = "desired_temperature_celsius", IsRequired = false, EmitDefaultValue = false)]
public float DesiredTemperatureCelsius { get; set; }

[DataMember(Name = "desired_temperature_fahrenheit", IsRequired = false, EmitDefaultValue = false)]
...
public EventDeviceNameChanged(object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, string customerKey = default, object deviceCustomMetadata = default, string deviceId = default, string deviceName = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountId = connectedAccountId;
CreatedAt = createdAt;
...
public EventDeviceDoorbellRang(object connectedAccountCustomMetadata = default, string connectedAccountId = default, string createdAt = default, string customerKey = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string imageUrl = default, string occurredAt = default, string videoUrl = default, string workspaceId = default)
{
ConnectedAccountCustomMetadata = connectedAccountCustomMetadata;
ConnectedAccountId = connectedAccountId;
CreatedAt = createdAt;
...
public EventPhoneDeactivated(string createdAt = default, object deviceCustomMetadata = default, string deviceId = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string workspaceId = default)
{
CreatedAt = createdAt;
DeviceCustomMetadata = deviceCustomMetadata;
DeviceId = deviceId;
...
public EventSpaceDeviceMembershipChanged(List<string> acsEntranceIds = default, string createdAt = default, List<string> deviceIds = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string spaceId = default, string spaceKey = default, string workspaceId = default)
{
...
public EventSpaceCreated(List<string> acsEntranceIds = default, string createdAt = default, List<string> deviceIds = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string spaceId = default, string spaceKey = default, string workspaceId = default)
{
AcsEntranceIds = acsEntranceIds;
CreatedAt = createdAt;
DeviceIds = deviceIds;
...
public EventSpaceDeleted(List<string> acsEntranceIds = default, string createdAt = default, List<string> deviceIds = default, string eventDescription = default, string eventId = default, string eventType = default, string occurredAt = default, string spaceId = default, string spaceKey = default, string workspaceId = default)
{
AcsEntranceIds = acsEntranceIds;
CreatedAt = createdAt;
DeviceIds = deviceIds;
