...
[JsonSubtypes.KnownSubType(typeof(EventEnrollmentAutomationDeleted), "enrollment_automation.deleted")]
...
[DataMember(Name = "connected_account_errors", IsRequired = false, EmitDefaultValue = false)]
public List<EventAccessCodeDelayInSettingOnDeviceConnectedAccountErrors>? ConnectedAccountErrors { get; set; }

[DataMember(Name = "connected_account_id", IsRequired = false, EmitDefaultValue = false)]
public string? ConnectedAccountId { get; set; }

[DataMember(Name = "connected_account_warnings", IsRequired = false, EmitDefaultValue = false)]
...
[DataMember(Name = "is_fallback_climate_preset", IsRequired = false, EmitDefaultValue = false)]
...
public EventEnrollmentAutomationDeleted(string? createdAt = default, string? enrollmentAutomationId = default, string? eventDescription = default, string? eventId = default, string eventType = default, string? occurredAt = default, string? workspaceId = default)
{
CreatedAt = createdAt;
...
[DataMember(Name = "enrollment_automation_id", IsRequired = false, EmitDefaultValue = false)]
