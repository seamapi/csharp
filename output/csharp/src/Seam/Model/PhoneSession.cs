...
public PhoneSession(bool? isSandboxWorkspace = default, List<PhoneSessionProviderSessions>? providerSessions = default, PhoneSessionUserIdentity? userIdentity = default, string? workspaceId = default)
{
...
public PhoneSessionProviderSessions(List<PhoneSessionProviderSessionsAcsCredentials>? acsCredentials = default, PhoneSessionProviderSessionsPhoneRegistration? phoneRegistration = default)
{
...
public PhoneSessionProviderSessionsAcsCredentials(PhoneSessionProviderSessionsAcsCredentials.AccessMethodEnum? accessMethod = default, string? acsCredentialId = default, string? acsCredentialPoolId = default, List<PhoneSessionProviderSessionsAcsCredentialsAcsEntrances>? acsEntrances = default, string? acsSystemId = default, string? acsUserId = default, PhoneSessionProviderSessionsAcsCredentialsAssaAbloyVostioMetadata? assaAbloyVostioMetadata = default, string? cardNumber = default, string? code = default, string? connectedAccountId = default, string? createdAt = default, string? displayName = default, string? endsAt = default, List<PhoneSessionProviderSessionsAcsCredentialsErrors>? errors = default, PhoneSessionProviderSessionsAcsCredentials.ExternalTypeEnum? externalType = default, string? externalTypeDisplayName = default, bool? isIssued = default, bool? isLatestDesiredStateSyncedWithProvider = default, bool? isManaged = default, bool? isMultiPhoneSyncCredential = default, bool? isOneTimeUse = default, string? issuedAt = default, string? latestDesiredStateSyncedWithProviderAt = default, string? parentAcsCredentialId = default, string? startsAt = default, string? userIdentityId = default, PhoneSessionProviderSessionsAcsCredentialsVisionlineMetadata? visionlineMetadata = default, List<PhoneSessionProviderSessionsAcsCredentialsWarnings>? warnings = default, string? workspaceId = default)
{
...
public PhoneSessionProviderSessionsAcsCredentialsAcsEntrances(string? acsEntranceId = default, string? acsSystemId = default, PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesAssaAbloyVostioMetadata? assaAbloyVostioMetadata = default, PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesAvigilonAltaMetadata? avigilonAltaMetadata = default, PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesBrivoMetadata? brivoMetadata = default, bool? canBelongToReservation = default, bool? canUnlockWithCard = default, bool? canUnlockWithCloudKey = default, bool? canUnlockWithCode = default, bool? canUnlockWithMobileKey = default, string? connectedAccountId = default, string? createdAt = default, string? displayName = default, PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesDormakabaAmbianceMetadata? dormakabaAmbianceMetadata = default, PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesDormakabaCommunityMetadata? dormakabaCommunityMetadata = default, List<PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesErrors>? errors = default, PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesHotekMetadata? hotekMetadata = default, bool? isLocked = default, PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesLatchMetadata? latchMetadata = default, PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesSaltoKsMetadata? saltoKsMetadata = default, PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesSaltoSpaceMetadata? saltoSpaceMetadata = default, List<string>? spaceIds = default, PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesVisionlineMetadata? visionlineMetadata = default, List<PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesWarnings>? warnings = default)
{
...
[DataMember(Name = "can_belong_to_reservation", IsRequired = false, EmitDefaultValue = false)]
...
[DataMember(Name = "can_unlock_with_cloud_key", IsRequired = false, EmitDefaultValue = false)]
...
[DataMember(Name = "can_unlock_with_mobile_key", IsRequired = false, EmitDefaultValue = false)]
...
[DataMember(Name = "dormakaba_ambiance_metadata", IsRequired = false, EmitDefaultValue = false)]
public PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesDormakabaAmbianceMetadata? DormakabaAmbianceMetadata { get; set; }

[DataMember(Name = "dormakaba_community_metadata", IsRequired = false, EmitDefaultValue = false)]
...
[DataContract(Name = "seamModel_phoneSessionProviderSessionsAcsCredentialsAcsEntrancesAssaAbloyVostioMetadata_model")]
...
public PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesAssaAbloyVostioMetadata(string? doorName = default, float? doorNumber = default, PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesAssaAbloyVostioMetadata.DoorTypeEnum? doorType = default, string? pmsId = default, bool? standOpen = default)
{
DoorName = doorName;
...
[DataContract(Name = "seamModel_phoneSessionProviderSessionsAcsCredentialsAcsEntrancesAvigilonAltaMetadata_model")]
...
public PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesAvigilonAltaMetadata(string? entryName = default, float? entryRelaysTotalCount = default, string? orgName = default, float? siteId = default, string? siteName = default, float? zoneId = default, string? zoneName = default)
{
EntryName = entryName;
...
[DataContract(Name = "seamModel_phoneSessionProviderSessionsAcsCredentialsAcsEntrancesBrivoMetadata_model")]
...
public PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesBrivoMetadata(string? accessPointId = default, float? siteId = default, string? siteName = default)
{
...
[DataContract(Name = "seamModel_phoneSessionProviderSessionsAcsCredentialsAcsEntrancesDormakabaAmbianceMetadata_model")]
...
public PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesDormakabaAmbianceMetadata(string? accessPointName = default)
{
...
[DataContract(Name = "seamModel_phoneSessionProviderSessionsAcsCredentialsAcsEntrancesDormakabaCommunityMetadata_model")]
...
public PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesDormakabaCommunityMetadata(string? accessPointProfile = default)
{
...
[DataContract(Name = "seamModel_phoneSessionProviderSessionsAcsCredentialsAcsEntrancesErrors_model")]
...
public PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesErrors(string? createdAt = default, string? errorCode = default, string? message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
[DataContract(Name = "seamModel_phoneSessionProviderSessionsAcsCredentialsAcsEntrancesHotekMetadata_model")]
...
public PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesHotekMetadata(string? commonAreaName = default, string? commonAreaNumber = default, string? roomNumber = default)
{
...
[DataContract(Name = "seamModel_phoneSessionProviderSessionsAcsCredentialsAcsEntrancesLatchMetadata_model")]
...
public PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesLatchMetadata(string? accessibilityType = default, string? doorName = default, string? doorType = default, bool? isConnected = default)
{
...
[DataContract(Name = "seamModel_phoneSessionProviderSessionsAcsCredentialsAcsEntrancesSaltoKsMetadata_model")]
...
public PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesSaltoKsMetadata(string? batteryLevel = default, string? doorName = default, bool? intrusionAlarm = default, bool? leftOpenAlarm = default, string? lockType = default, string? lockedState = default, bool? online = default, bool? privacyMode = default)
{
...
[DataContract(Name = "seamModel_phoneSessionProviderSessionsAcsCredentialsAcsEntrancesSaltoSpaceMetadata_model")]
...
public PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesSaltoSpaceMetadata(bool? auditOnKeys = default, string? doorDescription = default, string? doorId = default, string? doorName = default, string? roomDescription = default, string? roomName = default)
{
...
[DataContract(Name = "seamModel_phoneSessionProviderSessionsAcsCredentialsAcsEntrancesVisionlineMetadata_model")]
...
public PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesVisionlineMetadata(PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesVisionlineMetadata.DoorCategoryEnum? doorCategory = default, string? doorName = default, List<PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesVisionlineMetadataProfiles>? profiles = default)
{
...
[DataContract(Name = "seamModel_phoneSessionProviderSessionsAcsCredentialsAcsEntrancesVisionlineMetadataProfiles_model")]
...
public PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesVisionlineMetadataProfiles(string? visionlineDoorProfileId = default, PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesVisionlineMetadataProfiles.VisionlineDoorProfileTypeEnum? visionlineDoorProfileType = default)
{
...
[DataMember(Name = "visionline_door_profile_id", IsRequired = false, EmitDefaultValue = false)]
public string? VisionlineDoorProfileId { get; set; }

[DataMember(Name = "visionline_door_profile_type", IsRequired = false, EmitDefaultValue = false)]
...
[DataContract(Name = "seamModel_phoneSessionProviderSessionsAcsCredentialsAcsEntrancesWarnings_model")]
...
public PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesWarnings(string? createdAt = default, string? message = default, PhoneSessionProviderSessionsAcsCredentialsAcsEntrancesWarnings.WarningCodeEnum? warningCode = default)
{
CreatedAt = createdAt;
Message = message;
...
[DataContract(Name = "seamModel_phoneSessionProviderSessionsAcsCredentialsAssaAbloyVostioMetadata_model")]
...
public PhoneSessionProviderSessionsAcsCredentialsAssaAbloyVostioMetadata(bool? autoJoin = default, List<string>? doorNames = default, string? endpointId = default, string? keyId = default, string? keyIssuingRequestId = default, List<string>? overrideGuestAcsEntranceIds = default)
{
AutoJoin = autoJoin;
DoorNames = doorNames;
...
public PhoneSessionProviderSessionsAcsCredentialsErrors(string? createdAt = default, string? errorCode = default, string? message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
[DataContract(Name = "seamModel_phoneSessionProviderSessionsAcsCredentialsVisionlineMetadata_model")]
...
public PhoneSessionProviderSessionsAcsCredentialsWarnings(string? createdAt = default, string? message = default, PhoneSessionProviderSessionsAcsCredentialsWarnings.WarningCodeEnum? warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public PhoneSessionProviderSessionsPhoneRegistration(bool? isBeingActivated = default, string? phoneRegistrationId = default, string? providerName = default)
{
...
public PhoneSessionUserIdentity(List<string>? acsUserIds = default, string? createdAt = default, string? displayName = default, string? emailAddress = default, List<PhoneSessionUserIdentityErrors>? errors = default, string? fullName = default, string? phoneNumber = default, string? userIdentityId = default, string? userIdentityKey = default, List<PhoneSessionUserIdentityWarnings>? warnings = default, string? workspaceId = default)
{
...
public PhoneSessionUserIdentityErrors(string? acsSystemId = default, string? acsUserId = default, string? createdAt = default, PhoneSessionUserIdentityErrors.ErrorCodeEnum? errorCode = default, string? message = default)
{
AcsSystemId = acsSystemId;
AcsUserId = acsUserId;
CreatedAt = createdAt;
...
public PhoneSessionUserIdentityWarnings(string? createdAt = default, string? message = default, PhoneSessionUserIdentityWarnings.WarningCodeEnum? warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
