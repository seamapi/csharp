...
public UnmanagedAcsCredential(UnmanagedAcsCredential.AccessMethodEnum? accessMethod = default, string? acsCredentialId = default, string? acsCredentialPoolId = default, string? acsSystemId = default, string? acsUserId = default, UnmanagedAcsCredentialAssaAbloyVostioMetadata? assaAbloyVostioMetadata = default, string? cardNumber = default, string? code = default, string? connectedAccountId = default, string? createdAt = default, string? displayName = default, string? endsAt = default, List<UnmanagedAcsCredentialErrors>? errors = default, UnmanagedAcsCredential.ExternalTypeEnum? externalType = default, string? externalTypeDisplayName = default, bool? isIssued = default, bool? isLatestDesiredStateSyncedWithProvider = default, bool? isManaged = default, bool? isMultiPhoneSyncCredential = default, bool? isOneTimeUse = default, string? issuedAt = default, string? latestDesiredStateSyncedWithProviderAt = default, string? parentAcsCredentialId = default, string? startsAt = default, string? userIdentityId = default, UnmanagedAcsCredentialVisionlineMetadata? visionlineMetadata = default, List<UnmanagedAcsCredentialWarnings>? warnings = default, string? workspaceId = default)
{
...
[JsonSubtypes.FallBackSubType(typeof(UnmanagedAcsCredentialWarningsUnrecognized))]
[JsonSubtypes.KnownSubType(typeof(UnmanagedAcsCredentialWarningsNeedsToBeReissued), "needs_to_be_reissued")]
[JsonSubtypes.KnownSubType(typeof(UnmanagedAcsCredentialWarningsUnknownIssueWithAcsCredential), "unknown_issue_with_acs_credential")]
[JsonSubtypes.KnownSubType(typeof(UnmanagedAcsCredentialWarningsBeingDeleted), "being_deleted")]
[JsonSubtypes.KnownSubType(typeof(UnmanagedAcsCredentialWarningsScheduleModified), "schedule_modified")]
[JsonSubtypes.KnownSubType(typeof(UnmanagedAcsCredentialWarningsScheduleExternallyModified), "schedule_externally_modified")]
[JsonSubtypes.KnownSubType(typeof(UnmanagedAcsCredentialWarningsWaitingToBeIssued), "waiting_to_be_issued")]
...
public class UnmanagedAcsCredentialWarningsWaitingToBeIssued : UnmanagedAcsCredentialWarnings
{
[JsonConstructorAttribute]
protected UnmanagedAcsCredentialWarningsWaitingToBeIssued() { }

public UnmanagedAcsCredentialWarningsWaitingToBeIssued(string? createdAt = default, string? message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
...
[DataContract(Name = "seamModel_unmanagedAcsCredentialWarningsScheduleExternallyModified_model")]
public class UnmanagedAcsCredentialWarningsScheduleExternallyModified : UnmanagedAcsCredentialWarnings
{
[JsonConstructorAttribute]
protected UnmanagedAcsCredentialWarningsScheduleExternallyModified() { }

public UnmanagedAcsCredentialWarningsScheduleExternallyModified(string? createdAt = default, string? message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public UnmanagedAcsCredentialWarningsScheduleModified(string? createdAt = default, string? message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public UnmanagedAcsCredentialWarningsBeingDeleted(string? createdAt = default, string? message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
[DataContract(Name = "seamModel_unmanagedAcsCredentialWarningsUnknownIssueWithAcsCredential_model")]
public class UnmanagedAcsCredentialWarningsUnknownIssueWithAcsCredential : UnmanagedAcsCredentialWarnings
{
[JsonConstructorAttribute]
protected UnmanagedAcsCredentialWarningsUnknownIssueWithAcsCredential() { }

public UnmanagedAcsCredentialWarningsUnknownIssueWithAcsCredential(string? createdAt = default, string? message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public class UnmanagedAcsCredentialWarningsNeedsToBeReissued : UnmanagedAcsCredentialWarnings
{
[JsonConstructorAttribute]
protected UnmanagedAcsCredentialWarningsNeedsToBeReissued() { }

public UnmanagedAcsCredentialWarningsNeedsToBeReissued(string? createdAt = default, string? message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
[DataContract(Name = "seamModel_unmanagedAcsCredentialWarningsUnrecognized_model")]
...
public UnmanagedAcsCredentialWarningsUnrecognized(string warningCode = default)
{
WarningCode = warningCode;
}
...
public UnmanagedAcsCredentialAssaAbloyVostioMetadata(bool? autoJoin = default, List<string>? doorNames = default, string? endpointId = default, string? keyId = default, string? keyIssuingRequestId = default, List<string>? overrideGuestAcsEntranceIds = default)
{
AutoJoin = autoJoin;
DoorNames = doorNames;
...
public UnmanagedAcsCredentialErrors(string? createdAt = default, string? errorCode = default, string? message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
public UnmanagedAcsCredentialVisionlineMetadata(bool? autoJoin = default, UnmanagedAcsCredentialVisionlineMetadata.CardFunctionTypeEnum? cardFunctionType = default, string? cardId = default, List<string>? commonAcsEntranceIds = default, string? credentialId = default, List<string>? guestAcsEntranceIds = default, bool? isValid = default, List<string>? joinerAcsCredentialIds = default)
{
AutoJoin = autoJoin;
