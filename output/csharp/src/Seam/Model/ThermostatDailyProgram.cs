...
public ThermostatDailyProgram(string? createdAt = default, string? deviceId = default, string? name = default, List<ThermostatDailyProgramPeriods>? periods = default, string? thermostatDailyProgramId = default, string? workspaceId = default)
{
CreatedAt = createdAt;
DeviceId = deviceId;
Name = name;
...
public ThermostatDailyProgramPeriods(string? climatePresetKey = default, string? startsAtTime = default)
{
