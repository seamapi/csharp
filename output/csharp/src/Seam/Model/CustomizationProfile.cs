...
public CustomizationProfile(string? createdAt = default, CustomizationProfileCustomerPortalTheme? customerPortalTheme = default, string? customizationProfileId = default, string? logoUrl = default, object? messageOverrides = default, string? name = default, string? primaryColor = default, string? secondaryColor = default, string? workspaceId = default)
{
CreatedAt = createdAt;
...
public CustomizationProfileCustomerPortalTheme(string? fontFamily = default, string? monoFontFamily = default, string? primaryColor = default, string? primaryForegroundColor = default, string? secondaryColor = default, string? secondaryForegroundColor = default)
{
...
[DataMember(Name = "primary_foreground_color", IsRequired = false, EmitDefaultValue = false)]
public string? PrimaryForegroundColor { get; set; }

[DataMember(Name = "secondary_color", IsRequired = false, EmitDefaultValue = false)]
public string? SecondaryColor { get; set; }

[DataMember(Name = "secondary_foreground_color", IsRequired = false, EmitDefaultValue = false)]
