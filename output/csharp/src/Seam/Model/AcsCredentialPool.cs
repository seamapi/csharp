...
public AcsCredentialPool(string? acsCredentialPoolId = default, string? acsSystemId = default, string? createdAt = default, string? displayName = default, AcsCredentialPool.ExternalTypeEnum? externalType = default, string? externalTypeDisplayName = default, string? workspaceId = default)
{
