...
namespace Seam.Model
{
    ...
    public class AccessMethod
    {
        ...
        [JsonSubtypes.FallBackSubType(typeof(AccessMethodWarningsUnknown))]
        ...
        [DataContract(Name = "seamModel_accessMethodWarningsUnknown_model")]
        public class AccessMethodWarningsUnknown : AccessMethodWarnings
        {
            [JsonConstructorAttribute]
            protected AccessMethodWarningsUnknown() { }

            public AccessMethodWarningsUnknown(
                string warningCode = default,
                string message = default
            )
            {
