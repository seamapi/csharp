...
public AccessMethod(string? accessMethodId = default, string? clientSessionToken = default, string? code = default, string? createdAt = default, string? customizationProfileId = default, string? displayName = default, List<AccessMethodErrors>? errors = default, string? instantKeyUrl = default, bool? isAssignmentRequired = default, bool? isEncodingRequired = default, bool? isIssued = default, bool? isReadyForAssignment = default, bool? isReadyForEncoding = default, string? issuedAt = default, AccessMethod.ModeEnum? mode = default, List<AccessMethodPendingMutations>? pendingMutations = default, List<AccessMethodWarnings>? warnings = default, string? workspaceId = default)
{
...
public AccessMethodErrorsFailedToIssue(string? createdAt = default, string errorCode = default, string? message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
[JsonSubtypes.KnownSubType(typeof(AccessMethodPendingMutationsUpdatingAccessTimes), "updating_access_times")]
[JsonSubtypes.KnownSubType(typeof(AccessMethodPendingMutationsRevokingAccess), "revoking_access")]
[JsonSubtypes.KnownSubType(typeof(AccessMethodPendingMutationsProvisioningAccess), "provisioning_access")]
...
public AccessMethodPendingMutationsProvisioningAccess(string? createdAt = default, AccessMethodPendingMutationsProvisioningAccessFrom? from = default, string? message = default, string mutationCode = default, AccessMethodPendingMutationsProvisioningAccessTo? to = default)
{
CreatedAt = createdAt;
From = from;
Message = message;
...
public AccessMethodPendingMutationsProvisioningAccessFrom(List<string>? deviceIds = default)
{
DeviceIds = deviceIds;
}
...
public AccessMethodPendingMutationsProvisioningAccessTo(List<string>? deviceIds = default)
{
DeviceIds = deviceIds;
}
...
public AccessMethodPendingMutationsRevokingAccess(string? createdAt = default, AccessMethodPendingMutationsRevokingAccessFrom? from = default, string? message = default, string mutationCode = default, AccessMethodPendingMutationsRevokingAccessTo? to = default)
{
CreatedAt = createdAt;
From = from;
Message = message;
...
public AccessMethodPendingMutationsUpdatingAccessTimes(string? createdAt = default, AccessMethodPendingMutationsUpdatingAccessTimesFrom? from = default, string? message = default, string mutationCode = default, AccessMethodPendingMutationsUpdatingAccessTimesTo? to = default)
{
CreatedAt = createdAt;
From = from;
Message = message;
...
public AccessMethodPendingMutationsUpdatingAccessTimesFrom(string? endsAt = default, string? startsAt = default)
{
EndsAt = endsAt;
StartsAt = startsAt;
}
...
public AccessMethodPendingMutationsUpdatingAccessTimesTo(string? endsAt = default, string? startsAt = default)
{
EndsAt = endsAt;
StartsAt = startsAt;
}
...
[JsonSubtypes.KnownSubType(typeof(AccessMethodWarningsPulledBackupAccessCode), "pulled_backup_access_code")]
[JsonSubtypes.KnownSubType(typeof(AccessMethodWarningsUpdatingAccessTimes), "updating_access_times")]
...
public AccessMethodWarningsBeingDeleted(string? createdAt = default, string? message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
...
public AccessMethodWarningsUpdatingAccessTimes(string? createdAt = default, string? message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public AccessMethodWarningsPulledBackupAccessCode(string? createdAt = default, string? message = default, string? originalAccessMethodId = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
...
public AccessMethodWarningsDelayInIssuing(string? createdAt = default, string? message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
