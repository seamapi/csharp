...
public ClientSession(string clientSessionId = default, List<string> connectWebviewIds = default, List<string> connectedAccountIds = default, string createdAt = default, string customerKey = default, float deviceCount = default, string expiresAt = default, string token = default, string? userIdentifierKey = default, string userIdentityId = default, List<string> userIdentityIds = default, string workspaceId = default)
{
...
[DataMember(Name = "user_identifier_key", IsRequired = true, EmitDefaultValue = false)]
