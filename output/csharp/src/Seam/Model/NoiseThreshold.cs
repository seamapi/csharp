...
public NoiseThreshold(string? deviceId = default, string? endsDailyAt = default, string? name = default, float? noiseThresholdDecibels = default, string? noiseThresholdId = default, float? noiseThresholdNrs = default, string? startsDailyAt = default)
{
DeviceId = deviceId;
