...
public AcsEncoder(string? acsEncoderId = default, string? acsSystemId = default, string? connectedAccountId = default, string? createdAt = default, string? displayName = default, List<AcsEncoderErrors>? errors = default, string? workspaceId = default)
{
...
public AcsEncoderErrors(string? createdAt = default, AcsEncoderErrors.ErrorCodeEnum? errorCode = default, string? message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
