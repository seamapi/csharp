...
public WorkspaceConnectWebviewCustomization(string? inviterLogoUrl = default, WorkspaceConnectWebviewCustomization.LogoShapeEnum? logoShape = default, string? primaryButtonColor = default, string? primaryButtonTextColor = default, string? successMessage = default)
{
