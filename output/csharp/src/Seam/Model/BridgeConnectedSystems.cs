...
public BridgeConnectedSystems(string? acsSystemDisplayName = default, string? acsSystemId = default, string? bridgeCreatedAt = default, string? bridgeId = default, string? connectedAccountCreatedAt = default, string? connectedAccountId = default, string? workspaceDisplayName = default, string? workspaceId = default)
{
...
[DataMember(Name = "connected_account_created_at", IsRequired = false, EmitDefaultValue = false)]
