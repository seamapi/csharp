...
public BridgeClientSession(string? bridgeClientMachineIdentifierKey = default, string? bridgeClientName = default, string? bridgeClientSessionId = default, string? bridgeClientSessionToken = default, string? bridgeClientTimeZone = default, string? createdAt = default, List<BridgeClientSessionErrors>? errors = default, string? pairingCode = default, string? pairingCodeExpiresAt = default, string? tailscaleAuthKey = default, string? tailscaleHostname = default, string? telemetryToken = default, string? telemetryTokenExpiresAt = default, string? telemetryUrl = default)
{
...
[JsonSubtypes.FallBackSubType(typeof(BridgeClientSessionErrorsUnrecognized))]
[JsonSubtypes.KnownSubType(typeof(BridgeClientSessionErrorsNoCommunicationFromBridge), "no_communication_from_bridge")]
[JsonSubtypes.KnownSubType(typeof(BridgeClientSessionErrorsBridgeLanUnreachable), "bridge_lan_unreachable")]
...
public BridgeClientSessionErrorsBridgeLanUnreachable(bool? canTailscaleProxyReachBridge = default, bool? canTailscaleProxyReachTailscaleNetwork = default, string? createdAt = default, string errorCode = default, bool? isBridgeSocksServerHealthy = default, bool? isTailscaleProxyReachable = default, bool? isTailscaleProxySocksServerHealthy = default, string? message = default)
{
...
[DataMember(Name = "can_tailscale_proxy_reach_bridge", IsRequired = false, EmitDefaultValue = false)]
public bool? CanTailscaleProxyReachBridge { get; set; }

[DataMember(Name = "can_tailscale_proxy_reach_tailscale_network", IsRequired = false, EmitDefaultValue = false)]
...
[DataMember(Name = "is_bridge_socks_server_healthy", IsRequired = false, EmitDefaultValue = false)]
public bool? IsBridgeSocksServerHealthy { get; set; }

[DataMember(Name = "is_tailscale_proxy_reachable", IsRequired = false, EmitDefaultValue = false)]
public bool? IsTailscaleProxyReachable { get; set; }

[DataMember(Name = "is_tailscale_proxy_socks_server_healthy", IsRequired = false, EmitDefaultValue = false)]
...
public BridgeClientSessionErrorsNoCommunicationFromBridge(string? createdAt = default, string errorCode = default, string? message = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
[DataContract(Name = "seamModel_bridgeClientSessionErrorsUnrecognized_model")]
public class BridgeClientSessionErrorsUnrecognized : BridgeClientSessionErrors
{
[JsonConstructorAttribute]
protected BridgeClientSessionErrorsUnrecognized() { }

public BridgeClientSessionErrorsUnrecognized(string errorCode = default)
{
ErrorCode = errorCode;
}
...
[DataMember(Name = "bridge_client_machine_identifier_key", IsRequired = false, EmitDefaultValue = false)]
...
[DataMember(Name = "bridge_client_session_id", IsRequired = false, EmitDefaultValue = false)]
public string? BridgeClientSessionId { get; set; }

[DataMember(Name = "bridge_client_session_token", IsRequired = false, EmitDefaultValue = false)]
...
[DataMember(Name = "telemetry_token_expires_at", IsRequired = false, EmitDefaultValue = false)]
