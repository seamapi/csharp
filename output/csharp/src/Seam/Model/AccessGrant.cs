...
public AccessGrant(string? accessGrantId = default, string? accessGrantKey = default, List<string>? accessMethodIds = default, string? clientSessionToken = default, string? createdAt = default, string? customizationProfileId = default, string? displayName = default, string? endsAt = default, List<AccessGrantErrors>? errors = default, string? instantKeyUrl = default, List<string>? locationIds = default, string? name = default, List<AccessGrantPendingMutations>? pendingMutations = default, List<AccessGrantRequestedAccessMethods>? requestedAccessMethods = default, string? reservationKey = default, List<string>? spaceIds = default, string? startsAt = default, string? userIdentityId = default, List<AccessGrantWarnings>? warnings = default, string? workspaceId = default)
{
...
[JsonSubtypes.KnownSubType(typeof(AccessGrantErrorsCannotCreateRequestedAccessMethods), "cannot_create_requested_access_methods")]
...
public AccessGrantErrorsCannotCreateRequestedAccessMethods(string? createdAt = default, string errorCode = default, string? message = default, List<string>? missingDeviceIds = default)
{
CreatedAt = createdAt;
ErrorCode = errorCode;
Message = message;
...
public AccessGrantErrorsUnrecognized(string errorCode = default)
{
ErrorCode = errorCode;
}
...
[JsonSubtypes.KnownSubType(typeof(AccessGrantPendingMutationsUpdatingAccessTimes), "updating_access_times")]
[JsonSubtypes.KnownSubType(typeof(AccessGrantPendingMutationsUpdatingSpaces), "updating_spaces")]
...
public AccessGrantPendingMutationsUpdatingSpaces(string? createdAt = default, AccessGrantPendingMutationsUpdatingSpacesFrom? from = default, string? message = default, string mutationCode = default, AccessGrantPendingMutationsUpdatingSpacesTo? to = default)
{
CreatedAt = createdAt;
From = from;
Message = message;
...
public AccessGrantPendingMutationsUpdatingSpacesTo(string? commonCodeKey = default, List<string>? deviceIds = default)
{
...
public AccessGrantPendingMutationsUpdatingAccessTimes(List<string>? accessMethodIds = default, string? createdAt = default, AccessGrantPendingMutationsUpdatingAccessTimesFrom? from = default, string? message = default, string mutationCode = default, AccessGrantPendingMutationsUpdatingAccessTimesTo? to = default)
{
AccessMethodIds = accessMethodIds;
CreatedAt = createdAt;
From = from;
...
public AccessGrantPendingMutationsUpdatingAccessTimesFrom(string? endsAt = default, string? startsAt = default)
{
EndsAt = endsAt;
StartsAt = startsAt;
}
...
public AccessGrantPendingMutationsUpdatingAccessTimesTo(string? endsAt = default, string? startsAt = default)
{
EndsAt = endsAt;
StartsAt = startsAt;
}
...
public AccessGrantPendingMutationsUnrecognized(string mutationCode = default)
{
MutationCode = mutationCode;
}
...
[JsonSubtypes.KnownSubType(typeof(AccessGrantWarningsDeviceTimeConstraintsViolated), "device_time_constraints_violated")]
[JsonSubtypes.KnownSubType(typeof(AccessGrantWarningsDeviceDoesNotSupportAccessCodes), "device_does_not_support_access_codes")]
[JsonSubtypes.KnownSubType(typeof(AccessGrantWarningsRequestedCodeUnavailable), "requested_code_unavailable")]
[JsonSubtypes.KnownSubType(typeof(AccessGrantWarningsUpdatingAccessTimes), "updating_access_times")]
[JsonSubtypes.KnownSubType(typeof(AccessGrantWarningsOverprovisionedAccess), "overprovisioned_access")]
[JsonSubtypes.KnownSubType(typeof(AccessGrantWarningsUnderprovisionedAccess), "underprovisioned_access")]
...
public AccessGrantWarningsBeingDeleted(string? createdAt = default, string? message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
...
public AccessGrantWarningsUnderprovisionedAccess(string? createdAt = default, string? message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
public AccessGrantWarningsOverprovisionedAccess(string? createdAt = default, List<AccessGrantWarningsOverprovisionedAccessFailedDevices>? failedDevices = default, string? message = default, string warningCode = default)
{
CreatedAt = createdAt;
...
[DataContract(Name = "seamModel_accessGrantWarningsOverprovisionedAccessFailedDevices_model")]
...
public AccessGrantWarningsOverprovisionedAccessFailedDevices(string? deviceId = default, string? errorCode = default, string? message = default)
{
DeviceId = deviceId;
ErrorCode = errorCode;
Message = message;
...
public AccessGrantWarningsUpdatingAccessTimes(List<string>? accessMethodIds = default, string? createdAt = default, string? message = default, string warningCode = default)
{
AccessMethodIds = accessMethodIds;
CreatedAt = createdAt;
Message = message;
...
public AccessGrantWarningsRequestedCodeUnavailable(string? createdAt = default, string? deviceId = default, string? message = default, string? newCode = default, string? originalCode = default, string warningCode = default)
{
CreatedAt = createdAt;
DeviceId = deviceId;
Message = message;
...
public AccessGrantWarningsDeviceDoesNotSupportAccessCodes(string? createdAt = default, string? deviceId = default, string? message = default, string warningCode = default)
{
CreatedAt = createdAt;
DeviceId = deviceId;
Message = message;
...
public AccessGrantWarningsDeviceTimeConstraintsViolated(string? createdAt = default, string? deviceId = default, string? message = default, AccessGrantWarningsDeviceTimeConstraintsViolated.ReasonEnum? reason = default, string warningCode = default)
{
CreatedAt = createdAt;
DeviceId = deviceId;
Message = message;
...
public AccessGrantWarningsUnrecognized(string warningCode = default)
{
WarningCode = warningCode;
}
...
[DataMember(Name = "requested_access_methods", IsRequired = false, EmitDefaultValue = false)]
...
public AccessGrantRequestedAccessMethods(string? code = default, List<string>? createdAccessMethodIds = default, string? createdAt = default, string? displayName = default, int? instantKeyMaxUseCount = default, AccessGrantRequestedAccessMethods.ModeEnum? mode = default)
{
Code = code;
...
[DataMember(Name = "created_access_method_ids", IsRequired = false, EmitDefaultValue = false)]
