...
public UserIdentity(List<string> acsUserIds = default, string createdAt = default, string displayName = default, string? emailAddress = default, List<UserIdentityErrors> errors = default, string? fullName = default, string? phoneNumber = default, string userIdentityId = default, string? userIdentityKey = default, List<UserIdentityWarnings> warnings = default, string workspaceId = default)
{
...
[JsonSubtypes.KnownSubType(typeof(UserIdentityErrorsIssueWithAcsUser), "issue_with_acs_user")]
...
public UserIdentityErrorsIssueWithAcsUser(string acsSystemId = default, string acsUserId = default, string createdAt = default, string errorCode = default, string message = default)
{
...
[JsonSubtypes.KnownSubType(typeof(UserIdentityWarningsAcsUserProfileDoesNotMatchUserIdentity), "acs_user_profile_does_not_match_user_identity")]
...
public UserIdentityWarningsBeingDeleted(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
...
[DataContract(Name = "seamModel_userIdentityWarningsAcsUserProfileDoesNotMatchUserIdentity_model")]
public class UserIdentityWarningsAcsUserProfileDoesNotMatchUserIdentity : UserIdentityWarnings
{
[JsonConstructorAttribute]
protected UserIdentityWarningsAcsUserProfileDoesNotMatchUserIdentity() { }

public UserIdentityWarningsAcsUserProfileDoesNotMatchUserIdentity(string createdAt = default, string message = default, string warningCode = default)
{
CreatedAt = createdAt;
Message = message;
WarningCode = warningCode;
...
[DataMember(Name = "warning_code", IsRequired = true, EmitDefaultValue = false)]
public override string WarningCode { get; } = "acs_user_profile_does_not_match_user_identity";
