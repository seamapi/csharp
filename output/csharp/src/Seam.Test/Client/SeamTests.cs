...
public class UnitTest1 : SeamConnectTest
{
  ...
  {
    var device = seam.Devices.List().First(d => d.DeviceType == Device.DeviceTypeEnum.AugustLock);
  ...
  public async void TestCreateAccessCodeAsync()
  {
    ...
    var access_code = await seam.AccessCodes.CreateAsync(deviceId: device.DeviceId, code: "1234");
